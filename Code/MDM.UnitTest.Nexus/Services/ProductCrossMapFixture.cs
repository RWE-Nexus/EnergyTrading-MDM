namespace EnergyTrading.MDM.Test.Services
{
    ...
    [TestClass]
    public class ProductCrossMapFixture
    {
        [TestMethod]
        ...
        public void SuccessMatch()
        {
            ...
            var targetMapping = new ProductMapping
            {
                System = targetSystem,
                MappingValue = "B",
                IsDefault = true
            };
            var product = new MDM.Product
            {
                Id = 1,
            ...
            product.ProcessMapping(targetMapping);
            ...
            mappingEngine.Setup(x => x.Map<ProductMapping, NexusId>(targetMapping)).Returns(targetIdentifier);
