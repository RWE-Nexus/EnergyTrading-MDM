namespace EnergyTrading.MDM.Test.Services
{
    ...
    public class InstrumentTypeOverrideUpdateMappingFixture
    {
        ...
        public void ValidDetailsSaved()
        {
            ...
            var m1 = new InstrumentTypeOverrideMapping { Id = mappingId, System = s1, MappingValue = "1", Version = 34UL.GetVersionByteArray(), Validity = new DateRange(start, DateUtility.MaxDate) };			
