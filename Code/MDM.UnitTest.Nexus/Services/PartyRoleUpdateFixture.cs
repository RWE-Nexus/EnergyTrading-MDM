namespace EnergyTrading.MDM.Test.Services
{
    ...
    public class PartyRoleUpdateFixture
    {
        ...
        public void EarlierVersionRaisesVersionConflict()
        {
            ...
            validatorFactory.Setup(x => x.IsValid(It.IsAny<RWEST.Nexus.MDM.Contracts.PartyRole>(), It.IsAny<IList<IRule>>())).Returns(true);

            var service = new PartyRoleService(validatorFactory.Object, mappingEngine.Object, repository.Object, searchCache.Object);

            var cd = new RWEST.Nexus.MDM.Contracts.PartyRoleDetails { Name = "PartyRole 1" };
            var nexus = new RWEST.Nexus.MDM.Contracts.SystemData { StartDate = new DateTime(2012, 1, 1) };
            var contract = new RWEST.Nexus.MDM.Contracts.PartyRole { Details = cd, Nexus = nexus };
        ...
        public void ValidDetailsSaved()
        {
            ...
            var d1 = new PartyRoleDetails { Id = 1, Name = "PartyRole 1", Timestamp = new byte[] { 74, 0, 0, 0, 0, 0, 0, 0 } };
            ...
            mappingEngine.Setup(x => x.Map<RWEST.Nexus.MDM.Contracts.PartyRoleDetails, PartyRoleDetails>(cd)).Returns(d2);
