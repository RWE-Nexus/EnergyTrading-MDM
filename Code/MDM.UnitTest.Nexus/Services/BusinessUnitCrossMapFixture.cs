namespace EnergyTrading.MDM.Test.Services
{
    ...
    [TestClass]
    public class BusinessUnitCrossMapFixture
    {
        [TestMethod]
        ...
        public void SuccessMatch()
        {
            ...
            var details = new MDM.BusinessUnitDetails
            {
                Name = "Test",
            };
            var businessunit = new MDM.BusinessUnit
            {
                Id = 1,
            };
            businessunit.AddDetails(details);
            businessunit.ProcessMapping(mapping);
            businessunit.ProcessMapping(targetMapping);
