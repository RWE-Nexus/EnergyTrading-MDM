namespace EnergyTrading.MDM.Test.Services
{
    ...
    [TestClass]
    public class BrokerCommodityUpdateFixture : Fixture
    {
        [TestMethod]
        ...
        public void NullContractInvalid()
        {
            ...
            repository.Setup(x => x.FindOne<BrokerCommodity>(1)).Returns(new BrokerCommodity());
        ...
        public void EarlierVersionRaisesVersionConflict()
        {
            ...
            var cd = new RWEST.Nexus.MDM.Contracts.BrokerCommodityDetails();
            var nexus = new RWEST.Nexus.MDM.Contracts.SystemData { StartDate = new DateTime(2012, 1, 1) };
            var contract = new RWEST.Nexus.MDM.Contracts.BrokerCommodity { Details = cd, Nexus = nexus };

            var details = ObjectMother.Create<BrokerCommodity>();
            details.Id = 1;
            var entity = ObjectMother.Create<BrokerCommodity>();
            entity.Id = 2;
            entity.AddDetails(details);

            repository.Setup(x => x.FindOne<BrokerCommodity>(1)).Returns(entity);
        ...
        public void ValidDetailsSaved()
        {
            ...
            var d1 = ObjectMother.Create<BrokerCommodity>();
            d1.Id = 1;
            ...
            var d2 = ObjectMother.Create<BrokerCommodity>(); 
            ...
            mappingEngine.Setup(x => x.Map<RWEST.Nexus.MDM.Contracts.BrokerCommodityDetails, BrokerCommodity>(cd)).Returns(d2);
