namespace EnergyTrading.MDM.Test.Services
{
    ...
    [TestClass]
    public class ShapeElementUpdateFixture : Fixture
    {
        [TestMethod]
        ...
        public void NullContractInvalid()
        {
            ...
            repository.Setup(x => x.FindOne<ShapeElement>(1)).Returns(new ShapeElement());
        ...
        public void EarlierVersionRaisesVersionConflict()
        {
            ...
            validatorFactory.Setup(x => x.IsValid(It.IsAny<RWEST.Nexus.MDM.Contracts.ShapeElement>(), It.IsAny<IList<IRule>>())).Returns(true);

            var service = new ShapeElementService(validatorFactory.Object, mappingEngine.Object, repository.Object, searchCache.Object);

            var cd = new RWEST.Nexus.MDM.Contracts.ShapeElementDetails();
            var nexus = new RWEST.Nexus.MDM.Contracts.SystemData { StartDate = new DateTime(2012, 1, 1) };
            var contract = new RWEST.Nexus.MDM.Contracts.ShapeElement { Details = cd, Nexus = nexus };

            var details = ObjectMother.Create<ShapeElement>();
            details.Id = 1;
            var entity = ObjectMother.Create<ShapeElement>();
            entity.Id = 2;
            entity.AddDetails(details);

            repository.Setup(x => x.FindOne<ShapeElement>(1)).Returns(entity);
        ...
        public void ValidDetailsSaved()
        {
            ...
            var d1 = ObjectMother.Create<ShapeElement>();
            d1.Id = 1;
            ...
            var d2 = ObjectMother.Create<ShapeElement>(); 
            ...
            mappingEngine.Setup(x => x.Map<RWEST.Nexus.MDM.Contracts.ShapeElementDetails, ShapeElement>(cd)).Returns(d2);
