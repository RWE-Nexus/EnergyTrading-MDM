namespace EnergyTrading.MDM.Test.Services
{
    ...
    [TestClass]
    public class ShapeDayCrossMapFixture
    {
        [TestMethod]
        ...
        public void SuccessMatch()
        {
            ...
            var targetMapping = new ShapeDayMapping
            {
                System = targetSystem,
                MappingValue = "B",
                IsDefault = true
            };
            var shapeday = new MDM.ShapeDay
            {
                Id = 1,
            ...
            shapeday.ProcessMapping(targetMapping);
            ...
            mappingEngine.Setup(x => x.Map<ShapeDayMapping, NexusId>(targetMapping)).Returns(targetIdentifier);
