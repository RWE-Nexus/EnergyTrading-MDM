namespace EnergyTrading.MDM.Test.Services
{
    ...
    [TestClass]
    public class ProductCurveCrossMapFixture
    {
        [TestMethod]
        ...
        public void SuccessMatch()
        {
            ...
            var targetMapping = new ProductCurveMapping
            {
                System = targetSystem,
                MappingValue = "B",
                IsDefault = true
            ...
            productcurve.ProcessMapping(targetMapping);
            ...
            mappingEngine.Setup(x => x.Map<ProductCurveMapping, NexusId>(targetMapping)).Returns(targetIdentifier);
