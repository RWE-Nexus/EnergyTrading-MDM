namespace EnergyTrading.MDM.Test.Services
{
    ...
    [TestClass]
    public class HierarchyUpdateFixture : Fixture
    {
        [TestMethod]
        ...
        public void NullContractInvalid()
        {
            ...
            repository.Setup(x => x.FindOne<Hierarchy>(1)).Returns(new Hierarchy());
        ...
        public void EarlierVersionRaisesVersionConflict()
        {
            ...
            validatorFactory.Setup(x => x.IsValid(It.IsAny<RWEST.Nexus.MDM.Contracts.Hierarchy>(), It.IsAny<IList<IRule>>())).Returns(true);

            var service = new HierarchyService(validatorFactory.Object, mappingEngine.Object, repository.Object, searchCache.Object);

            var cd = new RWEST.Nexus.MDM.Contracts.HierarchyDetails();
            var nexus = new RWEST.Nexus.MDM.Contracts.SystemData { StartDate = new DateTime(2012, 1, 1) };
            var contract = new RWEST.Nexus.MDM.Contracts.Hierarchy { Details = cd, Nexus = nexus };

            var details = ObjectMother.Create<Hierarchy>();
            details.Id = 1;
            var entity = ObjectMother.Create<Hierarchy>();
            entity.Id = 2;
            entity.AddDetails(details);

            repository.Setup(x => x.FindOne<Hierarchy>(1)).Returns(entity);
        ...
        public void ValidDetailsSaved()
        {
            ...
            var d1 = ObjectMother.Create<Hierarchy>();
            d1.Id = 1;
            ...
            var d2 = ObjectMother.Create<Hierarchy>(); 
            ...
            mappingEngine.Setup(x => x.Map<RWEST.Nexus.MDM.Contracts.HierarchyDetails, Hierarchy>(cd)).Returns(d2);
