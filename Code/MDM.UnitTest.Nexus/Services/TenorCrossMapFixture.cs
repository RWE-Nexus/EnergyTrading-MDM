namespace EnergyTrading.MDM.Test.Services
{
    ...
    [TestClass]
    public class TenorCrossMapFixture
    {
        [TestMethod]
        ...
        public void SuccessMatch()
        {
            ...
            var targetMapping = new TenorMapping
            {
                System = targetSystem,
                MappingValue = "B",
                IsDefault = true
            ...
            tenor.ProcessMapping(targetMapping);
            ...
            mappingEngine.Setup(x => x.Map<TenorMapping, NexusId>(targetMapping)).Returns(targetIdentifier);
