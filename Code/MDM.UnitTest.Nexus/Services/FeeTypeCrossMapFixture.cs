namespace EnergyTrading.MDM.Test.Services
{
    ...
    [TestClass]
    public class FeeTypeCrossMapFixture
    {
        [TestMethod]
        ...
        public void SuccessMatch()
        {
            ...
            var targetMapping = new FeeTypeMapping
            {
                System = targetSystem,
                MappingValue = "B",
                IsDefault = true
            };
            var feetype = new MDM.FeeType
            {
                Id = 1,
            ...
            feetype.ProcessMapping(targetMapping);
            ...
            mappingEngine.Setup(x => x.Map<FeeTypeMapping, NexusId>(targetMapping)).Returns(targetIdentifier);
