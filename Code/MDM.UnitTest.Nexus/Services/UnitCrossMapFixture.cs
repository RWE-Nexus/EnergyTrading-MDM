namespace EnergyTrading.MDM.Test.Services
{
    ...
    [TestClass]
    public class UnitCrossMapFixture
    {
        [TestMethod]
        ...
        public void SuccessMatch()
        {
            ...
            var targetMapping = new UnitMapping
            {
                System = targetSystem,
                MappingValue = "B",
                IsDefault = true
            ...
            unit.ProcessMapping(targetMapping);
            ...
            mappingEngine.Setup(x => x.Map<UnitMapping, NexusId>(targetMapping)).Returns(targetIdentifier);
