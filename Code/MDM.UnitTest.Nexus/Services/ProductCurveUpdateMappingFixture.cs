namespace EnergyTrading.MDM.Test.Services
{
    ...
    public class ProductCurveUpdateMappingFixture
    {
        ...
        public void ValidDetailsSaved()
        {
            ...
            var m1 = new ProductCurveMapping { Id = mappingId, System = s1, MappingValue = "1", Version = 34UL.GetVersionByteArray(), Validity = new DateRange(start, DateUtility.MaxDate) };			
