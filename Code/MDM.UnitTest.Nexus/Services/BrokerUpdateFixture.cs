namespace EnergyTrading.MDM.Test.Services
{
    ...
    public class BrokerUpdateFixture
    {
        ...
        public void EarlierVersionRaisesVersionConflict()
        {
            ...
            var cd = new RWEST.Nexus.MDM.Contracts.BrokerDetails { Name = "Test" };
            var nexus = new RWEST.Nexus.MDM.Contracts.SystemData { StartDate = new DateTime(2012, 1, 1) };
            var contract = new RWEST.Nexus.MDM.Contracts.Broker { Details = cd, Nexus = nexus };
        ...
        public void ValidDetailsSaved()
        {
            ...
            var d1 = new BrokerDetails { Id = 1, Name = "Test", Timestamp = new byte[] { 74, 0, 0, 0, 0, 0, 0, 0 } };
            ...
            mappingEngine.Setup(x => x.Map<RWEST.Nexus.MDM.Contracts.BrokerDetails, BrokerDetails>(cd)).Returns(d2);
