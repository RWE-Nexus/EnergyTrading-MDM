namespace EnergyTrading.MDM.Test.Services
{
    ...
    [TestClass]
    public class ProductTypeInstanceCrossMapFixture
    {
        [TestMethod]
        ...
        public void SuccessMatch()
        {
            ...
            var targetMapping = new ProductTypeInstanceMapping
            {
                System = targetSystem,
                MappingValue = "B",
                IsDefault = true
            };
            var producttypeinstance = new MDM.ProductTypeInstance
            {
                Id = 1,
            ...
            producttypeinstance.ProcessMapping(targetMapping);
            ...
            mappingEngine.Setup(x => x.Map<ProductTypeInstanceMapping, NexusId>(targetMapping)).Returns(targetIdentifier);
