namespace EnergyTrading.MDM.Test.Services
{
    ...
    [TestClass]
    public class PortfolioCrossMapFixture
    {
        [TestMethod]
        ...
        public void SuccessMatch()
        {
            ...
            var targetMapping = new PortfolioMapping
            {
                System = targetSystem,
                MappingValue = "B",
                IsDefault = true
            };
            var portfolio = new MDM.Portfolio
            {
                Id = 1,
            ...
            portfolio.ProcessMapping(targetMapping);
            ...
            mappingEngine.Setup(x => x.Map<PortfolioMapping, NexusId>(targetMapping)).Returns(targetIdentifier);
