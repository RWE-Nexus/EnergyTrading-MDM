namespace EnergyTrading.MDM.Test.Services
{
    ...
    [TestClass]
    public class PartyOverrideCrossMapFixture
    {
        [TestMethod]
        ...
        public void SuccessMatch()
        {
            ...
            var targetMapping = new PartyOverrideMapping
            {
                System = targetSystem,
                MappingValue = "B",
                IsDefault = true
            };
            var partyoverride = new MDM.PartyOverride
            {
                Id = 1,
            ...
            partyoverride.ProcessMapping(targetMapping);
            ...
            mappingEngine.Setup(x => x.Map<PartyOverrideMapping, NexusId>(targetMapping)).Returns(targetIdentifier);
