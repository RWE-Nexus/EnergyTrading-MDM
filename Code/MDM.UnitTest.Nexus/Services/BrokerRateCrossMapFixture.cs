namespace EnergyTrading.MDM.Test.Services
{
    ...
    [TestClass]
    public class BrokerRateCrossMapFixture
    {
        [TestMethod]
        ...
        public void SuccessMatch()
        {
            ...
            var targetMapping = new BrokerRateMapping
            {
                System = targetSystem,
                MappingValue = "B",
                IsDefault = true
            };
            var brokerrate = new MDM.BrokerRate()
            {
                Id = 1,
               // Timestamp = new byte[] { 1, 0, 0, 0, 0, 0, 0, 0 }
            };
            var details = new MDM.BrokerRateDetails()
            {
                Id = 1,
                Timestamp = new byte[] { 1, 0, 0, 0, 0, 0, 0, 0 }
            };
            ...
            brokerrate.ProcessMapping(targetMapping);
            ...
            mappingEngine.Setup(x => x.Map<BrokerRateMapping, NexusId>(targetMapping)).Returns(targetIdentifier);
