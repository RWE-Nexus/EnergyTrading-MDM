namespace EnergyTrading.MDM.Test.Services
{
    ...
    [TestClass]
    public class ShapeCrossMapFixture
    {
        [TestMethod]
        ...
        public void SuccessMatch()
        {
            ...
            var targetMapping = new ShapeMapping
            {
                System = targetSystem,
                MappingValue = "B",
                IsDefault = true
            ...
            shape.ProcessMapping(targetMapping);
            ...
            mappingEngine.Setup(x => x.Map<ShapeMapping, NexusId>(targetMapping)).Returns(targetIdentifier);
