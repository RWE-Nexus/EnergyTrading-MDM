namespace EnergyTrading.MDM.Test.Services
{
    ...
    [TestClass]
    public class TenorUpdateFixture : Fixture
    {
        [TestMethod]
        ...
        public void NullContractInvalid()
        {
            ...
            repository.Setup(x => x.FindOne<Tenor>(1)).Returns(new Tenor());
        ...
        public void EarlierVersionRaisesVersionConflict()
        {
            ...
            var cd = new RWEST.Nexus.MDM.Contracts.TenorDetails();
            var nexus = new RWEST.Nexus.MDM.Contracts.SystemData { StartDate = new DateTime(2012, 1, 1) };
            var contract = new RWEST.Nexus.MDM.Contracts.Tenor { Details = cd, Nexus = nexus };

            var details = ObjectMother.Create<Tenor>();
            details.Id = 1;
            var entity = ObjectMother.Create<Tenor>();
            entity.Id = 2;
            entity.AddDetails(details);

            repository.Setup(x => x.FindOne<Tenor>(1)).Returns(entity);
        ...
        public void ValidDetailsSaved()
        {
            ...
            var d1 = ObjectMother.Create<Tenor>();
            d1.Id = 1;
            ...
            var d2 = ObjectMother.Create<Tenor>(); 
            ...
            mappingEngine.Setup(x => x.Map<RWEST.Nexus.MDM.Contracts.TenorDetails, Tenor>(cd)).Returns(d2);
