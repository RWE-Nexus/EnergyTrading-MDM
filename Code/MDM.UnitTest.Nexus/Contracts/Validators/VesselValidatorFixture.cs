namespace EnergyTrading.MDM.Test.Contracts.Validators
{
    ...
    using Vessel = RWEST.Nexus.MDM.Contracts.Vessel;

    [TestClass]
    public partial class VesselValidatorFixture : Fixture
    {
        [TestMethod]
        public void ValidatorResolution()
        {
            ...
            var validator = container.Resolve<IValidator<Vessel>>("vessel");
        ...
        public void ValidVesselPasses()
        {
            ...
            var validator = new VesselValidator(validatorEngine.Object, repository);

            var vessel = new Vessel { Identifiers = new RWEST.Nexus.MDM.Contracts.NexusIdList { identifier } };
            this.AddRelatedEntities(vessel);

            // Act
            var violations = new List<IRule>();
            var result = validator.IsValid(vessel, violations);
        ...
        public void OverlapsRangeFails()
        {
            ...
            var system = new MDM.SourceSystem { Name = "Test" };
            var vesselMapping = new VesselMapping { System = system, MappingValue = "1", Validity = validity };

            var list = new List<VesselMapping> { vesselMapping };
            var repository = new Mock<IRepository>();
            repository.Setup(x => x.Queryable<VesselMapping>()).Returns(list.AsQueryable());
            ...
            var identifierValidator = new NexusIdValidator<VesselMapping>(repository.Object);
            var validatorEngine = new Mock<IValidatorEngine>();
            ...
            var validator = new VesselValidator(validatorEngine.Object, repository.Object);

            var vessel = new Vessel { Identifiers = new RWEST.Nexus.MDM.Contracts.NexusIdList { overlapsRangeIdentifier } };
        ...
        public void BadSystemFails()
        {
            ...
            var vessel = new Vessel { Identifiers = new RWEST.Nexus.MDM.Contracts.NexusIdList { badSystemIdentifier } };
		...
		partial void AddRelatedEntities(RWEST.Nexus.MDM.Contracts.Vessel contract);
