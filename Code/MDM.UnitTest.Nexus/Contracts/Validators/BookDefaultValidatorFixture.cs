namespace EnergyTrading.MDM.Test.Contracts.Validators
{
    ...
    using BookDefault = RWEST.Nexus.MDM.Contracts.BookDefault;

    [TestClass]
    public partial class BookDefaultValidatorFixture : Fixture
    {
        [TestMethod]
        public void ValidatorResolution()
        {
            ...
            var validator = container.Resolve<IValidator<BookDefault>>("bookdefault");
        ...
        [TestMethod]
        public void ValidBookDefaultPasses()
        {
            // Assert
            ...
            var validator = new BookDefaultValidator(validatorEngine.Object, repository);

            var bookdefault = new BookDefault { Identifiers = new RWEST.Nexus.MDM.Contracts.NexusIdList { identifier } };
            this.AddRelatedEntities(bookdefault);

            // Act
            var violations = new List<IRule>();
            var result = validator.IsValid(bookdefault, violations);
        ...
        public void OverlapsRangeFails()
        {
            ...
            var system = new MDM.SourceSystem { Name = "Test" };
            var bookdefaultMapping = new BookDefaultMapping { System = system, MappingValue = "1", Validity = validity };

            var list = new List<BookDefaultMapping> { bookdefaultMapping };
            var repository = new Mock<IRepository>();
            ...
            var identifierValidator = new NexusIdValidator<BookDefaultMapping>(repository.Object);
            var validatorEngine = new Mock<IValidatorEngine>();
            ...
            var validator = new BookDefaultValidator(validatorEngine.Object, repository.Object);

            var bookdefault = new BookDefault { Identifiers = new RWEST.Nexus.MDM.Contracts.NexusIdList { overlapsRangeIdentifier } };
        ...
        public void BadSystemFails()
        {
            ...
            var bookdefault = new BookDefault { Identifiers = new RWEST.Nexus.MDM.Contracts.NexusIdList { badSystemIdentifier } };
        ...
        partial void AddRelatedEntities(RWEST.Nexus.MDM.Contracts.BookDefault contract);
