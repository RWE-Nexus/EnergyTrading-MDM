namespace EnergyTrading.MDM.Test.Contracts.Validators
{
    ...
    [TestClass]
    public partial class BrokerRateValidatorFixture : Fixture
    {
        [TestMethod]
        public void ValidatorResolution()
        {
            ...
            var config = new BrokerRateConfiguration(container);
            config.Configure();

            var validator = container.Resolve<IValidator<BrokerRate>>("brokerrate");
        ...
        [TestMethod]
        public void ValidBrokerRatePasses()
        {
            // Assert
            ...
            var validator = new BrokerRateValidator(validatorEngine.Object, repository);

            var brokerrate = new BrokerRate { Identifiers = new RWEST.Nexus.MDM.Contracts.NexusIdList { identifier } };
            this.AddRelatedEntities(brokerrate);

            // Act
            var violations = new List<IRule>();
            var result = validator.IsValid(brokerrate, violations);
        ...
        public void OverlapsRangeFails()
        {
            ...
            var system = new MDM.SourceSystem { Name = "Test" };
            var brokerrateMapping = new BrokerRateMapping { System = system, MappingValue = "1", Validity = validity };

            var list = new List<BrokerRateMapping> { brokerrateMapping };
            var repository = new Mock<IRepository>();
            ...
            var identifierValidator = new NexusIdValidator<BrokerRateMapping>(repository.Object);
            var validatorEngine = new Mock<IValidatorEngine>();
            ...
            var validator = new BrokerRateValidator(validatorEngine.Object, repository.Object);

            var brokerrate = new BrokerRate { Identifiers = new RWEST.Nexus.MDM.Contracts.NexusIdList { overlapsRangeIdentifier } };
        ...
        public void BadSystemFails()
        {
            ...
            var brokerrate = new BrokerRate { Identifiers = new RWEST.Nexus.MDM.Contracts.NexusIdList { badSystemIdentifier } };
		...
		partial void AddRelatedEntities(RWEST.Nexus.MDM.Contracts.BrokerRate contract);
