namespace EnergyTrading.MDM.Test.Contracts.Validators
{
    ...
    using BrokerCommodity = RWEST.Nexus.MDM.Contracts.BrokerCommodity;

    [TestClass]
    public partial class BrokerCommodityValidatorFixture : Fixture
    {
        [TestMethod]
        public void ValidatorResolution()
        {
            ...
            var validator = container.Resolve<IValidator<BrokerCommodity>>("brokercommodity");
        ...
        [TestMethod]
        public void ValidBrokerCommodityPasses()
        {
            // Assert
            ...
            var validator = new BrokerCommodityValidator(validatorEngine.Object, repository);

            var brokercommodity = new BrokerCommodity { Identifiers = new RWEST.Nexus.MDM.Contracts.NexusIdList { identifier } };
            this.AddRelatedEntities(brokercommodity);

            // Act
            var violations = new List<IRule>();
            var result = validator.IsValid(brokercommodity, violations);
        ...
        public void OverlapsRangeFails()
        {
            ...
            var system = new MDM.SourceSystem { Name = "Test" };
            var brokercommodityMapping = new BrokerCommodityMapping { System = system, MappingValue = "1", Validity = validity };

            var list = new List<BrokerCommodityMapping> { brokercommodityMapping };
            var repository = new Mock<IRepository>();
            repository.Setup(x => x.Queryable<BrokerCommodityMapping>()).Returns(list.AsQueryable());
            ...
            var identifierValidator = new NexusIdValidator<BrokerCommodityMapping>(repository.Object);
            var validatorEngine = new Mock<IValidatorEngine>();
            ...
            var validator = new BrokerCommodityValidator(validatorEngine.Object, repository.Object);

            var brokercommodity = new BrokerCommodity { Identifiers = new RWEST.Nexus.MDM.Contracts.NexusIdList { overlapsRangeIdentifier } };
        ...
        public void BadSystemFails()
        {
            ...
            var brokercommodity = new BrokerCommodity { Identifiers = new RWEST.Nexus.MDM.Contracts.NexusIdList { badSystemIdentifier } };
		...
		partial void AddRelatedEntities(RWEST.Nexus.MDM.Contracts.BrokerCommodity contract);
