namespace EnergyTrading.MDM.Test.Contracts.Validators
{
    ...
    using PortfolioHierarchy = RWEST.Nexus.MDM.Contracts.PortfolioHierarchy;

    [TestClass]
    public partial class PortfolioHierarchyValidatorFixture : Fixture
    {
        [TestMethod]
        public void ValidatorResolution()
        {
            ...
            var config = new PortfolioHierarchyConfiguration(container);
            config.Configure();

            var validator = container.Resolve<IValidator<PortfolioHierarchy>>("portfoliohierarchy");
        ...
        [TestMethod]
        public void ValidPortfolioHierarchyPasses()
        {
            // Assert
            ...
            var validator = new PortfolioHierarchyValidator(validatorEngine.Object, repository);

            var portfoliohierarchy = new PortfolioHierarchy { Identifiers = new RWEST.Nexus.MDM.Contracts.NexusIdList { identifier } };
            this.AddRelatedEntities(portfoliohierarchy);

            // Act
            var violations = new List<IRule>();
            var result = validator.IsValid(portfoliohierarchy, violations);
        ...
        public void OverlapsRangeFails()
        {
            ...
            var system = new MDM.SourceSystem { Name = "Test" };
            var portfoliohierarchyMapping = new PortfolioHierarchyMapping { System = system, MappingValue = "1", Validity = validity };

            var list = new List<PortfolioHierarchyMapping> { portfoliohierarchyMapping };
            var repository = new Mock<IRepository>();
            ...
            var identifierValidator = new NexusIdValidator<PortfolioHierarchyMapping>(repository.Object);
            var validatorEngine = new Mock<IValidatorEngine>();
            ...
            var validator = new PortfolioHierarchyValidator(validatorEngine.Object, repository.Object);

            var portfoliohierarchy = new PortfolioHierarchy { Identifiers = new RWEST.Nexus.MDM.Contracts.NexusIdList { overlapsRangeIdentifier } };
        ...
        public void BadSystemFails()
        {
            ...
            var portfoliohierarchy = new PortfolioHierarchy { Identifiers = new RWEST.Nexus.MDM.Contracts.NexusIdList { badSystemIdentifier } };
		...
		partial void AddRelatedEntities(RWEST.Nexus.MDM.Contracts.PortfolioHierarchy contract);
