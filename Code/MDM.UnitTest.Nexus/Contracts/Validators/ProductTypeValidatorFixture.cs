namespace EnergyTrading.MDM.Test.Contracts.Validators
{
    ...
    [TestClass]
    public partial class ProductTypeValidatorFixture : Fixture
    {
        [TestMethod]
        public void ValidatorResolution()
        {
            ...
            var validator = container.Resolve<IValidator<ProductType>>("producttype");
        ...
        [TestMethod]
        public void ValidProductTypePasses()
        {
            // Assert
            ...
            var validator = new ProductTypeValidator(validatorEngine.Object, repository);

            var producttype = new ProductType { Details = new RWEST.Nexus.MDM.Contracts.ProductTypeDetails{Name = "Test"}, Identifiers = new RWEST.Nexus.MDM.Contracts.NexusIdList { identifier } };
            producttype.Details.DeliveryRangeType = "test";
            this.AddRelatedEntities(producttype);

            // Act
            var violations = new List<IRule>();
            var result = validator.IsValid(producttype, violations);
        ...
        public void OverlapsRangeFails()
        {
            ...
            var system = new MDM.SourceSystem { Name = "Test" };
            var producttypeMapping = new ProductTypeMapping { System = system, MappingValue = "1", Validity = validity };

            var list = new List<ProductTypeMapping> { producttypeMapping };
            var repository = new Mock<IRepository>();
            repository.Setup(x => x.Queryable<ProductTypeMapping>()).Returns(list.AsQueryable());
            ...
            var identifierValidator = new NexusIdValidator<ProductTypeMapping>(repository.Object);
            var validatorEngine = new Mock<IValidatorEngine>();
            ...
            var validator = new ProductTypeValidator(validatorEngine.Object, repository.Object);

            var producttype = new ProductType { Identifiers = new RWEST.Nexus.MDM.Contracts.NexusIdList { overlapsRangeIdentifier } };
        ...
        public void BadSystemFails()
        {
            ...
            var producttype = new ProductType { Identifiers = new RWEST.Nexus.MDM.Contracts.NexusIdList { badSystemIdentifier } };
