namespace EnergyTrading.MDM.Test.Contracts.Validators
{
    ...
    using PartyOverride = RWEST.Nexus.MDM.Contracts.PartyOverride;

    [TestClass]
    public partial class PartyOverrideValidatorFixture : Fixture
    {
        [TestMethod]
        public void ValidatorResolution()
        {
            ...
            var validator = container.Resolve<IValidator<PartyOverride>>("partyoverride");
        ...
        [TestMethod]
        public void ValidPartyOverridePasses()
        {
            // Assert
            ...
            var validator = new PartyOverrideValidator(validatorEngine.Object, repository);

            var partyoverride = new PartyOverride { Identifiers = new RWEST.Nexus.MDM.Contracts.NexusIdList { identifier } };
            this.AddRelatedEntities(partyoverride);

            // Act
            var violations = new List<IRule>();
            var result = validator.IsValid(partyoverride, violations);
        ...
        public void OverlapsRangeFails()
        {
            ...
            var system = new MDM.SourceSystem { Name = "Test" };
            var partyoverrideMapping = new PartyOverrideMapping { System = system, MappingValue = "1", Validity = validity };

            var list = new List<PartyOverrideMapping> { partyoverrideMapping };
            var repository = new Mock<IRepository>();
            repository.Setup(x => x.Queryable<PartyOverrideMapping>()).Returns(list.AsQueryable());
            ...
            var identifierValidator = new NexusIdValidator<PartyOverrideMapping>(repository.Object);
            var validatorEngine = new Mock<IValidatorEngine>();
            ...
            var validator = new PartyOverrideValidator(validatorEngine.Object, repository.Object);

            var partyoverride = new PartyOverride { Identifiers = new RWEST.Nexus.MDM.Contracts.NexusIdList { overlapsRangeIdentifier } };
        ...
        public void BadSystemFails()
        {
            ...
            var partyoverride = new PartyOverride { Identifiers = new RWEST.Nexus.MDM.Contracts.NexusIdList { badSystemIdentifier } };
		...
		partial void AddRelatedEntities(RWEST.Nexus.MDM.Contracts.PartyOverride contract);
