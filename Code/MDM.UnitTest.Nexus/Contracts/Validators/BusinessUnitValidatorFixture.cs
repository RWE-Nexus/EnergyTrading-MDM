namespace EnergyTrading.MDM.Test.Contracts.Validators
{
    ...
    using BusinessUnit = RWEST.Nexus.MDM.Contracts.BusinessUnit;

    [TestClass]
    public partial class BusinessUnitValidatorFixture : Fixture
    {
        [TestMethod]
        public void ValidatorResolution()
        {
            ...
            var config = new BusinessUnitConfiguration(container);
            config.Configure();

            var validator = container.Resolve<IValidator<BusinessUnit>>("businessunit");
        ...
        [TestMethod]
        public void ValidBusinessUnitPasses()
        {
            // Assert
            ...
            var validator = new BusinessUnitValidator(validatorEngine.Object, repository);

            var businessunit = new BusinessUnit { Details = new RWEST.Nexus.MDM.Contracts.BusinessUnitDetails{Name = "Test"}, Identifiers = new RWEST.Nexus.MDM.Contracts.NexusIdList { identifier } };
            this.AddRelatedEntities(businessunit);

            // Act
            var violations = new List<IRule>();
            var result = validator.IsValid(businessunit, violations);
        ...
        public void OverlapsRangeFails()
        {
            ...
            var system = new MDM.SourceSystem { Name = "Test" };
            var businessunitMapping = new PartyRoleMapping { System = system, MappingValue = "1", Validity = validity };

            var list = new List<PartyRoleMapping> { businessunitMapping };
            var repository = new Mock<IRepository>();
            ...
            var validator = new BusinessUnitValidator(validatorEngine.Object, repository.Object);

            var businessunit = new BusinessUnit { Identifiers = new RWEST.Nexus.MDM.Contracts.NexusIdList { overlapsRangeIdentifier } };
        ...
        public void BadSystemFails()
        {
            ...
            var businessunit = new BusinessUnit { Identifiers = new RWEST.Nexus.MDM.Contracts.NexusIdList { badSystemIdentifier } };
