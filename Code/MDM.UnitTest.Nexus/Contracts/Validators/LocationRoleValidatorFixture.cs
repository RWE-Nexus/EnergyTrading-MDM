namespace EnergyTrading.MDM.Test.Contracts.Validators
{
    ...
    using LocationRole = RWEST.Nexus.MDM.Contracts.LocationRole;

    [TestClass]
    public partial class LocationRoleValidatorFixture : Fixture
    {
        [TestMethod]
        public void ValidatorResolution()
        {
            ...
            var validator = container.Resolve<IValidator<LocationRole>>("locationrole");
        ...
        [TestMethod]
        public void ValidLocationRolePasses()
        {
            // Assert
            ...
            var validator = new LocationRoleValidator(validatorEngine.Object, repository);

            var locationrole = new LocationRole { Identifiers = new RWEST.Nexus.MDM.Contracts.NexusIdList { identifier } };
            this.AddRelatedEntities(locationrole);

            // Act
            var violations = new List<IRule>();
            var result = validator.IsValid(locationrole, violations);
        ...
        public void OverlapsRangeFails()
        {
            ...
            var system = new MDM.SourceSystem { Name = "Test" };
            var locationroleMapping = new LocationRoleMapping { System = system, MappingValue = "1", Validity = validity };

            var list = new List<LocationRoleMapping> { locationroleMapping };
            var repository = new Mock<IRepository>();
            ...
            var identifierValidator = new NexusIdValidator<LocationRoleMapping>(repository.Object);
            var validatorEngine = new Mock<IValidatorEngine>();
            ...
            var validator = new LocationRoleValidator(validatorEngine.Object, repository.Object);

            var locationrole = new LocationRole { Identifiers = new RWEST.Nexus.MDM.Contracts.NexusIdList { overlapsRangeIdentifier } };
        ...
        public void BadSystemFails()
        {
            ...
            var locationrole = new LocationRole { Identifiers = new RWEST.Nexus.MDM.Contracts.NexusIdList { badSystemIdentifier } };
