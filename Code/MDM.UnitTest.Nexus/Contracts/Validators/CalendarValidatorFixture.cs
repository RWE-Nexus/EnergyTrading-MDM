namespace EnergyTrading.MDM.Test.Contracts.Validators
{
    ...
    [TestClass]
    public partial class CalendarValidatorFixture : Fixture
    {
        [TestMethod]
        public void ValidatorResolution()
        {
            ...
            var validator = container.Resolve<IValidator<Calendar>>("calendar");
        ...
        [TestMethod]
        public void ValidCalendarPasses()
        {
            // Assert
            ...
            var validator = new CalendarValidator(validatorEngine.Object, repository);

            var calendar = new Calendar { Details = new RWEST.Nexus.MDM.Contracts.CalendarDetails{Name = "Test"}, Identifiers = new RWEST.Nexus.MDM.Contracts.NexusIdList { identifier } };
            this.AddRelatedEntities(calendar);

            // Act
            var violations = new List<IRule>();
            var result = validator.IsValid(calendar, violations);
        ...
        public void OverlapsRangeFails()
        {
            ...
            var system = new MDM.SourceSystem { Name = "Test" };
            var calendarMapping = new CalendarMapping { System = system, MappingValue = "1", Validity = validity };

            var list = new List<CalendarMapping> { calendarMapping };
            var repository = new Mock<IRepository>();
            repository.Setup(x => x.Queryable<CalendarMapping>()).Returns(list.AsQueryable());
            ...
            var identifierValidator = new NexusIdValidator<CalendarMapping>(repository.Object);
            var validatorEngine = new Mock<IValidatorEngine>();
            ...
            var validator = new CalendarValidator(validatorEngine.Object, repository.Object);

            var calendar = new Calendar { Identifiers = new RWEST.Nexus.MDM.Contracts.NexusIdList { overlapsRangeIdentifier } };
        ...
        public void BadSystemFails()
        {
            ...
            var calendar = new Calendar { Identifiers = new RWEST.Nexus.MDM.Contracts.NexusIdList { badSystemIdentifier } };
		...
		partial void AddRelatedEntities(RWEST.Nexus.MDM.Contracts.Calendar contract);
