namespace EnergyTrading.MDM.Test.Contracts.Validators
{
    ...
    public class PersonValidatorFixture : Fixture
    {
        ...
        public void ValidatorResolution()
        {
            ...
            var validator = container.Resolve<IValidator<RWEST.Nexus.MDM.Contracts.Person>>("person");
        ...
        public void ValidPersonPasses()
        {
            ...
            var person = new RWEST.Nexus.MDM.Contracts.Person { Details = new RWEST.Nexus.MDM.Contracts.PersonDetails{Surname = "Test"}, Identifiers = new RWEST.Nexus.MDM.Contracts.NexusIdList { identifier } };
        ...
        public void OverlapsRangeFails()
        {
            ...
            var person = new RWEST.Nexus.MDM.Contracts.Person { Identifiers = new RWEST.Nexus.MDM.Contracts.NexusIdList { overlapsRangeIdentifier } };
        ...
        public void BadSystemFails()
        {
            ...
            var person = new RWEST.Nexus.MDM.Contracts.Person { Identifiers = new RWEST.Nexus.MDM.Contracts.NexusIdList { badSystemIdentifier } };
