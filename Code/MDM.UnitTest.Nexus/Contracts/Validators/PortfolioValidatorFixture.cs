namespace EnergyTrading.MDM.Test.Contracts.Validators
{
    ...
    using Portfolio = RWEST.Nexus.MDM.Contracts.Portfolio;

    [TestClass]
    public partial class PortfolioValidatorFixture : Fixture
    {
        [TestMethod]
        public void ValidatorResolution()
        {
            ...
            var validator = container.Resolve<IValidator<Portfolio>>("portfolio");
        ...
        [TestMethod]
        public void ValidPortfolioPasses()
        {
            // Assert
            ...
            var validator = new PortfolioValidator(validatorEngine.Object, repository);

            var portfolio = new Portfolio { Details = new RWEST.Nexus.MDM.Contracts.PortfolioDetails{Name = "Test"}, Identifiers = new RWEST.Nexus.MDM.Contracts.NexusIdList { identifier } };
            this.AddRelatedEntities(portfolio);
            portfolio.Details.PortfolioType = "Test";

            // Act
            var violations = new List<IRule>();
            var result = validator.IsValid(portfolio, violations);
        ...
        public void OverlapsRangeFails()
        {
            ...
            var system = new MDM.SourceSystem { Name = "Test" };
            var portfolioMapping = new PortfolioMapping { System = system, MappingValue = "1", Validity = validity };

            var list = new List<PortfolioMapping> { portfolioMapping };
            var repository = new Mock<IRepository>();
            repository.Setup(x => x.Queryable<PortfolioMapping>()).Returns(list.AsQueryable());
            ...
            var identifierValidator = new NexusIdValidator<PortfolioMapping>(repository.Object);
            var validatorEngine = new Mock<IValidatorEngine>();
            ...
            var validator = new PortfolioValidator(validatorEngine.Object, repository.Object);

            var portfolio = new Portfolio { Identifiers = new RWEST.Nexus.MDM.Contracts.NexusIdList { overlapsRangeIdentifier } };
        ...
        public void BadSystemFails()
        {
            ...
            var portfolio = new Portfolio { Identifiers = new RWEST.Nexus.MDM.Contracts.NexusIdList { badSystemIdentifier } };
		...
		partial void AddRelatedEntities(RWEST.Nexus.MDM.Contracts.Portfolio contract);
