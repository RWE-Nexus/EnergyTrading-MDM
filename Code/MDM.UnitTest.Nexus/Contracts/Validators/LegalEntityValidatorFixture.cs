namespace EnergyTrading.MDM.Test.Contracts.Validators
{
    ...
    using LegalEntity = RWEST.Nexus.MDM.Contracts.LegalEntity;
    ...
    public partial class LegalEntityValidatorFixture : Fixture
    {
        ...
        public void ValidLegalEntityPasses()
        {
            ...
            var legalentity = new LegalEntity { Identifiers = new RWEST.Nexus.MDM.Contracts.NexusIdList { identifier } };
        ...
        public void OverlapsRangeFails()
        {
            ...
            var legalentity = new LegalEntity { Identifiers = new RWEST.Nexus.MDM.Contracts.NexusIdList { overlapsRangeIdentifier } };
        ...
        public void BadSystemFails()
        {
            ...
            var legalentity = new LegalEntity { Identifiers = new RWEST.Nexus.MDM.Contracts.NexusIdList { badSystemIdentifier } };
        ...
        partial void AddRelatedEntities(RWEST.Nexus.MDM.Contracts.LegalEntity contract);
