namespace EnergyTrading.MDM.Test.Contracts.Validators
{
    ...
    [TestClass]
    public partial class InstrumentTypeOverrideValidatorFixture : Fixture
    {
        [TestMethod]
        public void ValidatorResolution()
        {
            ...
            var config = new InstrumentTypeOverrideConfiguration(container);
            config.Configure();

            var validator = container.Resolve<IValidator<InstrumentTypeOverride>>("instrumenttypeoverride");
        ...
        [TestMethod]
        public void ValidInstrumentTypeOverridePasses()
        {
            // Assert
            ...
            var validator = new InstrumentTypeOverrideValidator(validatorEngine.Object, repository);

            var instrumenttypeoverride = new InstrumentTypeOverride { Identifiers = new RWEST.Nexus.MDM.Contracts.NexusIdList { identifier } };
            this.AddRelatedEntities(instrumenttypeoverride);

            // Act
            var violations = new List<IRule>();
            var result = validator.IsValid(instrumenttypeoverride, violations);
        ...
        public void OverlapsRangeFails()
        {
            ...
            var system = new MDM.SourceSystem { Name = "Test" };
            var instrumenttypeoverrideMapping = new InstrumentTypeOverrideMapping { System = system, MappingValue = "1", Validity = validity };

            var list = new List<InstrumentTypeOverrideMapping> { instrumenttypeoverrideMapping };
            var repository = new Mock<IRepository>();
            repository.Setup(x => x.Queryable<InstrumentTypeOverrideMapping>()).Returns(list.AsQueryable());
            ...
            var identifierValidator = new NexusIdValidator<InstrumentTypeOverrideMapping>(repository.Object);
            var validatorEngine = new Mock<IValidatorEngine>();
            ...
            var validator = new InstrumentTypeOverrideValidator(validatorEngine.Object, repository.Object);

            var instrumenttypeoverride = new InstrumentTypeOverride { Identifiers = new RWEST.Nexus.MDM.Contracts.NexusIdList { overlapsRangeIdentifier } };
        ...
        public void BadSystemFails()
        {
            ...
            var instrumenttypeoverride = new InstrumentTypeOverride { Identifiers = new RWEST.Nexus.MDM.Contracts.NexusIdList { badSystemIdentifier } };
		...
		partial void AddRelatedEntities(RWEST.Nexus.MDM.Contracts.InstrumentTypeOverride contract);
