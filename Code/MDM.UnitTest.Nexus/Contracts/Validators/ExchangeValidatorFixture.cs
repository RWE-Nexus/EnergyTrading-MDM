namespace EnergyTrading.MDM.Test.Contracts.Validators
{
    ...
    using Exchange = RWEST.Nexus.MDM.Contracts.Exchange;
    ...
    public partial class ExchangeValidatorFixture : Fixture
    {
        ...
        public void ValidExchangePasses()
        {
            ...
            var exchange = new Exchange { Details = new RWEST.Nexus.MDM.Contracts.ExchangeDetails{Name = "Test"}, Identifiers = new RWEST.Nexus.MDM.Contracts.NexusIdList { identifier } };
        ...
        public void OverlapsRangeFails()
        {
            ...
            var exchange = new Exchange { Identifiers = new RWEST.Nexus.MDM.Contracts.NexusIdList { overlapsRangeIdentifier } };
        ...
        public void BadSystemFails()
        {
            ...
            var exchange = new Exchange { Identifiers = new RWEST.Nexus.MDM.Contracts.NexusIdList { badSystemIdentifier } };
