namespace EnergyTrading.MDM.Test.Contracts.Validators
{
    ...
    using FeeType = RWEST.Nexus.MDM.Contracts.FeeType;

    [TestClass]
    public partial class FeeTypeValidatorFixture : Fixture
    {
        [TestMethod]
        public void ValidatorResolution()
        {
            ...
            var validator = container.Resolve<IValidator<FeeType>>("feetype");
        ...
        [TestMethod]
        public void ValidFeeTypePasses()
        {
            // Assert
            ...
            var validator = new FeeTypeValidator(validatorEngine.Object, repository);

            var feetype = new FeeType { Identifiers = new RWEST.Nexus.MDM.Contracts.NexusIdList { identifier } };
            this.AddRelatedEntities(feetype);

            // Act
            var violations = new List<IRule>();
            var result = validator.IsValid(feetype, violations);
        ...
        public void OverlapsRangeFails()
        {
            ...
            var system = new MDM.SourceSystem { Name = "Test" };
            var feetypeMapping = new FeeTypeMapping { System = system, MappingValue = "1", Validity = validity };

            var list = new List<FeeTypeMapping> { feetypeMapping };
            var repository = new Mock<IRepository>();
            repository.Setup(x => x.Queryable<FeeTypeMapping>()).Returns(list.AsQueryable());
            ...
            var identifierValidator = new NexusIdValidator<FeeTypeMapping>(repository.Object);
            var validatorEngine = new Mock<IValidatorEngine>();
            ...
            var validator = new FeeTypeValidator(validatorEngine.Object, repository.Object);

            var feetype = new FeeType { Identifiers = new RWEST.Nexus.MDM.Contracts.NexusIdList { overlapsRangeIdentifier } };
        ...
        public void BadSystemFails()
        {
            ...
            var feetype = new FeeType { Identifiers = new RWEST.Nexus.MDM.Contracts.NexusIdList { badSystemIdentifier } };
		...
		partial void AddRelatedEntities(RWEST.Nexus.MDM.Contracts.FeeType contract);
