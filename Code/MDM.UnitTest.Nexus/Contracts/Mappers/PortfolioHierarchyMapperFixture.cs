namespace EnergyTrading.MDM.Test.Contracts.Mappers
{
    ...
    [TestClass]
    public class PortfolioHierarchyMapperFixture : Fixture
    {
        [TestMethod]
        public void Resolve()
        {
            ...
            var validator = container.Resolve<IMapper<RWEST.Nexus.MDM.Contracts.PortfolioHierarchy, PortfolioHierarchy>>();
        ...
        public void Map()
        {
            ...
            var contractDetails = new RWEST.Nexus.MDM.Contracts.PortfolioHierarchyDetails();
            ...
            var details = new PortfolioHierarchy();

            var mapping = new PortfolioHierarchyMapping();

            var mappingEngine = new Mock<IMappingEngine>();
            mappingEngine.Setup(x => x.Map<RWEST.Nexus.MDM.Contracts.NexusId, PortfolioHierarchyMapping>(id)).Returns(mapping);
            mappingEngine.Setup(x => x.Map<RWEST.Nexus.MDM.Contracts.PortfolioHierarchyDetails, PortfolioHierarchy>(contractDetails)).Returns(details);

            var mapper = new PortfolioHierarchyMapper(mappingEngine.Object);
