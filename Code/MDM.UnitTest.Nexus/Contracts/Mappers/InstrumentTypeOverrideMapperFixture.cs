namespace EnergyTrading.MDM.Test.Contracts.Mappers
{
    ...
    [TestClass]
    public class InstrumentTypeOverrideMapperFixture : Fixture
    {
        [TestMethod]
        public void Resolve()
        {
            ...
            var validator = container.Resolve<IMapper<RWEST.Nexus.MDM.Contracts.InstrumentTypeOverride, InstrumentTypeOverride>>();
        ...
        public void Map()
        {
            ...
            var contractDetails = new RWEST.Nexus.MDM.Contracts.InstrumentTypeOverrideDetails();
            ...
            var details = new InstrumentTypeOverride();

            var mapping = new InstrumentTypeOverrideMapping();

            var mappingEngine = new Mock<IMappingEngine>();
            mappingEngine.Setup(x => x.Map<RWEST.Nexus.MDM.Contracts.NexusId, InstrumentTypeOverrideMapping>(id)).Returns(mapping);
            mappingEngine.Setup(x => x.Map<RWEST.Nexus.MDM.Contracts.InstrumentTypeOverrideDetails, InstrumentTypeOverride>(contractDetails)).Returns(details);

            var mapper = new InstrumentTypeOverrideMapper(mappingEngine.Object);
