namespace EnergyTrading.MDM.Test.Contracts.Mappers
{
    ...
    [TestClass]
    public class CommodityMapperFixture : Fixture
    {
        [TestMethod]
        public void Resolve()
        {
            ...
            var validator = container.Resolve<IMapper<RWEST.Nexus.MDM.Contracts.Commodity, Commodity>>();
        ...
        public void Map()
        {
            ...
            var contractDetails = new RWEST.Nexus.MDM.Contracts.CommodityDetails();
            ...
            var details = new Commodity();

            var mapping = new CommodityMapping();

            var mappingEngine = new Mock<IMappingEngine>();
            mappingEngine.Setup(x => x.Map<RWEST.Nexus.MDM.Contracts.NexusId, CommodityMapping>(id)).Returns(mapping);
            mappingEngine.Setup(x => x.Map<RWEST.Nexus.MDM.Contracts.CommodityDetails, Commodity>(contractDetails)).Returns(details);

            var mapper = new CommodityMapper(mappingEngine.Object);
