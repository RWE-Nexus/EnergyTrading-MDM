namespace EnergyTrading.MDM.Test.Contracts.Mappers
{
    ...
    [TestClass]
    public class ShipperCodeMapperFixture : Fixture
    {
        [TestMethod]
        public void Resolve()
        {
            ...
            var validator = container.Resolve<IMapper<RWEST.Nexus.MDM.Contracts.ShipperCode, ShipperCode>>();
        ...
        public void Map()
        {
            ...
            var contractDetails = new RWEST.Nexus.MDM.Contracts.ShipperCodeDetails();
            ...
            var details = new ShipperCode();

            var mapping = new ShipperCodeMapping();

            var mappingEngine = new Mock<IMappingEngine>();
            mappingEngine.Setup(x => x.Map<RWEST.Nexus.MDM.Contracts.NexusId, ShipperCodeMapping>(id)).Returns(mapping);
            mappingEngine.Setup(x => x.Map<RWEST.Nexus.MDM.Contracts.ShipperCodeDetails, ShipperCode>(contractDetails)).Returns(details);

            var mapper = new ShipperCodeMapper(mappingEngine.Object);
