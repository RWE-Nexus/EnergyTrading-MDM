namespace EnergyTrading.MDM.Test.Contracts.Mappers
{
    ...
    [TestClass]
    public class ProductTypeInstanceMapperFixture : Fixture
    {
        [TestMethod]
        public void Resolve()
        {
            ...
            var validator = container.Resolve<IMapper<RWEST.Nexus.MDM.Contracts.ProductTypeInstance, ProductTypeInstance>>();
        ...
        public void Map()
        {
            ...
            var contractDetails = new RWEST.Nexus.MDM.Contracts.ProductTypeInstanceDetails();
            ...
            var details = new ProductTypeInstance();

            var mapping = new ProductTypeInstanceMapping();

            var mappingEngine = new Mock<IMappingEngine>();
            mappingEngine.Setup(x => x.Map<RWEST.Nexus.MDM.Contracts.NexusId, ProductTypeInstanceMapping>(id)).Returns(mapping);
            mappingEngine.Setup(x => x.Map<RWEST.Nexus.MDM.Contracts.ProductTypeInstanceDetails, ProductTypeInstance>(contractDetails)).Returns(details);

            var mapper = new ProductTypeInstanceMapper(mappingEngine.Object);
