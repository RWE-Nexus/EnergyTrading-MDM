namespace EnergyTrading.MDM.Test.Contracts.Mappers
{
    ...
    public class LocationMapperFixture : Fixture
    {
        ...
        public void Resolve()
        {
            ...
            var validator = container.Resolve<IMapper<RWEST.Nexus.MDM.Contracts.Location, Location>>();
        ...
        public void Map()
        {
            ...
            var contractDetails = new RWEST.Nexus.MDM.Contracts.LocationDetails();
            ...
            mappingEngine.Setup(x => x.Map<RWEST.Nexus.MDM.Contracts.NexusId, LocationMapping>(id)).Returns(mapping);
            mappingEngine.Setup(x => x.Map<RWEST.Nexus.MDM.Contracts.LocationDetails, Location>(contractDetails)).Returns(details);
