namespace EnergyTrading.MDM.Test.Contracts.Mappers
{
    ...
    public class PersonMapperFixture : Fixture
    {
        ...
        public void Resolve()
        {
            ...
            var validator = container.Resolve<IMapper<RWEST.Nexus.MDM.Contracts.Person, Person>>();
        ...
        public void Map()
        {
            ...
            var contractDetails = new RWEST.Nexus.MDM.Contracts.PersonDetails();
            ...
            mappingEngine.Setup(x => x.Map<RWEST.Nexus.MDM.Contracts.NexusId, PersonMapping>(id)).Returns(mapping);
            mappingEngine.Setup(x => x.Map<RWEST.Nexus.MDM.Contracts.PersonDetails, PersonDetails>(contractDetails)).Returns(personDetails);
