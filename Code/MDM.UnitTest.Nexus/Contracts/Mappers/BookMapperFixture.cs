namespace EnergyTrading.MDM.Test.Contracts.Mappers
{
    ...
    [TestClass]
    public class BookMapperFixture : Fixture
    {
        [TestMethod]
        public void Resolve()
        {
            ...
            var validator = container.Resolve<IMapper<RWEST.Nexus.MDM.Contracts.Book, Book>>();
        ...
        public void Map()
        {
            ...
            var contractDetails = new RWEST.Nexus.MDM.Contracts.BookDetails();
            ...
            mappingEngine.Setup(x => x.Map<RWEST.Nexus.MDM.Contracts.NexusId, BookMapping>(id)).Returns(mapping);
            mappingEngine.Setup(x => x.Map<RWEST.Nexus.MDM.Contracts.BookDetails, Book>(contractDetails)).Returns(details);

            var mapper = new BookMapper(mappingEngine.Object);
