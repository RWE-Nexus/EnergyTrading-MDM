namespace EnergyTrading.MDM.Test.Contracts.Mappers
{
    ...
    [TestClass]
    public class InstrumentTypeMapperFixture : Fixture
    {
        [TestMethod]
        public void Resolve()
        {
            ...
            var validator = container.Resolve<IMapper<RWEST.Nexus.MDM.Contracts.InstrumentType, InstrumentType>>();
        ...
        public void Map()
        {
            ...
            var contractDetails = new RWEST.Nexus.MDM.Contracts.InstrumentTypeDetails();
            ...
            var details = new InstrumentType();

            var mapping = new InstrumentTypeMapping();

            var mappingEngine = new Mock<IMappingEngine>();
            mappingEngine.Setup(x => x.Map<RWEST.Nexus.MDM.Contracts.NexusId, InstrumentTypeMapping>(id)).Returns(mapping);
            mappingEngine.Setup(x => x.Map<RWEST.Nexus.MDM.Contracts.InstrumentTypeDetails, InstrumentType>(contractDetails)).Returns(details);

            var mapper = new InstrumentTypeMapper(mappingEngine.Object);
