namespace EnergyTrading.MDM.Test.Contracts.Mappers
{
    ...
    public class PartyRoleMapperFixture : Fixture
    {
        ...
        public void Map()
        {
            ...
            var contractDetails = new RWEST.Nexus.MDM.Contracts.PartyRoleDetails();
            ...
            mappingEngine.Setup(x => x.Map<RWEST.Nexus.MDM.Contracts.PartyRoleDetails, PartyRoleDetails>(contractDetails)).Returns(details);
