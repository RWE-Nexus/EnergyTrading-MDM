namespace EnergyTrading.MDM.Configuration
{
    ...
    public class SettlementContactConfiguration : EntityConfiguration<Services.SettlementContactService, MDM.SettlementContact, RWEST.Nexus.MDM.Contracts.SettlementContact, 
