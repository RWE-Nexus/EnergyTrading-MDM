namespace EnergyTrading.MDM.Configuration
{
    ...
    public class PartyAccountabilityConfiguration : EntityConfiguration<Services.PartyAccountabilityService, MDM.PartyAccountability, RWEST.Nexus.MDM.Contracts.PartyAccountability, 
