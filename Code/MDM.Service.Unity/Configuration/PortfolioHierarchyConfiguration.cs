namespace EnergyTrading.MDM.Configuration
{
    ...
    public class PortfolioHierarchyConfiguration : EntityConfiguration<Services.PortfolioHierarchyService, MDM.PortfolioHierarchy, RWEST.Nexus.MDM.Contracts.PortfolioHierarchy, 
