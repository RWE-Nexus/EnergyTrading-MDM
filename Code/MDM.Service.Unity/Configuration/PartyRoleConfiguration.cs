namespace EnergyTrading.MDM.Configuration
{
    ...
    public class PartyRoleConfiguration : EntityConfiguration<Services.PartyRoleService, MDM.PartyRole, RWEST.Nexus.MDM.Contracts.PartyRole, PartyRoleMapping, PartyRoleValidator>
    {
