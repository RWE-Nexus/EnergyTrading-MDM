namespace EnergyTrading.MDM.Configuration
{
    ...
    public class CommodityFeeTypeConfiguration : EntityConfiguration<Services.CommodityFeeTypeService, MDM.CommodityFeeType, RWEST.Nexus.MDM.Contracts.CommodityFeeType, 
