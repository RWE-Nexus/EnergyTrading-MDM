namespace EnergyTrading.MDM.Configuration
{
    ...
    public class CommodityInstrumentTypeConfiguration : EntityConfiguration<Services.CommodityInstrumentTypeService, MDM.CommodityInstrumentType, RWEST.Nexus.MDM.Contracts.CommodityInstrumentType, 
