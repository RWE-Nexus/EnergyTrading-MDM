namespace EnergyTrading.MDM.ServiceHost.Wcf.Nexus.Legacy
{
    ...
    public class CommodityInstrumentTypeService : LegacyEntityService<RWEST.Nexus.MDM.Contracts.CommodityInstrumentType, OpenNexus.MDM.Contracts.CommodityInstrumentType, MDM.CommodityInstrumentType>
    {
        /// <summary>
        ...
        public void Create(CommodityInstrumentType contract)
        {
        ...
        public CommodityInstrumentTypeList List()
        {
            var list = new CommodityInstrumentTypeList();
        ...
        public IList<CommodityInstrumentType> GetEntityList(string id)
        {
            var list = new List<CommodityInstrumentType>();
        ...
        //[AspNetCacheProfile("MdmEntityCache")]
        public CommodityInstrumentType Get(string id)
        {
        ...
        // [AspNetCacheProfile("MdmMappingCache")]
        public CommodityInstrumentType Map()
        {
        ...
        public void Update(string id, CommodityInstrumentType contract)
        {
