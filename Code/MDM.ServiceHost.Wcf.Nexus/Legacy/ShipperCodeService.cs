namespace EnergyTrading.MDM.ServiceHost.Wcf.Nexus.Legacy
{
    ...
    public class ShipperCodeService : LegacyEntityService<RWEST.Nexus.MDM.Contracts.ShipperCode, OpenNexus.MDM.Contracts.ShipperCode, MDM.ShipperCode>
    {
        /// <summary>
        ...
        public void Create(ShipperCode contract)
        {
        ...
        public ShipperCodeList List()
        {
            var list = new ShipperCodeList();
        ...
        public IList<ShipperCode> GetEntityList(string id)
        {
            var list = new List<ShipperCode>();
        ...
        //[AspNetCacheProfile("MdmEntityCache")]
        public ShipperCode Get(string id)
        {
        ...
        public void Update(string id, ShipperCode contract)
        {
