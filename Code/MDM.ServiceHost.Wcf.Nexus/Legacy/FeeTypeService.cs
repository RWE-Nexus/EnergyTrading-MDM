namespace EnergyTrading.MDM.ServiceHost.Wcf.Nexus.Legacy
{
    ...
    public class FeeTypeService : LegacyEntityService<RWEST.Nexus.MDM.Contracts.FeeType, OpenNexus.MDM.Contracts.FeeType, MDM.FeeType>
    {
        /// <summary>
        ...
        public void Create(FeeType contract)
        {
        ...
        public FeeTypeList List()
        {
            var list = new FeeTypeList();
        ...
        public IList<FeeType> GetEntityList(string id)
        {
            var list = new List<FeeType>();
        ...
        public void Update(string id, FeeType contract)
        {
