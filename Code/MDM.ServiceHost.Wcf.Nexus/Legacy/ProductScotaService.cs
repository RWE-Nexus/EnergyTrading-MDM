namespace EnergyTrading.MDM.ServiceHost.Wcf.Nexus.Legacy
{
    ...
    public class ProductScotaService : LegacyEntityService<RWEST.Nexus.MDM.Contracts.ProductScota, OpenNexus.MDM.Contracts.ProductScota, MDM.ProductScota>
    {
        /// <summary>
        ...
        public void Create(ProductScota contract)
        {
        ...
        public ProductScotaList List()
        {
            var list = new ProductScotaList();
        ...
        public IList<ProductScota> GetEntityList(string id)
        {
            var list = new List<ProductScota>();
        ...
        //[AspNetCacheProfile("MdmEntityCache")]
        public ProductScota Get(string id)
        {
        ...
        public void Update(string id, ProductScota contract)
        {
