namespace EnergyTrading.MDM.ServiceHost.Wcf.Nexus.Legacy
{
    ...
    public class BusinessUnitService : LegacyEntityService<RWEST.Nexus.MDM.Contracts.BusinessUnit, OpenNexus.MDM.Contracts.BusinessUnit, MDM.BusinessUnit>
    {
        /// <summary>
        ...
        public void Create(BusinessUnit contract)
        {
        ...
        public BusinessUnitList List()
        {
            var list = new BusinessUnitList();
        ...
        public IList<BusinessUnit> GetEntityList(string id)
        {
        ...
        public void Update(string id, BusinessUnit contract)
        {
