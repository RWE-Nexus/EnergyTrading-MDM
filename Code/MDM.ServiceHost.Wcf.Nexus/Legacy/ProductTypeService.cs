namespace EnergyTrading.MDM.ServiceHost.Wcf.Nexus.Legacy
{
    ...
    public class ProductTypeService : LegacyEntityService<RWEST.Nexus.MDM.Contracts.ProductType, OpenNexus.MDM.Contracts.ProductType, MDM.ProductType>
    {
        /// <summary>
        ...
        public void Create(ProductType contract)
        {
        ...
        public ProductTypeList List()
        {
            var list = new ProductTypeList();
        ...
        public IList<ProductType> GetEntityList(string id)
        {
        ...
        public void Update(string id, ProductType contract)
        {
