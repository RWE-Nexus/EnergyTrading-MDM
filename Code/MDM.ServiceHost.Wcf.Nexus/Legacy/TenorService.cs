namespace EnergyTrading.MDM.ServiceHost.Wcf.Nexus.Legacy
{
    ...
    public class TenorService : LegacyEntityService<RWEST.Nexus.MDM.Contracts.Tenor, OpenNexus.MDM.Contracts.Tenor, MDM.Tenor>
    {
        /// <summary>
        ...
        public void Create(Tenor contract)
        {
        ...
        public TenorList List()
        {
            var list = new TenorList();
        ...
        public IList<Tenor> GetEntityList(string id)
        {
            var list = new List<Tenor>();
        ...
        public void Update(string id, Tenor contract)
        {
