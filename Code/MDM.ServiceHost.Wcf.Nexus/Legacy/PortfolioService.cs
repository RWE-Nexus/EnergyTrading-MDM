namespace EnergyTrading.MDM.ServiceHost.Wcf.Nexus.Legacy
{
    ...
    public class PortfolioService : LegacyEntityService<RWEST.Nexus.MDM.Contracts.Portfolio, OpenNexus.MDM.Contracts.Portfolio, MDM.Portfolio>
    {
        /// <summary>
        ...
        public void Create(Portfolio contract)
        {
        ...
        public PortfolioList List()
        {
            var list = new PortfolioList();
        ...
        public IList<Portfolio> GetEntityList(string id)
        {
        ...
        public void Update(string id, Portfolio contract)
        {
