namespace EnergyTrading.MDM.ServiceHost.Wcf.Nexus.Legacy
{
    ...
    public class MarketService : LegacyEntityService<RWEST.Nexus.MDM.Contracts.Market, OpenNexus.MDM.Contracts.Market, MDM.Market>
    {
        /// <summary>
        ...
        public void Create(Market contract)
        {
        ...
        public IList<Market> GetEntityList(string id)
        {
        ...
        public void Update(string id, Market contract)
        {
