namespace EnergyTrading.MDM.ServiceHost.Wcf.Nexus.Legacy
{
    ...
    public class BookDefaultService : LegacyEntityService<RWEST.Nexus.MDM.Contracts.BookDefault, OpenNexus.MDM.Contracts.BookDefault, MDM.BookDefault>
    {
        /// <summary>
        ...
        public void Create(BookDefault contract)
        {
        ...
        public BookDefaultList List()
        {
            var list = new BookDefaultList();
        ...
        public IList<BookDefault> GetEntityList(string id)
        {
            var list = new List<BookDefault>();
        ...
        //[AspNetCacheProfile("MdmEntityCache")]
        public BookDefault Get(string id)
        {
        ...
        public void Update(string id, BookDefault contract)
        {
