namespace EnergyTrading.MDM.ServiceHost.Wcf.Nexus.Legacy
{
    ...
    public class UnitService : LegacyEntityService<RWEST.Nexus.MDM.Contracts.Unit, OpenNexus.MDM.Contracts.Unit, MDM.Unit>
    {
        /// <summary>
        ...
        public void Create(Unit contract)
        {
        ...
        public void Update(string id, Unit contract)
        {
