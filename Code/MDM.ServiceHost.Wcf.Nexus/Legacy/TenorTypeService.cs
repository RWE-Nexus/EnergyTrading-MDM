namespace EnergyTrading.MDM.ServiceHost.Wcf.Nexus.Legacy
{
    ...
    public class TenorTypeService : LegacyEntityService<RWEST.Nexus.MDM.Contracts.TenorType, OpenNexus.MDM.Contracts.TenorType, MDM.TenorType>
    {
        /// <summary>
        ...
        public void Create(TenorType contract)
        {
        ...
        public TenorTypeList List()
        {
            var list = new TenorTypeList();
        ...
        public IList<TenorType> GetEntityList(string id)
        {
            var list = new List<TenorType>();
        ...
        //[AspNetCacheProfile("MdmEntityCache")]
        public TenorType Get(string id)
        {
        ...
        public void Update(string id, TenorType contract)
        {
