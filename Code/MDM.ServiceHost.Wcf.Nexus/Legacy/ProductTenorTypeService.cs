namespace EnergyTrading.MDM.ServiceHost.Wcf.Nexus.Legacy
{
    ...
    public class ProductTenorTypeService : LegacyEntityService<RWEST.Nexus.MDM.Contracts.ProductTenorType, OpenNexus.MDM.Contracts.ProductTenorType, MDM.ProductTenorType>
    {
        /// <summary>
        ...
        public void Create(ProductTenorType contract)
        {
        ...
        public ProductTenorTypeList List()
        {
            var list = new ProductTenorTypeList();
        ...
        public IList<ProductTenorType> GetEntityList(string id)
        {
            var list = new List<ProductTenorType>();
        ...
        //[AspNetCacheProfile("MdmEntityCache")]
        public ProductTenorType Get(string id)
        {
        ...
        public void Update(string id, ProductTenorType contract)
        {
