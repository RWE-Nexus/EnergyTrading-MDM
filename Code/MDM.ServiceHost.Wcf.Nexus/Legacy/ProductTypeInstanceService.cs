namespace EnergyTrading.MDM.ServiceHost.Wcf.Nexus.Legacy
{
    ...
    public class ProductTypeInstanceService : LegacyEntityService<RWEST.Nexus.MDM.Contracts.ProductTypeInstance, OpenNexus.MDM.Contracts.ProductTypeInstance, MDM.ProductTypeInstance>
    {
        /// <summary>
        ...
        public void Create(ProductTypeInstance contract)
        {
        ...
        public ProductTypeInstanceList List()
        {
            var list = new ProductTypeInstanceList();
        ...
        public IList<ProductTypeInstance> GetEntityList(string id)
        {
            var list = new List<ProductTypeInstance>();
        ...
        //[AspNetCacheProfile("MdmEntityCache")]
        public ProductTypeInstance Get(string id)
        {
        ...
        // [AspNetCacheProfile("MdmMappingCache")]
        public ProductTypeInstance Map()
        {
        ...
        public void Update(string id, ProductTypeInstance contract)
        {
