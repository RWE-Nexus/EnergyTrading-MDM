namespace EnergyTrading.MDM.ServiceHost.Wcf.Nexus.Legacy
{
    ...
    public class DimensionService : LegacyEntityService<RWEST.Nexus.MDM.Contracts.Dimension, OpenNexus.MDM.Contracts.Dimension, MDM.Dimension>
    {
        /// <summary>
        ...
        public void Create(Dimension contract)
        {
        ...
        public DimensionList List()
        {
            var list = new DimensionList();
        ...
        public IList<Dimension> GetEntityList(string id)
        {
        ...
        public void Update(string id, Dimension contract)
        {
