namespace EnergyTrading.MDM.ServiceHost.Wcf.Nexus.Legacy
{
    ...
    public class BrokerRateService : LegacyEntityService<RWEST.Nexus.MDM.Contracts.BrokerRate, OpenNexus.MDM.Contracts.BrokerRate, MDM.BrokerRate>
    {
        /// <summary>
        ...
        public Message Search(RWEST.Nexus.Contracts.Search.Search search)
        {
            ...
            var result = this.DirectSearchHandler(entitySearchCommand, search.FromNexus());
