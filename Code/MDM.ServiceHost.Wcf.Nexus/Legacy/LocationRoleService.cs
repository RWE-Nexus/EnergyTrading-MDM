namespace EnergyTrading.MDM.ServiceHost.Wcf.Nexus.Legacy
{
    ...
    public class LocationRoleService : LegacyEntityService<RWEST.Nexus.MDM.Contracts.LocationRole, OpenNexus.MDM.Contracts.LocationRole, MDM.LocationRole>
    {
        /// <summary>
        ...
        public void Create(LocationRole contract)
        {
        ...
        public LocationRoleList List()
        {
            var list = new LocationRoleList();
        ...
        public IList<LocationRole> GetEntityList(string id)
        {
            var list = new List<LocationRole>();
        ...
        //[AspNetCacheProfile("MdmEntityCache")]
        public LocationRole Get(string id)
        {
        ...
        public void Update(string id, LocationRole contract)
        {
