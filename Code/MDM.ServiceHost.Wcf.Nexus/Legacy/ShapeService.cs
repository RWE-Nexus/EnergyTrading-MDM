namespace EnergyTrading.MDM.ServiceHost.Wcf.Nexus.Legacy
{
    ...
    public class ShapeService : LegacyEntityService<RWEST.Nexus.MDM.Contracts.Shape, OpenNexus.MDM.Contracts.Shape, MDM.Shape>
    {
        /// <summary>
        ...
        public void Create(Shape contract)
        {
        ...
        public IList<Shape> GetEntityList(string id)
        {
        ...
        public void Update(string id, Shape contract)
        {
