namespace EnergyTrading.MDM.ServiceHost.Wcf.Nexus.Legacy
{
    ...
    public class CommodityFeeTypeService : LegacyEntityService<RWEST.Nexus.MDM.Contracts.CommodityFeeType, OpenNexus.MDM.Contracts.CommodityFeeType, MDM.CommodityFeeType>
    {
        /// <summary>
        ...
        public void Create(CommodityFeeType contract)
        {
        ...
        public CommodityFeeTypeList List()
        {
            var list = new CommodityFeeTypeList();
        ...
        public IList<CommodityFeeType> GetEntityList(string id)
        {
            var list = new List<CommodityFeeType>();
        ...
        //[AspNetCacheProfile("MdmEntityCache")]
        public CommodityFeeType Get(string id)
        {
        ...
        public void Update(string id, CommodityFeeType contract)
        {
