namespace EnergyTrading.MDM.ServiceHost.Wcf.Nexus.Legacy
{
    ...
    public class InstrumentTypeOverrideService : LegacyEntityService<RWEST.Nexus.MDM.Contracts.InstrumentTypeOverride, OpenNexus.MDM.Contracts.InstrumentTypeOverride, MDM.InstrumentTypeOverride>
    {
        /// <summary>
        ...
        public void Create(InstrumentTypeOverride contract)
        {
        ...
        public InstrumentTypeOverrideList List()
        {
            var list = new InstrumentTypeOverrideList();
        ...
        public IList<InstrumentTypeOverride> GetEntityList(string id)
        {
            var list = new List<InstrumentTypeOverride>();
        ...
        //[AspNetCacheProfile("MdmEntityCache")]
        public InstrumentTypeOverride Get(string id)
        {
        ...
        // [AspNetCacheProfile("MdmMappingCache")]
        public InstrumentTypeOverride Map()
        {
        ...
        public void Update(string id, InstrumentTypeOverride contract)
        {
