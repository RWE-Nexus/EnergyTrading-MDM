namespace EnergyTrading.MDM.ServiceHost.Wcf.Nexus.Legacy
{
    ...
    public class BrokerCommodityService : LegacyEntityService<RWEST.Nexus.MDM.Contracts.BrokerCommodity, OpenNexus.MDM.Contracts.BrokerCommodity, MDM.BrokerCommodity>
    {
        /// <summary>
        ...
        public void Create(BrokerCommodity contract)
        {
        ...
        public BrokerCommodityList List()
        {
            var list = new BrokerCommodityList();
        ...
        public IList<BrokerCommodity> GetEntityList(string id)
        {
            var list = new List<BrokerCommodity>();
        ...
        //[AspNetCacheProfile("MdmEntityCache")]
        public BrokerCommodity Get(string id)
        {
        ...
        public void Update(string id, BrokerCommodity contract)
        {
