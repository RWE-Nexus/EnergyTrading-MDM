namespace EnergyTrading.MDM.ServiceHost.Wcf.Nexus.Legacy
{
    ...
    public class AgreementService : LegacyEntityService<RWEST.Nexus.MDM.Contracts.Agreement, OpenNexus.MDM.Contracts.Agreement, MDM.Agreement>
    {
        /// <summary>
        ...
        public void Create(Agreement contract)
        {
        ...
        public AgreementList List()
        {
            var list = new AgreementList();
        ...
        public IList<Agreement> GetEntityList(string id)
        {
        ...
        public void Update(string id, Agreement contract)
        {
