namespace EnergyTrading.MDM.ServiceHost.Wcf.Nexus.Legacy
{
    ...
    public class ShapeElementService : LegacyEntityService<RWEST.Nexus.MDM.Contracts.ShapeElement, OpenNexus.MDM.Contracts.ShapeElement, MDM.ShapeElement>
    {
        /// <summary>
        ...
        public void Create(ShapeElement contract)
        {
        ...
        public ShapeElementList List()
        {
            var list = new ShapeElementList();
        ...
        public IList<ShapeElement> GetEntityList(string id)
        {
        ...
        //[AspNetCacheProfile("MdmEntityCache")]
        public ShapeElement Get(string id)
        {
        ...
        public void Update(string id, ShapeElement contract)
        {
