namespace EnergyTrading.MDM.ServiceHost.Wcf.Nexus.Legacy
{
    ...
    public class BookService : LegacyEntityService<RWEST.Nexus.MDM.Contracts.Book, OpenNexus.MDM.Contracts.Book, MDM.Book>
    {
        /// <summary>
        ...
        public void Create(Book contract)
        {
        ...
        public IList<Book> GetEntityList(string id)
        {
        ...
        public void Update(string id, Book contract)
        {
