namespace EnergyTrading.MDM.ServiceHost.Wcf.Nexus.Legacy
{
    ...
    public class InstrumentTypeService : LegacyEntityService<RWEST.Nexus.MDM.Contracts.InstrumentType, OpenNexus.MDM.Contracts.InstrumentType, MDM.InstrumentType>
    {
        /// <summary>
        ...
        public void Create(InstrumentType contract)
        {
        ...
        public InstrumentTypeList List()
        {
            var list = new InstrumentTypeList();
        ...
        public IList<InstrumentType> GetEntityList(string id)
        {
        ...
        //[AspNetCacheProfile("MdmEntityCache")]
        public InstrumentType Get(string id)
        {
        ...
        public void Update(string id, InstrumentType contract)
        {
