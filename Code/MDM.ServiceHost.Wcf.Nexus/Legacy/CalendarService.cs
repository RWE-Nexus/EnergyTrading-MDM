namespace EnergyTrading.MDM.ServiceHost.Wcf.Nexus.Legacy
{
    ...
    public class CalendarService : LegacyEntityService<RWEST.Nexus.MDM.Contracts.Calendar, OpenNexus.MDM.Contracts.Calendar, MDM.Calendar>
    {
        /// <summary>
        ...
        public void Create(Calendar contract)
        {
        ...
        public IList<Calendar> GetEntityList(string id)
        {
        ...
        public void Update(string id, Calendar contract)
        {
