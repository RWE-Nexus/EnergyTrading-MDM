namespace EnergyTrading.MDM.ServiceHost.Wcf.Nexus.Legacy
{
    ...
    public class ShapeDayService : LegacyEntityService<RWEST.Nexus.MDM.Contracts.ShapeDay, OpenNexus.MDM.Contracts.ShapeDay, MDM.ShapeDay>
    {
        /// <summary>
        ...
        public void Create(ShapeDay contract)
        {
        ...
        public ShapeDayList List()
        {
            var list = new ShapeDayList();
        ...
        public IList<ShapeDay> GetEntityList(string id)
        {
            var list = new List<ShapeDay>();
        ...
        public void Update(string id, ShapeDay contract)
        {
