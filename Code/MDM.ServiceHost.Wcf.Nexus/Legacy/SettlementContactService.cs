namespace EnergyTrading.MDM.ServiceHost.Wcf.Nexus.Legacy
{
    ...
    public class SettlementContactService : LegacyEntityService<RWEST.Nexus.MDM.Contracts.SettlementContact, OpenNexus.MDM.Contracts.SettlementContact, MDM.SettlementContact>
    {
        /// <summary>
        ...
        public void Create(SettlementContact contract)
        {
        ...
        public SettlementContactList List()
        {
            var list = new SettlementContactList();
        ...
        public IList<SettlementContact> GetEntityList(string id)
        {
            var list = new List<SettlementContact>();
        ...
        //[AspNetCacheProfile("MdmEntityCache")]
        public SettlementContact Get(string id)
        {
        ...
        public void Update(string id, SettlementContact contract)
        {
