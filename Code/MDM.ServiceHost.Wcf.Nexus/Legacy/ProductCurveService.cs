namespace EnergyTrading.MDM.ServiceHost.Wcf.Nexus.Legacy
{
    ...
    public class ProductCurveService : LegacyEntityService<RWEST.Nexus.MDM.Contracts.ProductCurve, OpenNexus.MDM.Contracts.ProductCurve, MDM.ProductCurve>
    {
        /// <summary>
        ...
        public void Create(ProductCurve contract)
        {
        ...
        public ProductCurveList List()
        {
            var list = new ProductCurveList();
        ...
        public IList<ProductCurve> GetEntityList(string id)
        {
            var list = new List<ProductCurve>();
        ...
        //[AspNetCacheProfile("MdmEntityCache")]
        public ProductCurve Get(string id)
        {
        ...
        public void Update(string id, ProductCurve contract)
        {
