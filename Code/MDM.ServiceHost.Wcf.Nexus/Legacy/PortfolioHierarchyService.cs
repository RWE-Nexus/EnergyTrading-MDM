namespace EnergyTrading.MDM.ServiceHost.Wcf.Nexus.Legacy
{
    ...
    public class PortfolioHierarchyService : LegacyEntityService<RWEST.Nexus.MDM.Contracts.PortfolioHierarchy, OpenNexus.MDM.Contracts.PortfolioHierarchy, MDM.PortfolioHierarchy>
    {
        /// <summary>
        ...
        public void Create(PortfolioHierarchy contract)
        {
        ...
        public PortfolioHierarchyList List()
        {
        ...
        public IList<PortfolioHierarchy> GetEntityList(string id)
        {
            var list = new List<PortfolioHierarchy>();
        ...
        //[AspNetCacheProfile("MdmEntityCache")]
        public PortfolioHierarchy Get(string id)
        {
        ...
        public void Update(string id, PortfolioHierarchy contract)
        {
