namespace EnergyTrading.MDM.ServiceHost.Wcf.Nexus.Legacy
{
    ...
    public class PartyOverrideService : LegacyEntityService<RWEST.Nexus.MDM.Contracts.PartyOverride, OpenNexus.MDM.Contracts.PartyOverride, MDM.PartyOverride>
    {
        /// <summary>
        ...
        public void Create(PartyOverride contract)
        {
        ...
        public PartyOverrideList List()
        {
            var list = new PartyOverrideList();
        ...
        public IList<PartyOverride> GetEntityList(string id)
        {
            var list = new List<PartyOverride>();
        ...
        //[AspNetCacheProfile("MdmEntityCache")]
        public PartyOverride Get(string id)
        {
        ...
        public void Update(string id, PartyOverride contract)
        {
