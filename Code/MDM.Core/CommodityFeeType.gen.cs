namespace EnergyTrading.MDM
{
    ...
    public partial class CommodityFeeType : IIdentifiable, IEntity, IEntityDetail
    {
        public CommodityFeeType()
        {
            this.Mappings = new List<CommodityFeeTypeMapping>();
        ...
        public virtual IList<CommodityFeeTypeMapping> Mappings { get; private set; }
        ...
        /// <summary>
        /// Add a details to the CommodityFeeType checking its validity 
        /// </summary>
        /// <param name="details"></param>
        public void AddDetails(CommodityFeeType details)
        {
            // Sanity checks
            if (details == null)
            {
        ...
        public void ProcessMapping(CommodityFeeTypeMapping mapping)
        {
        ...
        {
            this.AddDetails(details as CommodityFeeType);
        }

        void IEntity.ProcessMapping(IEntityMapping mapping)
        {
            this.ProcessMapping(mapping as CommodityFeeTypeMapping);
        }
    }
}