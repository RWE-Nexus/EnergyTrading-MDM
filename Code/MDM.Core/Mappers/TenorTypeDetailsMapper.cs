namespace EnergyTrading.MDM.Mappers
{
    ...
    /// </summary>
    public class TenorTypeDetailsMapper : Mapper<EnergyTrading.MDM.TenorType, RWEST.Nexus.MDM.Contracts.TenorTypeDetails>
    {
        public override void Map(EnergyTrading.MDM.TenorType source, RWEST.Nexus.MDM.Contracts.TenorTypeDetails destination)
        {
