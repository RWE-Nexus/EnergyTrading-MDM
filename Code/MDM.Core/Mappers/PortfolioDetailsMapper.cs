...
namespace EnergyTrading.MDM.Mappers
{
    ...
    /// </summary>
    public class PortfolioDetailsMapper : Mapper<EnergyTrading.MDM.Portfolio, RWEST.Nexus.MDM.Contracts.PortfolioDetails>
    {
        public override void Map(EnergyTrading.MDM.Portfolio source, RWEST.Nexus.MDM.Contracts.PortfolioDetails destination)
        {
