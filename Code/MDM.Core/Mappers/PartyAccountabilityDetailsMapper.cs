namespace EnergyTrading.MDM.Mappers
{
    ...
    /// </summary>
    public class PartyAccountabilityDetailsMapper : Mapper<EnergyTrading.MDM.PartyAccountability, RWEST.Nexus.MDM.Contracts.PartyAccountabilityDetails>
    {
        public override void Map(EnergyTrading.MDM.PartyAccountability source, RWEST.Nexus.MDM.Contracts.PartyAccountabilityDetails destination)
        {
