namespace EnergyTrading.MDM.Mappers
{
    ...
    /// </summary>
    public class BookDefaultDetailsMapper : Mapper<EnergyTrading.MDM.BookDefault, RWEST.Nexus.MDM.Contracts.BookDefaultDetails>
    {
        public override void Map(EnergyTrading.MDM.BookDefault source, RWEST.Nexus.MDM.Contracts.BookDefaultDetails destination)
        {
