namespace EnergyTrading.MDM
{
    ...
    public partial class Vessel : IIdentifiable, IEntity, IEntityDetail
    {
        public Vessel()
        {
            this.Mappings = new List<VesselMapping>();
        ...
        public virtual IList<VesselMapping> Mappings { get; private set; }
        ...
        /// <summary>
        /// Add a details to the Vessel checking its validity 
        /// </summary>
        /// <param name="details"></param>
        public void AddDetails(Vessel details)
        {
            // Sanity checks
            if (details == null)
            {
        ...
        public void ProcessMapping(VesselMapping mapping)
        {
        ...
        {
            this.AddDetails(details as Vessel);
        }

        void IEntity.ProcessMapping(IEntityMapping mapping)
        {
            this.ProcessMapping(mapping as VesselMapping);
        }
    }
}