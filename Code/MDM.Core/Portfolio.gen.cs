namespace EnergyTrading.MDM
{
    ...
    public partial class Portfolio : IIdentifiable, IEntity, IEntityDetail
    {
        private string name;

        public Portfolio()
        {
            this.Mappings = new List<PortfolioMapping>();
        ...
        public virtual IList<PortfolioMapping> Mappings { get; private set; }
        ...
        /// <summary>
        /// Add a details to the Portfolio checking its validity 
        /// </summary>
        /// <param name="details"></param>
        public void AddDetails(Portfolio details)
        {
            // Sanity checks
            if (details == null)
            {
        ...
        public void ProcessMapping(PortfolioMapping mapping)
        {
        ...
        {
            this.AddDetails(details as Portfolio);
        }

        void IEntity.ProcessMapping(IEntityMapping mapping)
        {
            this.ProcessMapping(mapping as PortfolioMapping);
        }
    }
}