namespace EnergyTrading.MDM
{
    ...
    public partial class TenorType : IIdentifiable, IEntity, IEntityDetail
    {
        public TenorType()
        {
            this.Mappings = new List<TenorTypeMapping>();
        ...
        public virtual IList<TenorTypeMapping> Mappings { get; private set; }
        ...
        /// <summary>
        /// Add a details to the TenorType checking its validity 
        /// </summary>
        /// <param name="details"></param>
        public void AddDetails(TenorType details)
        {
            // Sanity checks
            if (details == null)
            {
        ...
        public void ProcessMapping(TenorTypeMapping mapping)
        {
        ...
        {
            this.AddDetails(details as TenorType);
        }

        void IEntity.ProcessMapping(IEntityMapping mapping)
        {
            this.ProcessMapping(mapping as TenorTypeMapping);
        }
    }
}