namespace EnergyTrading.MDM
{
    ...
    public partial class FeeType : IIdentifiable, IEntity, IEntityDetail
    {
        public FeeType()
        {
            this.Mappings = new List<FeeTypeMapping>();
        ...
        public virtual IList<FeeTypeMapping> Mappings { get; private set; }
        ...
        /// <summary>
        /// Add a details to the FeeType checking its validity 
        /// </summary>
        /// <param name="details"></param>
        public void AddDetails(FeeType details)
        {
            // Sanity checks
            if (details == null)
            {
        ...
        public void ProcessMapping(FeeTypeMapping mapping)
        {
        ...
        {
            this.AddDetails(details as FeeType);
        }

        void IEntity.ProcessMapping(IEntityMapping mapping)
        {
            this.ProcessMapping(mapping as FeeTypeMapping);
        }
    }
}