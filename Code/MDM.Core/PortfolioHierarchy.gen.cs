namespace EnergyTrading.MDM
{
    ...
    public partial class PortfolioHierarchy : IIdentifiable, IEntity, IEntityDetail
    {
        public PortfolioHierarchy()
        {
            this.Mappings = new List<PortfolioHierarchyMapping>();
        ...
        public virtual IList<PortfolioHierarchyMapping> Mappings { get; private set; }
        ...
        /// <summary>
        /// Add a details to the PortfolioHierarchy checking its validity 
        /// </summary>
        /// <param name="details"></param>
        public void AddDetails(PortfolioHierarchy details)
        {
            // Sanity checks
            if (details == null)
            {
        ...
        public void ProcessMapping(PortfolioHierarchyMapping mapping)
        {
        ...
        {
            this.AddDetails(details as PortfolioHierarchy);
        }

        void IEntity.ProcessMapping(IEntityMapping mapping)
        {
            this.ProcessMapping(mapping as PortfolioHierarchyMapping);
        }
    }
}