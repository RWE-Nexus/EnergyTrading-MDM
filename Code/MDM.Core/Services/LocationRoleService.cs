namespace EnergyTrading.MDM.Services
{
    ...
    public class LocationRoleService : MdmService<RWEST.Nexus.MDM.Contracts.LocationRole, LocationRole, LocationRoleMapping, LocationRole, RWEST.Nexus.MDM.Contracts.LocationRoleDetails>
    {
