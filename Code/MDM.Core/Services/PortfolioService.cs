namespace EnergyTrading.MDM.Services
{
    ...
    public class PortfolioService : MdmService<RWEST.Nexus.MDM.Contracts.Portfolio, Portfolio, PortfolioMapping, Portfolio, RWEST.Nexus.MDM.Contracts.PortfolioDetails>
    {
