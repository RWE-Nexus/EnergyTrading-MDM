namespace EnergyTrading.MDM.Services
{
    ...
    public class ProductTypeService : MdmService<RWEST.Nexus.MDM.Contracts.ProductType, ProductType, ProductTypeMapping, ProductType, RWEST.Nexus.MDM.Contracts.ProductTypeDetails>
    {
