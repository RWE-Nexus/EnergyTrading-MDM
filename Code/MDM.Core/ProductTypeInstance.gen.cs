namespace EnergyTrading.MDM
{
    ...
    public partial class ProductTypeInstance : IIdentifiable, IEntity, IEntityDetail
    {
        public ProductTypeInstance()
        {
            this.Mappings = new List<ProductTypeInstanceMapping>();
        ...
        public virtual IList<ProductTypeInstanceMapping> Mappings { get; private set; }
        ...
        /// <summary>
        /// Add a details to the ProductTypeInstance checking its validity 
        /// </summary>
        /// <param name="details"></param>
        public void AddDetails(ProductTypeInstance details)
        {
            // Sanity checks
            if (details == null)
            {
        ...
        public void ProcessMapping(ProductTypeInstanceMapping mapping)
        {
        ...
        {
            this.AddDetails(details as ProductTypeInstance);
        }

        void IEntity.ProcessMapping(IEntityMapping mapping)
        {
            this.ProcessMapping(mapping as ProductTypeInstanceMapping);
        }
    }
}