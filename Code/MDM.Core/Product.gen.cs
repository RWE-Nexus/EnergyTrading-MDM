namespace EnergyTrading.MDM
{
    ...
    public partial class Product : IIdentifiable, IEntity, IEntityDetail
    {
        public Product()
        {
            this.Mappings = new List<ProductMapping>();
        ...
        public virtual IList<ProductMapping> Mappings { get; private set; }
        ...
        /// <summary>
        /// Add a details to the Product checking its validity 
        /// </summary>
        /// <param name="details"></param>
        public void AddDetails(Product details)
        {
            // Sanity checks
            if (details == null)
            {
        ...
        public void ProcessMapping(ProductMapping mapping)
        {
        ...
        {
            this.AddDetails(details as Product);
        }

        void IEntity.ProcessMapping(IEntityMapping mapping)
        {
            this.ProcessMapping(mapping as ProductMapping);
        }
    }
}