namespace EnergyTrading.MDM
{
    ...
    public partial class ShapeElement : IIdentifiable, IEntity, IEntityDetail
    {
        public ShapeElement()
        {
            this.Mappings = new List<ShapeElementMapping>();
        ...
        public virtual IList<ShapeElementMapping> Mappings { get; private set; }
        ...
        /// <summary>
        /// Add a details to the ShapeElement checking its validity 
        /// </summary>
        /// <param name="details"></param>
        public void AddDetails(ShapeElement details)
        {
            // Sanity checks
            if (details == null)
            {
        ...
        public void ProcessMapping(ShapeElementMapping mapping)
        {
        ...
        {
            this.AddDetails(details as ShapeElement);
        }

        void IEntity.ProcessMapping(IEntityMapping mapping)
        {
            this.ProcessMapping(mapping as ShapeElementMapping);
        }
    }
}