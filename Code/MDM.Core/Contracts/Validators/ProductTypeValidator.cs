namespace EnergyTrading.MDM.Contracts.Validators
{
    ...
    public class ProductTypeValidator : Validator<ProductType>
    {
        ...
        {
            Rules.Add(new ChildCollectionRule<ProductType, NexusId>(validatorEngine, p => p.Identifiers));
            ...
            Rules.Add(new NexusEntityExistsRule<RWEST.Nexus.MDM.Contracts.ProductType, MDM.Product, MDM.ProductMapping>(repository, x => x.Details.Product, true));
            ...
            Rules.Add(new NexusEntityExistsRule<RWEST.Nexus.MDM.Contracts.ProductType, MDM.Curve, MDM.CurveMapping>(repository, x => x.Details.SettlementCurve, false));
        }
    }
}
