namespace EnergyTrading.MDM.Contracts.Mappers
{
	...
	///
	/// </summary>
    public class BusinessUnitDetailsMapper : Mapper<RWEST.Nexus.MDM.Contracts.BusinessUnitDetails, MDM.BusinessUnitDetails>
    {
        ...
        public override void Map(RWEST.Nexus.MDM.Contracts.BusinessUnitDetails source, MDM.BusinessUnitDetails destination)
        {
