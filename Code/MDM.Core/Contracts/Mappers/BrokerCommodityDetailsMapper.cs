...
namespace EnergyTrading.MDM.Contracts.Mappers
{
	...
	///
	/// </summary>
    public class BrokerCommodityDetailsMapper : Mapper<RWEST.Nexus.MDM.Contracts.BrokerCommodityDetails, MDM.BrokerCommodity>
    {
        ...
        public override void Map(RWEST.Nexus.MDM.Contracts.BrokerCommodityDetails source, MDM.BrokerCommodity destination)
        {
