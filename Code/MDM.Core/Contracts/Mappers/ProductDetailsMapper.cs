namespace EnergyTrading.MDM.Contracts.Mappers
{
    ...
    public class ProductDetailsMapper : Mapper<RWEST.Nexus.MDM.Contracts.ProductDetails, MDM.Product>
    {
        ...
        public override void Map(RWEST.Nexus.MDM.Contracts.ProductDetails source, MDM.Product destination)
        {
