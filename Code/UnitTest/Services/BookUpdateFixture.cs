namespace EnergyTrading.MDM.Test.Services
{
    ...
    [TestClass]
    public class BookUpdateFixture : Fixture
    {
        [TestMethod]
        ...
        public void NullContractInvalid()
        {
            ...
            repository.Setup(x => x.FindOne<Book>(1)).Returns(new Book());
        ...
        public void EarlierVersionRaisesVersionConflict()
        {
            ...
            var cd = new RWEST.Nexus.MDM.Contracts.BookDetails();
            var nexus = new RWEST.Nexus.MDM.Contracts.SystemData { StartDate = new DateTime(2012, 1, 1) };
            var contract = new RWEST.Nexus.MDM.Contracts.Book { Details = cd, Nexus = nexus };

            var details = ObjectMother.Create<Book>();
            details.Id = 1;
            var entity = ObjectMother.Create<Book>();
            entity.Id = 2;
            entity.AddDetails(details);

            repository.Setup(x => x.FindOne<Book>(1)).Returns(entity);
        ...
        public void ValidDetailsSaved()
        {
            ...
            var d1 = ObjectMother.Create<Book>();
            d1.Id = 1;
            ...
            var d2 = ObjectMother.Create<Book>(); 
            ...
            mappingEngine.Setup(x => x.Map<RWEST.Nexus.MDM.Contracts.BookDetails, Book>(cd)).Returns(d2);
