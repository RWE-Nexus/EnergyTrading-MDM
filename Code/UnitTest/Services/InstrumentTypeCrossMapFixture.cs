namespace EnergyTrading.MDM.Test.Services
{
    ...
    [TestClass]
    public class InstrumentTypeCrossMapFixture
    {
        [TestMethod]
        ...
        public void SuccessMatch()
        {
            ...
            var targetMapping = new InstrumentTypeMapping
            {
                System = targetSystem,
                MappingValue = "B",
                IsDefault = true
            };
            var instrumenttype = new MDM.InstrumentType
            {
                Id = 1,
            ...
            instrumenttype.ProcessMapping(targetMapping);
            ...
            mappingEngine.Setup(x => x.Map<InstrumentTypeMapping, NexusId>(targetMapping)).Returns(targetIdentifier);
