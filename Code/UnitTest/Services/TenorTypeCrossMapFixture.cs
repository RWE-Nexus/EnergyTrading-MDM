namespace EnergyTrading.MDM.Test.Services
{
    ...
    [TestClass]
    public class TenorTypeCrossMapFixture
    {
        [TestMethod]
        ...
        public void SuccessMatch()
        {
            ...
            var targetMapping = new TenorTypeMapping
            {
                System = targetSystem,
                MappingValue = "B",
                IsDefault = true
            ...
            tenortype.ProcessMapping(targetMapping);
            ...
            mappingEngine.Setup(x => x.Map<TenorTypeMapping, NexusId>(targetMapping)).Returns(targetIdentifier);
