namespace EnergyTrading.MDM.Test.Services
{
    ...
    [TestClass]
    public class InstrumentTypeOverrideCrossMapFixture
    {
        [TestMethod]
        ...
        public void SuccessMatch()
        {
            ...
            var targetMapping = new InstrumentTypeOverrideMapping
            {
                System = targetSystem,
                MappingValue = "B",
                IsDefault = true
            };
            var instrumenttypeoverride = new MDM.InstrumentTypeOverride
            {
                Id = 1,
            ...
            instrumenttypeoverride.ProcessMapping(targetMapping);
            ...
            mappingEngine.Setup(x => x.Map<InstrumentTypeOverrideMapping, NexusId>(targetMapping)).Returns(targetIdentifier);
