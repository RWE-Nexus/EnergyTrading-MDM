namespace EnergyTrading.MDM.Test.Services
{
    ...
    [TestClass]
    public class VesselCrossMapFixture
    {
        [TestMethod]
        ...
        public void SuccessMatch()
        {
            ...
            var targetMapping = new VesselMapping
            {
                System = targetSystem,
                MappingValue = "B",
                IsDefault = true
            };
            var vessel = new MDM.Vessel
            {
                Id = 1,
            ...
            vessel.ProcessMapping(targetMapping);
            ...
            mappingEngine.Setup(x => x.Map<VesselMapping, NexusId>(targetMapping)).Returns(targetIdentifier);
