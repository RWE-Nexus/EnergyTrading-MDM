namespace EnergyTrading.MDM.Test.Services
{
    ...
    [TestClass]
    public class ProductTypeCrossMapFixture
    {
        [TestMethod]
        ...
        public void SuccessMatch()
        {
            ...
            var targetMapping = new ProductTypeMapping
            {
                System = targetSystem,
                MappingValue = "B",
                IsDefault = true
            };
            var producttype = new MDM.ProductType
            {
                Id = 1,
            ...
            producttype.ProcessMapping(targetMapping);
            ...
            mappingEngine.Setup(x => x.Map<ProductTypeMapping, NexusId>(targetMapping)).Returns(targetIdentifier);
