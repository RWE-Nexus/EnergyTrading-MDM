namespace EnergyTrading.MDM.Test.Services
{
    ...
    public class LocationUpdateMappingFixture
    {
        ...
        public void ValidDetailsSaved()
        {
            ...
            var m1 = new LocationMapping { Id = mappingId, System = s1, MappingValue = "1", Version = BitConverter.GetBytes(34L), Validity = new DateRange(start, DateUtility.MaxDate) };			
            ...
            mappingEngine.Setup(x => x.Map<RWEST.Nexus.MDM.Contracts.NexusId, LocationMapping>(identifier)).Returns(m2);
