namespace EnergyTrading.MDM.Test.Services
{
    ...
    [TestClass]
    public class ProductScotaCrossMapFixture
    {
        [TestMethod]
        ...
        public void SuccessMatch()
        {
            ...
            var targetMapping = new ProductScotaMapping
            {
                System = targetSystem,
                MappingValue = "B",
                IsDefault = true
            ...
            productscota.ProcessMapping(targetMapping);
            ...
            mappingEngine.Setup(x => x.Map<ProductScotaMapping, NexusId>(targetMapping)).Returns(targetIdentifier);
