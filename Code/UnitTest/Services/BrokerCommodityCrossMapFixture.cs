namespace EnergyTrading.MDM.Test.Services
{
    ...
    [TestClass]
    public class BrokerCommodityCrossMapFixture
    {
        [TestMethod]
        ...
        public void SuccessMatch()
        {
            ...
            var targetMapping = new BrokerCommodityMapping
            {
                System = targetSystem,
                MappingValue = "B",
                IsDefault = true
            ...
            brokercommodity.ProcessMapping(targetMapping);
            ...
            mappingEngine.Setup(x => x.Map<BrokerCommodityMapping, NexusId>(targetMapping)).Returns(targetIdentifier);
