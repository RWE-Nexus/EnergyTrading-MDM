namespace EnergyTrading.MDM.Test.Services
{
    ...
    [TestClass]
    public class CommodityInstrumentTypeCrossMapFixture
    {
        [TestMethod]
        ...
        public void SuccessMatch()
        {
            ...
            var targetMapping = new CommodityInstrumentTypeMapping
            {
                System = targetSystem,
                MappingValue = "B",
                IsDefault = true
            ...
            commodityinstrumenttype.ProcessMapping(targetMapping);
            ...
            mappingEngine.Setup(x => x.Map<CommodityInstrumentTypeMapping, NexusId>(targetMapping)).Returns(targetIdentifier);
