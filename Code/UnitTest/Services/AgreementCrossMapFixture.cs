namespace EnergyTrading.MDM.Test.Services
{
    ...
    [TestClass]
    public class AgreementCrossMapFixture
    {
        [TestMethod]
        ...
        public void SuccessMatch()
        {
            ...
            var targetMapping = new AgreementMapping
            {
                System = targetSystem,
                MappingValue = "B",
                IsDefault = true
            };
            var agreement = new MDM.Agreement
            {
                Id = 1,
            ...
            agreement.ProcessMapping(targetMapping);
            ...
            mappingEngine.Setup(x => x.Map<AgreementMapping, NexusId>(targetMapping)).Returns(targetIdentifier);
