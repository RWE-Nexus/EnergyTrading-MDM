namespace EnergyTrading.MDM.Test.Services
{
    ...
    [TestClass]
    public class ProductTenorTypeCrossMapFixture
    {
        [TestMethod]
        ...
        public void SuccessMatch()
        {
            ...
            var targetMapping = new ProductTenorTypeMapping
            {
                System = targetSystem,
                MappingValue = "B",
                IsDefault = true
            ...
            producttenortype.ProcessMapping(targetMapping);
            ...
            mappingEngine.Setup(x => x.Map<ProductTenorTypeMapping, NexusId>(targetMapping)).Returns(targetIdentifier);
