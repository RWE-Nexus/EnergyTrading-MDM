namespace EnergyTrading.MDM.Test.Services
{
    ...
    [TestClass]
    public class CommodityCrossMapFixture
    {
        [TestMethod]
        ...
        public void SuccessMatch()
        {
            ...
            var targetMapping = new CommodityMapping
            {
                System = targetSystem,
                MappingValue = "B",
                IsDefault = true
            ...
            commodity.ProcessMapping(targetMapping);
            ...
            mappingEngine.Setup(x => x.Map<CommodityMapping, NexusId>(targetMapping)).Returns(targetIdentifier);
