namespace EnergyTrading.MDM.Test.Services
{
    ...
    [TestClass]
    public class DimensionCrossMapFixture
    {
        [TestMethod]
        ...
        public void SuccessMatch()
        {
            ...
            var targetMapping = new DimensionMapping
            {
                System = targetSystem,
                MappingValue = "B",
                IsDefault = true
            };
            var dimension = new MDM.Dimension
            {
                Id = 1,
            ...
            dimension.ProcessMapping(targetMapping);
            ...
            mappingEngine.Setup(x => x.Map<DimensionMapping, NexusId>(targetMapping)).Returns(targetIdentifier);
