namespace EnergyTrading.MDM.Test.Services
{
    ...
    [TestClass]
    public class LocationRoleCrossMapFixture
    {
        [TestMethod]
        ...
        public void SuccessMatch()
        {
            ...
            var targetMapping = new LocationRoleMapping
            {
                System = targetSystem,
                MappingValue = "B",
                IsDefault = true
            ...
            locationrole.ProcessMapping(targetMapping);
            ...
            mappingEngine.Setup(x => x.Map<LocationRoleMapping, NexusId>(targetMapping)).Returns(targetIdentifier);
