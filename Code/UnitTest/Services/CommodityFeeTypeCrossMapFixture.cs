namespace EnergyTrading.MDM.Test.Services
{
    ...
    [TestClass]
    public class CommodityFeeTypeCrossMapFixture
    {
        [TestMethod]
        ...
        public void SuccessMatch()
        {
            ...
            var targetMapping = new CommodityFeeTypeMapping
            {
                System = targetSystem,
                MappingValue = "B",
                IsDefault = true
            };
            var commodityfeetype = new MDM.CommodityFeeType
            {
                Id = 1,
            ...
            commodityfeetype.ProcessMapping(targetMapping);
            ...
            mappingEngine.Setup(x => x.Map<CommodityFeeTypeMapping, NexusId>(targetMapping)).Returns(targetIdentifier);
