namespace EnergyTrading.MDM.Test.Services
{
    ...
    [TestClass]
    public class PortfolioHierarchyUpdateFixture : Fixture
    {
        [TestMethod]
        ...
        public void NullContractInvalid()
        {
            ...
            repository.Setup(x => x.FindOne<PortfolioHierarchy>(1)).Returns(new PortfolioHierarchy());
        ...
        public void EarlierVersionRaisesVersionConflict()
        {
            ...
            var cd = new RWEST.Nexus.MDM.Contracts.PortfolioHierarchyDetails();
            var nexus = new RWEST.Nexus.MDM.Contracts.SystemData { StartDate = new DateTime(2012, 1, 1) };
            var contract = new RWEST.Nexus.MDM.Contracts.PortfolioHierarchy { Details = cd, Nexus = nexus };

            var details = ObjectMother.Create<PortfolioHierarchy>();
            details.Id = 1;
            var entity = ObjectMother.Create<PortfolioHierarchy>();
            entity.Id = 2;
            entity.AddDetails(details);

            repository.Setup(x => x.FindOne<PortfolioHierarchy>(1)).Returns(entity);
        ...
        public void ValidDetailsSaved()
        {
            ...
            var d1 = ObjectMother.Create<PortfolioHierarchy>();
            d1.Id = 1;
            ...
            var d2 = ObjectMother.Create<PortfolioHierarchy>(); 
            ...
            mappingEngine.Setup(x => x.Map<RWEST.Nexus.MDM.Contracts.PortfolioHierarchyDetails, PortfolioHierarchy>(cd)).Returns(d2);
