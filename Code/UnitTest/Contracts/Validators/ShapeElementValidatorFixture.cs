namespace EnergyTrading.MDM.Test.Contracts.Validators
{
    ...
    using ShapeElement = RWEST.Nexus.MDM.Contracts.ShapeElement;

    [TestClass]
    public partial class ShapeElementValidatorFixture : Fixture
    {
        [TestMethod]
        public void ValidatorResolution()
        {
            ...
            var config = new ShapeElementConfiguration(container);
            config.Configure();

            var validator = container.Resolve<IValidator<ShapeElement>>("shapeelement");
        ...
        [TestMethod]
        public void ValidShapeElementPasses()
        {
            // Assert
            ...
            var validator = new ShapeElementValidator(validatorEngine.Object, repository);

            var shapeelement = new ShapeElement { Identifiers = new RWEST.Nexus.MDM.Contracts.NexusIdList { identifier } };
            this.AddRelatedEntities(shapeelement);

            // Act
            var violations = new List<IRule>();
            var result = validator.IsValid(shapeelement, violations);
        ...
        public void OverlapsRangeFails()
        {
            ...
            var system = new MDM.SourceSystem { Name = "Test" };
            var shapeelementMapping = new ShapeElementMapping { System = system, MappingValue = "1", Validity = validity };

            var list = new List<ShapeElementMapping> { shapeelementMapping };
            var repository = new Mock<IRepository>();
            ...
            var identifierValidator = new NexusIdValidator<ShapeElementMapping>(repository.Object);
            var validatorEngine = new Mock<IValidatorEngine>();
            ...
            var validator = new ShapeElementValidator(validatorEngine.Object, repository.Object);

            var shapeelement = new ShapeElement { Identifiers = new RWEST.Nexus.MDM.Contracts.NexusIdList { overlapsRangeIdentifier } };
        ...
        public void BadSystemFails()
        {
            ...
            var shapeelement = new ShapeElement { Identifiers = new RWEST.Nexus.MDM.Contracts.NexusIdList { badSystemIdentifier } };
		...
		partial void AddRelatedEntities(RWEST.Nexus.MDM.Contracts.ShapeElement contract);
