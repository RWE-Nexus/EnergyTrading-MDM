namespace EnergyTrading.MDM.Test.Contracts.Mappers
{
    ...
    [TestClass]
    public class BrokerRateMapperFixture : Fixture
    {
        [TestMethod]
        public void Resolve()
        {
            ...
            var validator = container.Resolve<IMapper<RWEST.Nexus.MDM.Contracts.BrokerRate, BrokerRate>>();
        ...
        public void Map()
        {
            ...
            var contractDetails = new RWEST.Nexus.MDM.Contracts.BrokerRateDetails();
            ...
            mappingEngine.Setup(x => x.Map<RWEST.Nexus.MDM.Contracts.NexusId, BrokerRateMapping>(id)).Returns(mapping);
            mappingEngine.Setup(x => x.Map<RWEST.Nexus.MDM.Contracts.BrokerRateDetails, BrokerRateDetails>(contractDetails)).Returns(details);

            var mapper = new BrokerRateMapper(mappingEngine.Object);
