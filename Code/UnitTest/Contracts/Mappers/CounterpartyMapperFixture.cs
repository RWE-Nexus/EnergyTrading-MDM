...
namespace EnergyTrading.MDM.Test.Contracts.Mappers
{
    ...
    public class CounterpartyMapperFixture : Fixture
    {
        ...
        public void Map()
        {
            ...
            var contractDetails = new RWEST.Nexus.MDM.Contracts.CounterpartyDetails();
            ...
            mappingEngine.Setup(x => x.Map<RWEST.Nexus.MDM.Contracts.CounterpartyDetails, CounterpartyDetails>(contractDetails)).Returns(details);
