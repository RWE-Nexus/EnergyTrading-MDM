	namespace EnergyTrading.MDM.Test
{
    ...
    [TestClass]
    public class when_a_search_for_a_market_with_two_results_is_paged_at_one_per_page : IntegrationTestBase
    {
        ...
        private static IList<Market> pageOne;
        private static Uri pageOneNextPage;
        private static IList<Market> pageTwo;
        ...
        {
            pageOneResponse = client.Post(ServiceUrl["Market"] + "search", content);
        ...
        protected static void Establish_context()
        {
			...
			Script.MarketData.CreateSearch(search, entity1, entity2);
        ...
        private static IList<Market> GetPeopleFromFeed(SyndicationFeed feed)
        {
