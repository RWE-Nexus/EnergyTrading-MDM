	namespace EnergyTrading.MDM.Test
{
    ...
    [TestClass]
    public class when_a_search_for_a_instrumenttypeoverride_with_two_results_is_paged_at_one_per_page : IntegrationTestBase
    {
        ...
        private static IList<InstrumentTypeOverride> pageOne;
        private static Uri pageOneNextPage;
        private static IList<InstrumentTypeOverride> pageTwo;
        ...
        {
            pageOneResponse = client.Post(ServiceUrl["InstrumentTypeOverride"] + "search", content);
        ...
        protected static void Establish_context()
        {
			...
			InstrumentTypeOverrideData.CreateSearch(search, entity1, entity2);
        ...
        private static IList<InstrumentTypeOverride> GetPeopleFromFeed(SyndicationFeed feed)
        {
