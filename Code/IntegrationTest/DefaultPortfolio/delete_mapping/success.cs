namespace EnergyTrading.MDM.Test
{
    ...
    [TestClass]
    public class when_a_request_is_made_to_delete_a_bookdefault_mapping : IntegrationTestBase
    {
        ...
        protected static void Because_of()
        {
            ...
            var uri = ServiceUrl["BookDefault"] + defaultportfolio.Id + "/Mapping/" + defaultportfolio.Mappings[0].Id;
