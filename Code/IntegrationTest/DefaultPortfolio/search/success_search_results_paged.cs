    namespace EnergyTrading.MDM.Test
{
    ...
    [TestClass]
    public class when_a_search_for_a_bookdefault_with_two_results_is_paged_at_one_per_page : IntegrationTestBase
    {
        ...
        private static IList<BookDefault> pageOne;
        private static Uri pageOneNextPage;
        private static IList<BookDefault> pageTwo;
        ...
        {
            pageOneResponse = client.Post(ServiceUrl["BookDefault"] + "search", content);
        ...
        private static IList<BookDefault> GetPeopleFromFeed(SyndicationFeed feed)
        {
