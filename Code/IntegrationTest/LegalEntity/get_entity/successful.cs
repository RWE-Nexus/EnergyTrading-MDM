namespace EnergyTrading.MDM.Test
{
    ...
    public class when_a_request_is_made_for_a_legalentity_and_they_exist : IntegrationTestBase
    {
        ...
        private static RWEST.Nexus.MDM.Contracts.LegalEntity returnedLegalEntity;
        ...
        protected static void Because_of()
        {
                ...
                legalentity.Id))
            {
                ...
                {
                    returnedLegalEntity = response.Content.ReadAsDataContract<RWEST.Nexus.MDM.Contracts.LegalEntity>();
                }
            }
        }
