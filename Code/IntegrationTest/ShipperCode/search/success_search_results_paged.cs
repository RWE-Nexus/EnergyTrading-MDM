	namespace EnergyTrading.MDM.Test
{
    ...
    [TestClass]
    public class when_a_search_for_a_shippercode_with_two_results_is_paged_at_one_per_page : IntegrationTestBase
    {
        ...
        private static IList<ShipperCode> pageOne;
        private static Uri pageOneNextPage;
        private static IList<ShipperCode> pageTwo;
        ...
        {
            pageOneResponse = client.Post(ServiceUrl["ShipperCode"] + "search", content);
        ...
        protected static void Establish_context()
        {
			...
			Script.ShipperCodeData.CreateSearch(search, entity1, entity2);
        ...
        private static IList<ShipperCode> GetPeopleFromFeed(SyndicationFeed feed)
        {
