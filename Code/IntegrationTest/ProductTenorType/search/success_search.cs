namespace EnergyTrading.MDM.Test
{
    ...
    [TestClass]
    public class when_a_search_for_a_producttenortype_is_made_with_a_specific_name : IntegrationTestBase
    {
        ...
        {
            var entity1 = ProductTenorTypeData.CreateBasicEntity();
            var entity2 = ProductTenorTypeData.CreateBasicEntity();
