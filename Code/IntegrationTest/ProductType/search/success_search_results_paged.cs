	namespace EnergyTrading.MDM.Test
{
    ...
    [TestClass]
    public class when_a_search_for_a_producttype_with_two_results_is_paged_at_one_per_page : IntegrationTestBase
    {
        ...
        private static IList<ProductType> pageOne;
        private static Uri pageOneNextPage;
        private static IList<ProductType> pageTwo;
        ...
        {
            pageOneResponse = client.Post(ServiceUrl["ProductType"] + "search", content);
        ...
        protected static void Establish_context()
        {
			...
			Script.ProductTypeData.CreateSearch(search, entity1, entity2);
        ...
        private static IList<ProductType> GetPeopleFromFeed(SyndicationFeed feed)
        {
