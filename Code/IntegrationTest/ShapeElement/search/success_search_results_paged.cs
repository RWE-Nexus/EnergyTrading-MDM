	namespace EnergyTrading.MDM.Test
{
    ...
    [TestClass]
    public class when_a_search_for_a_shapeelement_with_two_results_is_paged_at_one_per_page : IntegrationTestBase
    {
        ...
        private static IList<ShapeElement> pageOne;
        private static Uri pageOneNextPage;
        private static IList<ShapeElement> pageTwo;
        ...
        {
            pageOneResponse = client.Post(ServiceUrl["ShapeElement"] + "search", content);
        ...
        protected static void Establish_context()
        {
			...
			ShapeElementData.CreateSearch(search, entity1, entity2);
        ...
        private static IList<ShapeElement> GetPeopleFromFeed(SyndicationFeed feed)
        {
