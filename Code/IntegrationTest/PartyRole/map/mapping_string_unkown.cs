namespace EnergyTrading.MDM.Test
{
    ...
    public class when_a_request_is_made_to_retrive_a_partyrole_from_a_source_system_and_the_mapping_string_doesnt_exist : IntegrationTestBase
    {
        ...
        {
            RWEST.Nexus.MDM.Contracts.PartyRole returnedPartyRole = null;
            try { returnedPartyRole = response.Content.ReadAsDataContract<RWEST.Nexus.MDM.Contracts.PartyRole>(); } catch { }
