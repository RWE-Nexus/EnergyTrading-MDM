namespace EnergyTrading.MDM.Test
{
    ...
    public class when_a_request_is_made_to_update_a_partyrole_entity : IntegrationTestBase
    {
        ...
        private static RWEST.Nexus.MDM.Contracts.PartyRole partyDataContract;
        private static HttpClient client;
        private static MDM.PartyRole entity;

        private static RWEST.Nexus.MDM.Contracts.PartyRole updatedContract;
        ...
        protected static void Establish_context()
        {
            ...
            updatedContract = getResponse.Content.ReadAsDataContract<RWEST.Nexus.MDM.Contracts.PartyRole>();
