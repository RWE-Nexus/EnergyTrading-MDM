	namespace EnergyTrading.MDM.Test
{
    ...
    [TestClass]
    public class when_a_search_for_a_productscota_with_two_results_is_paged_at_one_per_page : IntegrationTestBase
    {
        ...
        private static IList<ProductScota> pageOne;
        private static Uri pageOneNextPage;
        private static IList<ProductScota> pageTwo;
        ...
        {
            pageOneResponse = client.Post(ServiceUrl["ProductScota"] + "search", content);
        ...
        protected static void Establish_context()
        {
			...
			ProductScotaData.CreateSearch(search, entity1, entity2);
        ...
        private static IList<ProductScota> GetPeopleFromFeed(SyndicationFeed feed)
        {
