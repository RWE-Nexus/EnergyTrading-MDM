namespace EnergyTrading.MDM.Test
{
    ...
    [TestClass]
    public class when_a_search_for_a_productscota_is_made_with_a_specific_name : IntegrationTestBase
    {
        ...
        {
            var entity1 = ProductScotaData.CreateBasicEntity();
            var entity2 = ProductScotaData.CreateBasicEntity();
