    namespace EnergyTrading.MDM.Test
{
    ...
    [TestClass]
    public class when_a_search_for_a_book_with_two_results_is_paged_at_one_per_page : IntegrationTestBase
    {
        ...
        private static IList<Book> pageOne;
        private static Uri pageOneNextPage;
        private static IList<Book> pageTwo;
        ...
        {
            pageOneResponse = client.Post(ServiceUrl["Book"] + "search", content);
        ...
        private static IList<Book> GetPeopleFromFeed(SyndicationFeed feed)
        {
