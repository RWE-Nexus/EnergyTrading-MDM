namespace EnergyTrading.MDM.Test
{
    ...
    [TestClass]
    public class when_a_search_for_a_partyRoleaccountability_is_made_with_a_mapping_value_and_results_are_found : IntegrationTestBase
    {
        ...
        {
            response = client.Post(ServiceUrl["PartyRoleAccountability"] + "search", content);
        }

        protected static void Establish_context()
        {
            entity1 = PartyRoleAccountabilityData.CreateBasicEntityWithOneMapping();
            entity2 = PartyRoleAccountabilityData.CreateBasicEntityWithOneMapping();
    ...
    [TestClass]
    public class when_a_search_for_a_partyRoleaccountability_is_made_with_a_mapping_value_and_a_system_name_and_results_are_found : IntegrationTestBase
    {
        private static HttpClient client;
