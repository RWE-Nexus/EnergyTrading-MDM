namespace EnergyTrading.MDM.Test
{
    ...
    public static class PartyRoleAccountabilityDataChecker
    {
        ...
        {
            var savedEntity =
                new DbSetRepository<MDM.PartyRoleAccountability>(new MappingContext()).FindOne(id);
        ...
        public static void CompareContractWithSavedEntity(RWEST.Nexus.MDM.Contracts.PartyRoleAccountability contract)
        {
            ...
            var savedEntity = new DbSetRepository<MDM.PartyRoleAccountability>(new MappingContext()).FindOne(id);
