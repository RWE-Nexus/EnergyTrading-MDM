namespace EnergyTrading.MDM.Test
{
    ...
    public class InstrumentTypeDataChecker
    {
        ...
        {
            var savedEntity =
                new DbSetRepository<MDM.InstrumentType>(new MappingContext()).FindOne(id);
        ...
        public void CompareContractWithSavedEntity(RWEST.Nexus.MDM.Contracts.InstrumentType contract)
        {
            ...
            var savedEntity = new DbSetRepository<MDM.InstrumentType>(new MappingContext()).FindOne(id);
