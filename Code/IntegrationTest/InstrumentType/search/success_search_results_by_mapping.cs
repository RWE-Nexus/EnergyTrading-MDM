namespace EnergyTrading.MDM.Test
{
    ...
    [TestClass]
    public class when_a_search_for_a_instrumenttype_is_made_with_a_mapping_value_and_results_are_found : IntegrationTestBase
    {
        ...
        {
            response = client.Post(ServiceUrl["InstrumentType"] + "search", content);
        }

        protected static void Establish_context()
        {
            entity1 = Script.InstrumentTypeData.CreateBasicEntityWithOneMapping();
            entity2 = Script.InstrumentTypeData.CreateBasicEntityWithOneMapping();
    ...
    [TestClass]
    public class when_a_search_for_a_instrumenttype_is_made_with_a_mapping_value_and_a_system_name_and_results_are_found : IntegrationTestBase
    {
        private static HttpClient client;
