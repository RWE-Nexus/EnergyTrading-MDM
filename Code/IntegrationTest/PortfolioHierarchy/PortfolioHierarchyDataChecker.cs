namespace EnergyTrading.MDM.Test
{
    ...
    public static class PortfolioHierarchyDataChecker
    {
        ...
        {
            var savedEntity =
                new DbSetRepository<MDM.PortfolioHierarchy>(new MappingContext()).FindOne(id);
        ...
        public static void CompareContractWithSavedEntity(RWEST.Nexus.MDM.Contracts.PortfolioHierarchy contract)
        {
            ...
            var savedEntity = new DbSetRepository<MDM.PortfolioHierarchy>(new MappingContext()).FindOne(id);
