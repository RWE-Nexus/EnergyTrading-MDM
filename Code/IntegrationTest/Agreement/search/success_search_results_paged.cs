    namespace EnergyTrading.MDM.Test
{
    ...
    [TestClass]
    public class when_a_search_for_a_agreement_with_two_results_is_paged_at_one_per_page : IntegrationTestBase
    {
        ...
        private static IList<Agreement> pageOne;
        private static Uri pageOneNextPage;
        private static IList<Agreement> pageTwo;
        ...
        {
            pageOneResponse = client.Post(ServiceUrl["Agreement"] + "search", content);
        ...
        protected static void Establish_context()
        {
            ...
            AgreementData.CreateSearch(search, entity1, entity2);
        ...
        private static IList<Agreement> GetPeopleFromFeed(SyndicationFeed feed)
        {
