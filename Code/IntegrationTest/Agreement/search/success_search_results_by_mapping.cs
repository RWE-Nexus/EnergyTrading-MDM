namespace EnergyTrading.MDM.Test
{
    ...
    [TestClass]
    public class when_a_search_for_a_agreement_is_made_with_a_mapping_value_and_results_are_found : IntegrationTestBase
    {
        ...
        public void should_return_the_relevant_search_results()
        {
            ...
            List<RWEST.Nexus.MDM.Contracts.Agreement> result =
                feed.Items.Select(syndicationItem => (XmlSyndicationContent)syndicationItem.Content).Select(
                    syndic => syndic.ReadContent<RWEST.Nexus.MDM.Contracts.Agreement>()).ToList();
        ...
        {
            response = client.Post(ServiceUrl["Agreement"] + "search", content);
        }

        protected static void Establish_context()
        {
            entity1 = AgreementData.CreateBasicEntityWithOneMapping();
            entity2 = AgreementData.CreateBasicEntityWithOneMapping();
    ...
    [TestClass]
    public class when_a_search_for_a_agreement_is_made_with_a_mapping_value_and_a_system_name_and_results_are_found : IntegrationTestBase
    {
        private static HttpClient client;
