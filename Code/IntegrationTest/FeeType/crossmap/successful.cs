namespace EnergyTrading.MDM.Test 
{
    ...
    [TestClass]
    public class when_a_source_system_to_destination_system_mapping_request_is_made_for_feetype : IntegrationTestBase
    {
        ...
        {
            entity = Script.FeeTypeData.CreateEntityWithTwoDetailsAndTwoMappings();

            client = new HttpClient(ServiceUrl["FeeType"] +
                "crossmap?source-system=trayport&destination-system=gastar&mapping-string=" + entity.Mappings[0].MappingValue);
        ...
        public void should_return_the_correct_vesrion_of_the_mapping()
        {
            ...
            Assert.AreEqual("gastar", mappingResponse.Mappings[0].SystemName.ToLower(), true);
    ...
    [TestClass]
    public class when_a_source_system_to_destination_system_mapping_request_is_made_as_of_a_date_for_feetype : IntegrationTestBase
    {
        private static HttpResponseMessage response;
        private static MappingResponse mappingResponse;
        private static HttpClient client;
