	namespace EnergyTrading.MDM.Test
{
    ...
    [TestClass]
    public class when_a_search_for_a_feetype_with_two_results_is_paged_at_one_per_page : IntegrationTestBase
    {
        ...
        private static IList<FeeType> pageOne;
        private static Uri pageOneNextPage;
        private static IList<FeeType> pageTwo;
        ...
        {
            pageOneResponse = client.Post(ServiceUrl["FeeType"] + "search", content);
        ...
        protected static void Establish_context()
        {
            ...
            Script.FeeTypeData.CreateSearch(search, entity1, entity2);
        ...
        private static IList<FeeType> GetPeopleFromFeed(SyndicationFeed feed)
        {
            List<RWEST.Nexus.MDM.Contracts.FeeType> result =
                feed.Items.Select(syndicationItem => (XmlSyndicationContent)syndicationItem.Content).Select(
                    syndic => syndic.ReadContent<RWEST.Nexus.MDM.Contracts.FeeType>()).ToList();
