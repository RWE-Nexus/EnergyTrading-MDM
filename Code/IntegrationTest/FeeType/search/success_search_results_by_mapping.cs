namespace EnergyTrading.MDM.Test
{
    ...
    [TestClass]
    public class when_a_search_for_a_feetype_is_made_with_a_mapping_value_and_results_are_found : IntegrationTestBase
    {
        ...
        {
            response = client.Post(ServiceUrl["FeeType"] + "search", content);
        }

        protected static void Establish_context()
        {
            entity1 = Script.FeeTypeData.CreateBasicEntityWithOneMapping();
            entity2 = Script.FeeTypeData.CreateBasicEntityWithOneMapping();
    ...
    [TestClass]
    public class when_a_search_for_a_feetype_is_made_with_a_mapping_value_and_a_system_name_and_results_are_found : IntegrationTestBase
    {
        private static HttpClient client;
