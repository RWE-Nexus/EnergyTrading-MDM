namespace EnergyTrading.MDM.Test
{
    ...
    [TestClass]
    public class when_a_search_for_a_partyoverride_is_made_with_a_specific_name : IntegrationTestBase
    {
        ...
        {
            var entity1 = PartyOverrideData.CreateBasicEntity();
            var entity2 = PartyOverrideData.CreateBasicEntity();
