namespace EnergyTrading.MDM.Test
{
    ...
    [TestClass]
    public class when_a_request_is_made_for_an_individual_mapping_for_a_producttypeinstance : IntegrationTestBase
    {
        private static HttpResponseMessage response;
        private static MappingResponse mappingResponse;
        private static HttpClient client;
        private static ProductTypeInstance entity;
        private static ProductTypeInstanceMapping mapping;
        ...
        protected static void Because_of()
        {
            ...
            client = new HttpClient(ServiceUrl["ProductTypeInstance"] + string.Format("{0}/mapping/{1}", entity.Id, mapping.Id));
