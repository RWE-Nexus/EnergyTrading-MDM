namespace EnergyTrading.MDM.Test
{
    ...
    public class when_a_request_is_made_to_update_a_producttypeinstance_mapping_and_the_mapping_doesnt_exist : IntegrationTestBase
    {
        ...
        {
            var producttypeinstanceMapping = new DbSetRepository<MDM.ProductTypeInstanceMapping>(new MappingContext()).FindOne(entity.Mappings[0].Id);
            return BitConverter.ToInt64(producttypeinstanceMapping.Version, 0);
        }
    }
}
