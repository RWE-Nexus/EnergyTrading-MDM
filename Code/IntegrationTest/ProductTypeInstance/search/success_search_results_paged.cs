	namespace EnergyTrading.MDM.Test
{
    ...
    [TestClass]
    [Ignore] // TODO: paging removed to get perf changes in for uk gas release
    public class when_a_search_for_a_producttypeinstance_with_two_results_is_paged_at_one_per_page : IntegrationTestBase
    {
        ...
        private static IList<ProductTypeInstance> pageOne;
        private static Uri pageOneNextPage;
        private static IList<ProductTypeInstance> pageTwo;
        ...
        {
            pageOneResponse = client.Post(ServiceUrl["ProductTypeInstance"] + "search", content);
        ...
        private static IList<ProductTypeInstance> GetPeopleFromFeed(SyndicationFeed feed)
        {
