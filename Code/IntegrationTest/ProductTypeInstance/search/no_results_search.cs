namespace EnergyTrading.MDM.Test
{
    ...
    [TestClass]
    public class when_a_search_for_a_producttypeinstance_is_made_with_a_specific_name_and_no_results_are_found : IntegrationTestBase
    {
        ...
        protected static void Establish_context()
        {
            ...
            search.AddSearchCriteria(SearchCombinator.Or).AddCriteria(
                "Name", SearchCondition.Equals, Guid.NewGuid().ToString());
