	namespace EnergyTrading.MDM.Test
{
    ...
    [TestClass]
    public class when_a_search_for_a_businessunit_with_two_results_is_paged_at_one_per_page : IntegrationTestBase
    {
        ...
        private static IList<BusinessUnit> pageOne;
        private static Uri pageOneNextPage;
        private static IList<BusinessUnit> pageTwo;
        ...
        {
            pageOneResponse = client.Post(ServiceUrl["BusinessUnit"] + "search", content);
        ...
        protected static void Establish_context()
        {
			...
			BusinessUnitData.CreateSearch(search, entity1, entity2);
        ...
        private static IList<BusinessUnit> GetPeopleFromFeed(SyndicationFeed feed)
        {
