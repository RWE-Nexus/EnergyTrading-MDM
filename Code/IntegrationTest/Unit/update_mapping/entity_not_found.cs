namespace EnergyTrading.MDM.Test
{
    ...
    [TestClass]
    public class when_a_request_is_made_to_update_a_unit_mapping_and_the_mapping_doesnt_exist : IntegrationTestBase
    {
        ...
        protected static void Because_of()
        {
            ...
            response = client.Post(ServiceUrl["Unit"] +  string.Format("{0}/Mapping/{1}", entity.Id, int.MaxValue), content);
        }
        ...
        private static long CurrentEntityVersion()
        {
            ...
            return BitConverter.ToInt64(unitMapping.Version, 0);
        }
    }
}
