	namespace EnergyTrading.MDM.Test
{
    ...
    [TestClass]
    public class when_a_search_for_a_calendar_with_two_results_is_paged_at_one_per_page : IntegrationTestBase
    {
        ...
        private static IList<Calendar> pageOne;
        private static Uri pageOneNextPage;
        private static IList<Calendar> pageTwo;
        ...
        {
            pageOneResponse = client.Post(ServiceUrl["Calendar"] + "search", content);
        ...
        protected static void Establish_context()
        {
			...
			Script.CalendarData.CreateSearch(search, entity1, entity2);
        ...
        private static IList<Calendar> GetPeopleFromFeed(SyndicationFeed feed)
        {
