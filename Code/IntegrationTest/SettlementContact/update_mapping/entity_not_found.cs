namespace EnergyTrading.MDM.Test
{
    ...
    public class when_a_request_is_made_to_update_a_settlementcontact_mapping_and_the_mapping_doesnt_exist : IntegrationTestBase
    {
        ...
        protected static void Because_of()
       {
        ...
        {
            var settlementcontactMapping = new DbSetRepository<MDM.PartyAccountabilityMapping>(new MappingContext()).FindOne(entity.Mappings[0].Id);
            return BitConverter.ToInt64(settlementcontactMapping.Version, 0);
        }
    }
}
