namespace EnergyTrading.MDM.Test
{
    ...
    [TestClass]
    public class when_a_search_for_a_tenortype_is_made_with_a_specific_name : IntegrationTestBase
    {
        ...
        {
            var entity1 = TenorTypeData.CreateBasicEntity();
            var entity2 = TenorTypeData.CreateBasicEntity();
