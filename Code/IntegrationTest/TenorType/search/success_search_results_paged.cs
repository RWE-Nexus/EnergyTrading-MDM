	namespace EnergyTrading.MDM.Test
{
    ...
    [TestClass]
    public class when_a_search_for_a_tenortype_with_two_results_is_paged_at_one_per_page : IntegrationTestBase
    {
        ...
        private static IList<TenorType> pageOne;
        private static Uri pageOneNextPage;
        private static IList<TenorType> pageTwo;
        ...
        {
            pageOneResponse = client.Post(ServiceUrl["TenorType"] + "search", content);
        ...
        protected static void Establish_context()
        {
			...
			TenorTypeData.CreateSearch(search, entity1, entity2);
        ...
        private static IList<TenorType> GetPeopleFromFeed(SyndicationFeed feed)
        {
            List<RWEST.Nexus.MDM.Contracts.TenorType> result =
                feed.Items.Select(syndicationItem => (XmlSyndicationContent)syndicationItem.Content).Select(
                    syndic => syndic.ReadContent<RWEST.Nexus.MDM.Contracts.TenorType>()).ToList();
