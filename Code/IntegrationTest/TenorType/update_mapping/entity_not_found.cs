namespace EnergyTrading.MDM.Test
{
    ...
    [TestClass]
    public class when_a_request_is_made_to_update_a_tenortype_mapping_and_the_mapping_doesnt_exist : IntegrationTestBase
    {
        ...
        protected static void Because_of()
        {
            ...
            response = client.Post(ServiceUrl["TenorType"] +  string.Format("{0}/Mapping/{1}", entity.Id, int.MaxValue), content);
        }
        ...
        {
            var tenortypeMapping = new DbSetRepository<MDM.TenorTypeMapping>(new MappingContext()).FindOne(entity.Mappings[0].Id);
            return BitConverter.ToInt64(tenortypeMapping.Version, 0);
        }
    }
}
