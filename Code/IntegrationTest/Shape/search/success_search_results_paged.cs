	namespace EnergyTrading.MDM.Test
{
    ...
    [TestClass]
    public class when_a_search_for_a_shape_with_two_results_is_paged_at_one_per_page : IntegrationTestBase
    {
        ...
        private static IList<Shape> pageOne;
        private static Uri pageOneNextPage;
        private static IList<Shape> pageTwo;
        ...
        {
            pageOneResponse = client.Post(ServiceUrl["Shape"] + "search", content);
        ...
        protected static void Establish_context()
        {
			...
			ShapeData.CreateSearch(search, entity1, entity2);
        ...
        private static IList<Shape> GetPeopleFromFeed(SyndicationFeed feed)
        {
