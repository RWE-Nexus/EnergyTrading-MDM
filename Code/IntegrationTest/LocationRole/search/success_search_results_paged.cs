	namespace EnergyTrading.MDM.Test
{
    ...
    [TestClass]
    public class when_a_search_for_a_locationrole_with_two_results_is_paged_at_one_per_page : IntegrationTestBase
    {
        ...
        private static IList<LocationRole> pageOne;
        private static Uri pageOneNextPage;
        private static IList<LocationRole> pageTwo;
        ...
        {
            pageOneResponse = client.Post(ServiceUrl["LocationRole"] + "search", content);
        ...
        protected static void Establish_context()
        {
			...
			Script.LocationRoleData.CreateSearch(search, entity1, entity2);
        ...
        private static IList<LocationRole> GetPeopleFromFeed(SyndicationFeed feed)
        {
