namespace EnergyTrading.MDM.Test 
{
    ...
    [TestClass]
    public class when_a_source_system_to_destination_system_mapping_request_is_made_for_product : IntegrationTestBase
    {
        ...
        {
            entity = Script.ProductData.CreateEntityWithTwoDetailsAndTwoMappings();
    ...
    [TestClass]
    public class when_a_source_system_to_destination_system_mapping_request_is_made_as_of_a_date_for_product : IntegrationTestBase
    {
        private static HttpResponseMessage response;
        private static MappingResponse mappingResponse;
        private static HttpClient client;
