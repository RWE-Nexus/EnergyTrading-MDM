namespace EnergyTrading.MDM.Test
{
    ...
    [TestClass]
    public class when_a_request_is_made_to_create_a_product_mapping_and_a_conflicting_mapping_exists : IntegrationTestBase
    {
        ...
        {
            client.Post(ServiceUrl["Product"] + string.Format("{0}/Mapping", entity.Id), content);
            response2 = client.Post(ServiceUrl["Product"] + string.Format("{0}/Mapping", entity.Id), content2);
        }
