	namespace EnergyTrading.MDM.Test
{
    ...
    [TestClass]
    public class when_a_search_for_a_commodityinstrumenttype_with_two_results_is_paged_at_one_per_page : IntegrationTestBase
    {
        ...
        private static IList<CommodityInstrumentType> pageOne;
        private static Uri pageOneNextPage;
        private static IList<CommodityInstrumentType> pageTwo;
        ...
        {
            pageOneResponse = client.Post(ServiceUrl["CommodityInstrumentType"] + "search", content);
        ...
        protected static void Establish_context()
        {
			...
			CommodityInstrumentTypeData.CreateSearch(search, entity1, entity2);
        ...
        private static IList<CommodityInstrumentType> GetPeopleFromFeed(SyndicationFeed feed)
        {
