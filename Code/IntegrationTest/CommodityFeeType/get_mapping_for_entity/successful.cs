namespace EnergyTrading.MDM.Test
{
    ...
    [TestClass]
    public class when_a_request_is_made_for_an_individual_mapping_for_a_commodityfeetype : IntegrationTestBase
    {
        private static HttpResponseMessage response;
        private static MappingResponse mappingResponse;
        private static HttpClient client;
        private static CommodityFeeType entity;
        private static CommodityFeeTypeMapping mapping;
        ...
        protected static void Because_of()
        {
            ...
            client = new HttpClient(ServiceUrl["CommodityFeeType"] + string.Format("{0}/mapping/{1}", entity.Id, mapping.Id));
