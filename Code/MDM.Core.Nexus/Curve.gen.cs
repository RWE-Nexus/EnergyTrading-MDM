namespace EnergyTrading.MDM
{
    ...
    public partial class Curve : IIdentifiable, IEntity, IEntityDetail
    {
        public Curve()
        {
            this.Mappings = new List<CurveMapping>();
        ...
        public virtual IList<CurveMapping> Mappings { get; private set; }
        ...
        /// <summary>
        /// Add a details to the Curve checking its validity 
        /// </summary>
        /// <param name="details"></param>
        public void AddDetails(Curve details)
        {
            // Sanity checks
            if (details == null)
            {
        ...
        public void ProcessMapping(CurveMapping mapping)
        {
        ...
        {
            this.AddDetails(details as Curve);
        }

        void IEntity.ProcessMapping(IEntityMapping mapping)
        {
            this.ProcessMapping(mapping as CurveMapping);
        }
    }
}