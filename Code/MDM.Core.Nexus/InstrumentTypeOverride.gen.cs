namespace EnergyTrading.MDM
{
    ...
    public partial class InstrumentTypeOverride : IIdentifiable, IEntity, IEntityDetail
    {
        public InstrumentTypeOverride()
        {
            this.Mappings = new List<InstrumentTypeOverrideMapping>();
        ...
        public virtual IList<InstrumentTypeOverrideMapping> Mappings { get; private set; }
        ...
        /// <summary>
        /// Add a details to the InstrumentTypeOverride checking its validity 
        /// </summary>
        /// <param name="details"></param>
        public void AddDetails(InstrumentTypeOverride details)
        {
            // Sanity checks
            if (details == null)
            {
        ...
        public void ProcessMapping(InstrumentTypeOverrideMapping mapping)
        {
        ...
        {
            this.AddDetails(details as InstrumentTypeOverride);
        }

        void IEntity.ProcessMapping(IEntityMapping mapping)
        {
            this.ProcessMapping(mapping as InstrumentTypeOverrideMapping);
        }
    }
}