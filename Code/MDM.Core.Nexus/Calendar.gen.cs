namespace EnergyTrading.MDM
{
    ...
    public partial class Calendar : IIdentifiable, IEntity, IEntityDetail
    {
        public Calendar()
        {
            this.Mappings = new List<CalendarMapping>();
        ...
        public virtual IList<CalendarMapping> Mappings { get; private set; }
        ...
        /// <summary>
        /// Add a details to the Calendar checking its validity 
        /// </summary>
        /// <param name="details"></param>
        public void AddDetails(Calendar details)
        {
            // Sanity checks
            if (details == null)
            {
        ...
        public void ProcessMapping(CalendarMapping mapping)
        {
        ...
        {
            this.AddDetails(details as Calendar);
        }

        void IEntity.ProcessMapping(IEntityMapping mapping)
        {
            this.ProcessMapping(mapping as CalendarMapping);
        }
    }
}