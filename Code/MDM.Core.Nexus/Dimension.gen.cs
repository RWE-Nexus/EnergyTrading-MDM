namespace EnergyTrading.MDM
{
    ...
    public partial class Dimension : IIdentifiable, IEntity, IEntityDetail
    {
        public Dimension()
        {
            this.Mappings = new List<DimensionMapping>();
        ...
        public virtual IList<DimensionMapping> Mappings { get; private set; }
        ...
        /// <summary>
        /// Add a details to the Dimension checking its validity 
        /// </summary>
        /// <param name="details"></param>
        public void AddDetails(Dimension details)
        {
            // Sanity checks
            if (details == null)
            {
        ...
        public void ProcessMapping(DimensionMapping mapping)
        {
        ...
        {
            this.AddDetails(details as Dimension);
        }

        void IEntity.ProcessMapping(IEntityMapping mapping)
        {
            this.ProcessMapping(mapping as DimensionMapping);
        }
    }
}