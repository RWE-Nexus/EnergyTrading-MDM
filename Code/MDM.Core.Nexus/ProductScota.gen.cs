namespace EnergyTrading.MDM
{
    ...
    public partial class ProductScota : IIdentifiable, IEntity, IEntityDetail
    {
        public ProductScota()
        {
            this.Mappings = new List<ProductScotaMapping>();
        ...
        public virtual IList<ProductScotaMapping> Mappings { get; private set; }
        ...
        /// <summary>
        /// Add a details to the ProductScota checking its validity 
        /// </summary>
        /// <param name="details"></param>
        public void AddDetails(ProductScota details)
        {
            // Sanity checks
            if (details == null)
            {
        ...
        public void ProcessMapping(ProductScotaMapping mapping)
        {
        ...
        {
            this.AddDetails(details as ProductScota);
        }

        void IEntity.ProcessMapping(IEntityMapping mapping)
        {
            this.ProcessMapping(mapping as ProductScotaMapping);
        }
    }
}