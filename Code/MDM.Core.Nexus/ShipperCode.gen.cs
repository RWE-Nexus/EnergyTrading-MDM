namespace EnergyTrading.MDM
{
    ...
    public partial class ShipperCode : IIdentifiable, IEntity, IEntityDetail
    {
        public ShipperCode()
        {
            this.Mappings = new List<ShipperCodeMapping>();
        ...
        public virtual IList<ShipperCodeMapping> Mappings { get; private set; }
        ...
        /// <summary>
        /// Add a details to the ShipperCode checking its validity 
        /// </summary>
        /// <param name="details"></param>
        public void AddDetails(ShipperCode details)
        {
            // Sanity checks
            if (details == null)
            {
        ...
        public void ProcessMapping(ShipperCodeMapping mapping)
        {
        ...
        {
            this.AddDetails(details as ShipperCode);
        }

        void IEntity.ProcessMapping(IEntityMapping mapping)
        {
            this.ProcessMapping(mapping as ShipperCodeMapping);
        }
    }
}