namespace EnergyTrading.MDM
{
    ...
    public partial class BrokerCommodity : IIdentifiable, IEntity, IEntityDetail
    {
        public BrokerCommodity()
        {
            this.Mappings = new List<BrokerCommodityMapping>();
        ...
        public virtual IList<BrokerCommodityMapping> Mappings { get; private set; }
        ...
        /// <summary>
        /// Add a details to the BrokerCommodity checking its validity 
        /// </summary>
        /// <param name="details"></param>
        public void AddDetails(BrokerCommodity details)
        {
            // Sanity checks
            if (details == null)
            {
        ...
        public void ProcessMapping(BrokerCommodityMapping mapping)
        {
        ...
        {
            this.AddDetails(details as BrokerCommodity);
        }

        void IEntity.ProcessMapping(IEntityMapping mapping)
        {
            this.ProcessMapping(mapping as BrokerCommodityMapping);
        }
    }
}