namespace EnergyTrading.MDM.Contracts.Mappers
{
	...
	///
	/// </summary>
    public class DimensionDetailsMapper : Mapper<OpenNexus.MDM.Contracts.DimensionDetails, MDM.Dimension>
    {
        public override void Map(OpenNexus.MDM.Contracts.DimensionDetails source, MDM.Dimension destination)
        {
