namespace EnergyTrading.MDM.Contracts.Mappers
{
    ...
    public class SettlementContactDetailsMapper : Mapper<RWEST.Nexus.MDM.Contracts.SettlementContactDetails, MDM.SettlementContact>
    {
        ...
        public override void Map(RWEST.Nexus.MDM.Contracts.SettlementContactDetails source, MDM.SettlementContact destination)
        {
