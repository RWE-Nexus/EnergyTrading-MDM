namespace EnergyTrading.MDM.Contracts.Mappers
{
    ...
    public class InstrumentTypeOverrideDetailsMapper : Mapper<OpenNexus.MDM.Contracts.InstrumentTypeOverrideDetails, MDM.InstrumentTypeOverride>
    {
        ...
        public override void Map(OpenNexus.MDM.Contracts.InstrumentTypeOverrideDetails source, MDM.InstrumentTypeOverride destination)
        {
