namespace EnergyTrading.MDM.Contracts.Mappers
{
    ...
    public class PersonDetailsMapper : Mapper<RWEST.Nexus.MDM.Contracts.PersonDetails, MDM.PersonDetails>
    {
        public override void Map(RWEST.Nexus.MDM.Contracts.PersonDetails source, MDM.PersonDetails destination)
        {
