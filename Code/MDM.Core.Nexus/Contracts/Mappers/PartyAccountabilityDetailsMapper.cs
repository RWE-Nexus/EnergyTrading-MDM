namespace EnergyTrading.MDM.Contracts.Mappers
{
	...
	///
	/// </summary>
    public class PartyAccountabilityDetailsMapper : Mapper<RWEST.Nexus.MDM.Contracts.PartyAccountabilityDetails, MDM.PartyAccountability>
    {
        ...
        public override void Map(RWEST.Nexus.MDM.Contracts.PartyAccountabilityDetails source, MDM.PartyAccountability destination)
        {
