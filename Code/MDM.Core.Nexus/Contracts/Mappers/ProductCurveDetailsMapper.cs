...
namespace EnergyTrading.MDM.Contracts.Mappers
{
	...
	///
	/// </summary>
    public class ProductCurveDetailsMapper : Mapper<OpenNexus.MDM.Contracts.ProductCurveDetails, MDM.ProductCurve>
    {
        ...
        public override void Map(OpenNexus.MDM.Contracts.ProductCurveDetails source, MDM.ProductCurve destination)
        {
