namespace EnergyTrading.MDM.Contracts.Mappers
{
    ...
    public class TenorTypeDetailsMapper : Mapper<OpenNexus.MDM.Contracts.TenorTypeDetails, MDM.TenorType>
    {
        public override void Map(OpenNexus.MDM.Contracts.TenorTypeDetails source, MDM.TenorType destination)
        {
