namespace EnergyTrading.MDM.Contracts.Mappers
{
    ...
    public class BrokerRateDetailsMapper : Mapper<OpenNexus.MDM.Contracts.BrokerRateDetails, MDM.BrokerRateDetails>
    {
        ...
        public override void Map(OpenNexus.MDM.Contracts.BrokerRateDetails source, MDM.BrokerRateDetails destination)
        {
