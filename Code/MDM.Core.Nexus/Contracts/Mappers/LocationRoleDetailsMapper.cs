namespace EnergyTrading.MDM.Contracts.Mappers
{
    ...
    public class LocationRoleDetailsMapper : Mapper<RWEST.Nexus.MDM.Contracts.LocationRoleDetails, MDM.LocationRole>
    {
        ...
        public override void Map(RWEST.Nexus.MDM.Contracts.LocationRoleDetails source, MDM.LocationRole destination)
        {
