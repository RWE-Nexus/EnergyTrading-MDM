...
namespace EnergyTrading.MDM.Contracts.Mappers
{
	...
	///
	/// </summary>
    public class CurveDetailsMapper : Mapper<OpenNexus.MDM.Contracts.CurveDetails, MDM.Curve>
    {
        ...
        public override void Map(OpenNexus.MDM.Contracts.CurveDetails source, MDM.Curve destination)
        {
