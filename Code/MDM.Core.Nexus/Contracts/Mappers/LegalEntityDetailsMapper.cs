namespace EnergyTrading.MDM.Contracts.Mappers
{
    ...
    public class LegalEntityDetailsMapper : Mapper<RWEST.Nexus.MDM.Contracts.LegalEntityDetails, MDM.LegalEntityDetails>
    {
        public override void Map(RWEST.Nexus.MDM.Contracts.LegalEntityDetails source, MDM.LegalEntityDetails destination)
        {
