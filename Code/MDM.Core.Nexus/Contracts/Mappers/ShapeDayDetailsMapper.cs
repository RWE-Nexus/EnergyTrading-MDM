namespace EnergyTrading.MDM.Contracts.Mappers
{
    ...
    public class ShapeDayDetailsMapper : Mapper<RWEST.Nexus.MDM.Contracts.ShapeDayDetails, MDM.ShapeDay>
    {
        ...
        public override void Map(RWEST.Nexus.MDM.Contracts.ShapeDayDetails source, MDM.ShapeDay destination)
        {
