namespace EnergyTrading.MDM.Contracts.Mappers
{
    ...
    public class BookDefaultDetailsMapper : Mapper<OpenNexus.MDM.Contracts.BookDefaultDetails, MDM.BookDefault>
    {
        ...
        public override void Map(OpenNexus.MDM.Contracts.BookDefaultDetails source, MDM.BookDefault destination)
        {
