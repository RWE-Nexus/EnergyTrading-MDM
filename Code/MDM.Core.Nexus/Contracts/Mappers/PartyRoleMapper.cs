namespace EnergyTrading.MDM.Contracts.Mappers
{
    ...
    public class PartyRoleMapper : ContractMapper<PartyRole, MDM.PartyRole, PartyRoleDetails, MDM.PartyRoleDetails, PartyRoleMapping>
    {
        ...
        public override void Map(RWEST.Nexus.MDM.Contracts.PartyRole source, MDM.PartyRole destination)
        {
        ...
        protected override IEnumerable<RWEST.Nexus.MDM.Contracts.NexusId> Identifiers(PartyRole contract)
        {
