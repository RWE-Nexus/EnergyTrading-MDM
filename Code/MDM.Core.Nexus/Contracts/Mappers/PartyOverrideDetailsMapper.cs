namespace EnergyTrading.MDM.Contracts.Mappers
{
    ...
    public class PartyOverrideDetailsMapper : Mapper<OpenNexus.MDM.Contracts.PartyOverrideDetails, MDM.PartyOverride>
    {
        ...
        public override void Map(OpenNexus.MDM.Contracts.PartyOverrideDetails source, MDM.PartyOverride destination)
        {
