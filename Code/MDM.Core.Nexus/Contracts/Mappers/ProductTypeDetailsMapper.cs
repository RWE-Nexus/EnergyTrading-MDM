namespace EnergyTrading.MDM.Contracts.Mappers
{
    ...
    public class ProductTypeDetailsMapper : Mapper<OpenNexus.MDM.Contracts.ProductTypeDetails, MDM.ProductType>
    {
        ...
        public override void Map(OpenNexus.MDM.Contracts.ProductTypeDetails source, MDM.ProductType destination)
        {
