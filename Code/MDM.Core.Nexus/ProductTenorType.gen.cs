namespace EnergyTrading.MDM
{
    ...
    public partial class ProductTenorType : IIdentifiable, IEntity, IEntityDetail
    {
        public ProductTenorType()
        {
            this.Mappings = new List<ProductTenorTypeMapping>();
        ...
        public virtual IList<ProductTenorTypeMapping> Mappings { get; private set; }
        ...
        /// <summary>
        /// Add a details to the ProductTenorType checking its validity 
        /// </summary>
        /// <param name="details"></param>
        public void AddDetails(ProductTenorType details)
        {
            // Sanity checks
            if (details == null)
            {
        ...
        public void ProcessMapping(ProductTenorTypeMapping mapping)
        {
        ...
        {
            this.AddDetails(details as ProductTenorType);
        }

        void IEntity.ProcessMapping(IEntityMapping mapping)
        {
            this.ProcessMapping(mapping as ProductTenorTypeMapping);
        }
    }
}