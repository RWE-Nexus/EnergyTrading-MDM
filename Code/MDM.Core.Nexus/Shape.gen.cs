namespace EnergyTrading.MDM
{
    ...
    public partial class Shape : IIdentifiable, IEntity, IEntityDetail
    {
        public Shape()
        {
            this.Mappings = new List<ShapeMapping>();
        ...
        public virtual IList<ShapeMapping> Mappings { get; private set; }
        ...
        /// <summary>
        /// Add a details to the Shape checking its validity 
        /// </summary>
        /// <param name="details"></param>
        public void AddDetails(Shape details)
        {
            // Sanity checks
            if (details == null)
            {
        ...
        public void ProcessMapping(ShapeMapping mapping)
        {
        ...
        {
            this.AddDetails(details as Shape);
        }

        void IEntity.ProcessMapping(IEntityMapping mapping)
        {
            this.ProcessMapping(mapping as ShapeMapping);
        }
    }
}