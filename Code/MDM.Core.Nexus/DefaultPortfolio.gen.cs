namespace EnergyTrading.MDM
{
    ...
    public partial class BookDefault : IIdentifiable, IEntity, IEntityDetail
    {
        public BookDefault()
        {
            this.Mappings = new List<BookDefaultMapping>();
        ...
        public virtual IList<BookDefaultMapping> Mappings { get; private set; }
        ...
        /// <summary>
        /// Add a details to the BookDefault checking its validity 
        /// </summary>
        /// <param name="details"></param>
        public void AddDetails(BookDefault details)
        {
            // Sanity checks
            if (details == null)
            {
        ...
        public void ProcessMapping(BookDefaultMapping mapping)
        {
        ...
        {
            this.AddDetails(details as BookDefault);
        }

        void IEntity.ProcessMapping(IEntityMapping mapping)
        {
            this.ProcessMapping(mapping as BookDefaultMapping);
        }
    }
}