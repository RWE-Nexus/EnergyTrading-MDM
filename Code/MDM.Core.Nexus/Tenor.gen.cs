namespace EnergyTrading.MDM
{
    ...
    public partial class Tenor : IIdentifiable, IEntity, IEntityDetail
    {
        public Tenor()
        {
            this.Mappings = new List<TenorMapping>();
        ...
        public virtual IList<TenorMapping> Mappings { get; private set; }
        ...
        /// <summary>
        /// Add a details to the Tenor checking its validity 
        /// </summary>
        /// <param name="details"></param>
        public void AddDetails(Tenor details)
        {
            // Sanity checks
            if (details == null)
            {
        ...
        public void ProcessMapping(TenorMapping mapping)
        {
        ...
        {
            this.AddDetails(details as Tenor);
        }

        void IEntity.ProcessMapping(IEntityMapping mapping)
        {
            this.ProcessMapping(mapping as TenorMapping);
        }
    }
}