namespace EnergyTrading.MDM
{
    ...
    public partial class ProductType : IIdentifiable, IEntity, IEntityDetail
    {
        public ProductType()
        {
            this.Mappings = new List<ProductTypeMapping>();
        ...
        public virtual IList<ProductTypeMapping> Mappings { get; private set; }
        ...
        /// <summary>
        /// Add a details to the ProductType checking its validity 
        /// </summary>
        /// <param name="details"></param>
        public void AddDetails(ProductType details)
        {
            // Sanity checks
            if (details == null)
            {
        ...
        public void ProcessMapping(ProductTypeMapping mapping)
        {
        ...
        {
            this.AddDetails(details as ProductType);
        }

        void IEntity.ProcessMapping(IEntityMapping mapping)
        {
            this.ProcessMapping(mapping as ProductTypeMapping);
        }
    }
}