namespace EnergyTrading.MDM
{
    ...
    public partial class ProductCurve : IIdentifiable, IEntity, IEntityDetail
    {
        public ProductCurve()
        {
            this.Mappings = new List<ProductCurveMapping>();
        ...
        public virtual IList<ProductCurveMapping> Mappings { get; private set; }
        ...
        /// <summary>
        /// Add a details to the ProductCurve checking its validity 
        /// </summary>
        /// <param name="details"></param>
        public void AddDetails(ProductCurve details)
        {
            // Sanity checks
            if (details == null)
            {
        ...
        public void ProcessMapping(ProductCurveMapping mapping)
        {
        ...
        {
            this.AddDetails(details as ProductCurve);
        }

        void IEntity.ProcessMapping(IEntityMapping mapping)
        {
            this.ProcessMapping(mapping as ProductCurveMapping);
        }
    }
}