namespace EnergyTrading.MDM
{
    ...
    public partial class InstrumentType : IIdentifiable, IEntity, IEntityDetail
    {
        public InstrumentType()
        {
            this.Mappings = new List<InstrumentTypeMapping>();
        ...
        public virtual IList<InstrumentTypeMapping> Mappings { get; private set; }
        ...
        /// <summary>
        /// Add a details to the InstrumentType checking its validity 
        /// </summary>
        /// <param name="details"></param>
        public void AddDetails(InstrumentType details)
        {
            // Sanity checks
            if (details == null)
            {
        ...
        public void ProcessMapping(InstrumentTypeMapping mapping)
        {
        ...
        {
            this.AddDetails(details as InstrumentType);
        }

        void IEntity.ProcessMapping(IEntityMapping mapping)
        {
            this.ProcessMapping(mapping as InstrumentTypeMapping);
        }
    }
}