namespace EnergyTrading.MDM
{
    ...
    public partial class CommodityInstrumentType : IIdentifiable, IEntity, IEntityDetail
    {
        public CommodityInstrumentType()
        {
            this.Mappings = new List<CommodityInstrumentTypeMapping>();
        ...
        public virtual IList<CommodityInstrumentTypeMapping> Mappings { get; private set; }
        ...
        /// <summary>
        /// Add a details to the CommodityInstrumentType checking its validity 
        /// </summary>
        /// <param name="details"></param>
        public void AddDetails(CommodityInstrumentType details)
        {
            // Sanity checks
            if (details == null)
            {
        ...
        public void ProcessMapping(CommodityInstrumentTypeMapping mapping)
        {
        ...
        {
            this.AddDetails(details as CommodityInstrumentType);
        }

        void IEntity.ProcessMapping(IEntityMapping mapping)
        {
            this.ProcessMapping(mapping as CommodityInstrumentTypeMapping);
        }
    }
}