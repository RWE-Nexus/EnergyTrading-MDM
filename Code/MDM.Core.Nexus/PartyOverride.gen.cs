namespace EnergyTrading.MDM
{
    ...
    public partial class PartyOverride : IIdentifiable, IEntity, IEntityDetail
    {
        public PartyOverride()
        {
            this.Mappings = new List<PartyOverrideMapping>();
        ...
        public virtual IList<PartyOverrideMapping> Mappings { get; private set; }
        ...
        /// <summary>
        /// Add a details to the PartyOverride checking its validity 
        /// </summary>
        /// <param name="details"></param>
        public void AddDetails(PartyOverride details)
        {
            // Sanity checks
            if (details == null)
            {
        ...
        public void ProcessMapping(PartyOverrideMapping mapping)
        {
        ...
        {
            this.AddDetails(details as PartyOverride);
        }

        void IEntity.ProcessMapping(IEntityMapping mapping)
        {
            this.ProcessMapping(mapping as PartyOverrideMapping);
        }
    }
}