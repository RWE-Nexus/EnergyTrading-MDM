namespace EnergyTrading.MDM
{
    ...
    public partial class Agreement : IIdentifiable, IEntity, IEntityDetail
    {
        public Agreement()
        {
            this.Mappings = new List<AgreementMapping>();
        ...
        public virtual IList<AgreementMapping> Mappings { get; private set; }
        ...
        /// <summary>
        /// Add a details to the Agreement checking its validity 
        /// </summary>
        /// <param name="details"></param>
        public void AddDetails(Agreement details)
        {
            // Sanity checks
            if (details == null)
            {
        ...
        public void ProcessMapping(AgreementMapping mapping)
        {
        ...
        {
            this.AddDetails(details as Agreement);
        }

        void IEntity.ProcessMapping(IEntityMapping mapping)
        {
            this.ProcessMapping(mapping as AgreementMapping);
        }
    }
}