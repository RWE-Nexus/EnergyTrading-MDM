namespace EnergyTrading.MDM
{
    ...
    public partial class Book : IIdentifiable, IEntity, IEntityDetail
    {
        public Book()
        {
            this.Mappings = new List<BookMapping>();
        ...
        public virtual IList<BookMapping> Mappings { get; private set; }
        ...
        /// <summary>
        /// Add a details to the Book checking its validity 
        /// </summary>
        /// <param name="details"></param>
        public void AddDetails(Book details)
        {
            // Sanity checks
            if (details == null)
            {
        ...
        public void ProcessMapping(BookMapping mapping)
        {
        ...
        {
            this.AddDetails(details as Book);
        }

        void IEntity.ProcessMapping(IEntityMapping mapping)
        {
            this.ProcessMapping(mapping as BookMapping);
        }
    }
}