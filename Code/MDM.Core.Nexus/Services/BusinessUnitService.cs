namespace EnergyTrading.MDM.Services
{
    ...
    public class BusinessUnitService : MdmService<OpenNexus.MDM.Contracts.BusinessUnit, BusinessUnit, PartyRoleMapping, BusinessUnitDetails, OpenNexus.MDM.Contracts.BusinessUnitDetails>
    {
