namespace EnergyTrading.MDM.Services
{
    ...
    public class InstrumentTypeService : MdmService<RWEST.Nexus.MDM.Contracts.InstrumentType, InstrumentType, InstrumentTypeMapping, InstrumentType, RWEST.Nexus.MDM.Contracts.InstrumentTypeDetails>
    {
