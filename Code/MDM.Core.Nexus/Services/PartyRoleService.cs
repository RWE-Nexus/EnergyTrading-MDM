namespace EnergyTrading.MDM.Services
{
    ...
    public class PartyRoleService : MdmService<OpenNexus.MDM.Contracts.PartyRole, PartyRole, PartyRoleMapping, PartyRoleDetails, OpenNexus.MDM.Contracts.PartyRoleDetails>
    {
