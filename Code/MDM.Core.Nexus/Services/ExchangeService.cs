namespace EnergyTrading.MDM.Services
{
    ...
    public class ExchangeService : MdmService<OpenNexus.MDM.Contracts.Exchange, Exchange, PartyRoleMapping, ExchangeDetails, OpenNexus.MDM.Contracts.ExchangeDetails>
    {
