namespace EnergyTrading.MDM.Services
{
    ...
    public class LocationService : MdmService<RWEST.Nexus.MDM.Contracts.Location, Location, LocationMapping, Location, RWEST.Nexus.MDM.Contracts.LocationDetails>
    {
