namespace EnergyTrading.MDM.Services
{
    ...
    public class CounterpartyService : MdmService<OpenNexus.MDM.Contracts.Counterparty, Counterparty, PartyRoleMapping, CounterpartyDetails, OpenNexus.MDM.Contracts.CounterpartyDetails>
    {
