namespace EnergyTrading.MDM.Services
{
    ...
    public class ShipperCodeService : MdmService<OpenNexus.MDM.Contracts.ShipperCode, ShipperCode, ShipperCodeMapping, ShipperCode, OpenNexus.MDM.Contracts.ShipperCodeDetails>
    {
