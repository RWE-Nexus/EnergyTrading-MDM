namespace EnergyTrading.MDM
{
    ...
    public partial class Market : IIdentifiable, IEntity, IEntityDetail
    {
        public Market()
        {
            this.Mappings = new List<MarketMapping>();
        ...
        public virtual IList<MarketMapping> Mappings { get; private set; }
        ...
        /// <summary>
        /// Add a details to the Market checking its validity 
        /// </summary>
        /// <param name="details"></param>
        public void AddDetails(Market details)
        {
            // Sanity checks
            if (details == null)
            {
        ...
        public void ProcessMapping(MarketMapping mapping)
        {
        ...
        {
            this.AddDetails(details as Market);
        }

        void IEntity.ProcessMapping(IEntityMapping mapping)
        {
            this.ProcessMapping(mapping as MarketMapping);
        }
    }
}