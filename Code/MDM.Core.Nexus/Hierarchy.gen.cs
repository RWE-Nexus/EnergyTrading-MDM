namespace EnergyTrading.MDM
{
    ...
    public partial class Hierarchy : IIdentifiable, IEntity, IEntityDetail
    {
        public Hierarchy()
        {
            this.Mappings = new List<HierarchyMapping>();
        ...
        public virtual IList<HierarchyMapping> Mappings { get; private set; }
        ...
        /// <summary>
        /// Add a details to the Hierarchy checking its validity 
        /// </summary>
        /// <param name="details"></param>
        public void AddDetails(Hierarchy details)
        {
            // Sanity checks
            if (details == null)
            {
        ...
        public void ProcessMapping(HierarchyMapping mapping)
        {
        ...
        {
            this.AddDetails(details as Hierarchy);
        }

        void IEntity.ProcessMapping(IEntityMapping mapping)
        {
            this.ProcessMapping(mapping as HierarchyMapping);
        }
    }
}