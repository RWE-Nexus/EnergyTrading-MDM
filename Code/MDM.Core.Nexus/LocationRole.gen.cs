namespace EnergyTrading.MDM
{
    ...
    public partial class LocationRole : IIdentifiable, IEntity, IEntityDetail
    {
        public LocationRole()
        {
            this.Mappings = new List<LocationRoleMapping>();
        ...
        public virtual IList<LocationRoleMapping> Mappings { get; private set; }
        ...
        /// <summary>
        /// Add a details to the LocationRole checking its validity 
        /// </summary>
        /// <param name="details"></param>
        public void AddDetails(LocationRole details)
        {
            // Sanity checks
            if (details == null)
            {
        ...
        public void ProcessMapping(LocationRoleMapping mapping)
        {
        ...
        {
            this.AddDetails(details as LocationRole);
        }

        void IEntity.ProcessMapping(IEntityMapping mapping)
        {
            this.ProcessMapping(mapping as LocationRoleMapping);
        }
    }
}