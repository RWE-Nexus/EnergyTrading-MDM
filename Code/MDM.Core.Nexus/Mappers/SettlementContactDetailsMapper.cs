namespace EnergyTrading.MDM.Mappers
{
    ...
    /// </summary>
    public class SettlementContactDetailsMapper : Mapper<EnergyTrading.MDM.SettlementContact, RWEST.Nexus.MDM.Contracts.SettlementContactDetails>
    {
        public override void Map(EnergyTrading.MDM.SettlementContact source, RWEST.Nexus.MDM.Contracts.SettlementContactDetails destination)
        {
