namespace EnergyTrading.MDM.Mappers
{
    ...
    /// </summary>
    public class PortfolioHierarchyDetailsMapper : Mapper<EnergyTrading.MDM.PortfolioHierarchy, RWEST.Nexus.MDM.Contracts.PortfolioHierarchyDetails>
    {
        public override void Map(EnergyTrading.MDM.PortfolioHierarchy source, RWEST.Nexus.MDM.Contracts.PortfolioHierarchyDetails destination)
        {
