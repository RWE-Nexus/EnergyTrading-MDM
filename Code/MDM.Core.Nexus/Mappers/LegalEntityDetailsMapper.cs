namespace EnergyTrading.MDM.Mappers
{
    ...
    /// </summary>
    public class LegalEntityDetailsMapper : Mapper<EnergyTrading.MDM.LegalEntityDetails, RWEST.Nexus.MDM.Contracts.LegalEntityDetails>
    {
        public override void Map(EnergyTrading.MDM.LegalEntityDetails source, RWEST.Nexus.MDM.Contracts.LegalEntityDetails destination)
        {
