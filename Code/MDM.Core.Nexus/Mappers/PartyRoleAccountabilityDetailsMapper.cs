namespace EnergyTrading.MDM.Mappers
{
    ...
    /// </summary>
    public class PartyRoleAccountabilityDetailsMapper : Mapper<EnergyTrading.MDM.PartyRoleAccountability, RWEST.Nexus.MDM.Contracts.PartyRoleAccountabilityDetails>
    {
        public override void Map(EnergyTrading.MDM.PartyRoleAccountability source, RWEST.Nexus.MDM.Contracts.PartyRoleAccountabilityDetails destination)
        {
