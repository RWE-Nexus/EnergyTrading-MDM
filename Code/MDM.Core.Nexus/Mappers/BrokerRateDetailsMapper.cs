...
namespace EnergyTrading.MDM.Mappers
{
    ...
    /// </summary>
    public class BrokerRateDetailsMapper : Mapper<EnergyTrading.MDM.BrokerRateDetails, OpenNexus.MDM.Contracts.BrokerRateDetails>
    {
        public override void Map(EnergyTrading.MDM.BrokerRateDetails source, OpenNexus.MDM.Contracts.BrokerRateDetails destination)
        {
