namespace EnergyTrading.MDM.Mappers
{
    ...
    public class CommodityDetailsMapper : Mapper<EnergyTrading.MDM.Commodity, OpenNexus.MDM.Contracts.CommodityDetails>
    {
        public override void Map(EnergyTrading.MDM.Commodity source, OpenNexus.MDM.Contracts.CommodityDetails destination)
        {
