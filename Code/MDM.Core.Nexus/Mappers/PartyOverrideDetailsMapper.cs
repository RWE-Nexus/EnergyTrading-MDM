namespace EnergyTrading.MDM.Mappers
{
    ...
    /// </summary>
    public class PartyOverrideDetailsMapper : Mapper<EnergyTrading.MDM.PartyOverride, OpenNexus.MDM.Contracts.PartyOverrideDetails>
    {
        public override void Map(EnergyTrading.MDM.PartyOverride source, OpenNexus.MDM.Contracts.PartyOverrideDetails destination)
        {
