...
namespace EnergyTrading.MDM.Mappers
{
    ...
    /// </summary>
    public class CurveDetailsMapper : Mapper<EnergyTrading.MDM.Curve, OpenNexus.MDM.Contracts.CurveDetails>
    {
        public override void Map(EnergyTrading.MDM.Curve source, OpenNexus.MDM.Contracts.CurveDetails destination)
        {
