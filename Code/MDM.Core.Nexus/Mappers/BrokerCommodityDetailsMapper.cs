...
namespace EnergyTrading.MDM.Mappers
{
    ...
    /// </summary>
    public class BrokerCommodityDetailsMapper : Mapper<EnergyTrading.MDM.BrokerCommodity, RWEST.Nexus.MDM.Contracts.BrokerCommodityDetails>
    {
        public override void Map(EnergyTrading.MDM.BrokerCommodity source, RWEST.Nexus.MDM.Contracts.BrokerCommodityDetails destination)
        {
