namespace EnergyTrading.MDM.Mappers
{
    ...
    /// </summary>
    public class InstrumentTypeOverrideDetailsMapper : Mapper<EnergyTrading.MDM.InstrumentTypeOverride, OpenNexus.MDM.Contracts.InstrumentTypeOverrideDetails>
    {
        public override void Map(EnergyTrading.MDM.InstrumentTypeOverride source, OpenNexus.MDM.Contracts.InstrumentTypeOverrideDetails destination)
        {
