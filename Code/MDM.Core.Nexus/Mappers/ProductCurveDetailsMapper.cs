...
namespace EnergyTrading.MDM.Mappers
{
    ...
    /// </summary>
    public class ProductCurveDetailsMapper : Mapper<EnergyTrading.MDM.ProductCurve, RWEST.Nexus.MDM.Contracts.ProductCurveDetails>
    {
        public override void Map(EnergyTrading.MDM.ProductCurve source, RWEST.Nexus.MDM.Contracts.ProductCurveDetails destination)
        {
