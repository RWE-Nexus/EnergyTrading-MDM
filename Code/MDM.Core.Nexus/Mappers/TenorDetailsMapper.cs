namespace EnergyTrading.MDM.Mappers
{
    ...
    /// </summary>
    public class TenorDetailsMapper : Mapper<EnergyTrading.MDM.Tenor, OpenNexus.MDM.Contracts.TenorDetails>
    {
        public override void Map(EnergyTrading.MDM.Tenor source, OpenNexus.MDM.Contracts.TenorDetails destination)
        {
