namespace EnergyTrading.MDM.Mappers
{
    ...
    public class SettlementContactMapper : Mapper<EnergyTrading.MDM.SettlementContact, RWEST.Nexus.MDM.Contracts.SettlementContact>
    {
        public override void Map(EnergyTrading.MDM.SettlementContact source, RWEST.Nexus.MDM.Contracts.SettlementContact destination)
        {
