namespace EnergyTrading.MDM.Configuration
{
    ...
    public class PartyRoleAccountabilityConfiguration : NexusEntityConfiguration<Services.PartyRoleAccountabilityService, MDM.PartyRoleAccountability, RWEST.Nexus.MDM.Contracts.PartyRoleAccountability,
