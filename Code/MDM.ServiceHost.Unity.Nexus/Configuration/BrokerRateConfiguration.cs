namespace EnergyTrading.MDM.Configuration
{
    ...
    public class BrokerRateConfiguration : NexusEntityConfiguration<Services.BrokerRateService, MDM.BrokerRate, RWEST.Nexus.MDM.Contracts.BrokerRate, BrokerRateMapping, BrokerRateValidator>
    {
