namespace EnergyTrading.MDM.Configuration
{
    ...
    public class PartyOverrideConfiguration : NexusEntityConfiguration<Services.PartyOverrideService, MDM.PartyOverride, RWEST.Nexus.MDM.Contracts.PartyOverride, 
