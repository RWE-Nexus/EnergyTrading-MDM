namespace EnergyTrading.MDM.Configuration
{
    ...
    public class ProductTypeInstanceConfiguration : NexusEntityConfiguration<Services.ProductTypeInstanceService, MDM.ProductTypeInstance, RWEST.Nexus.MDM.Contracts.ProductTypeInstance, 
