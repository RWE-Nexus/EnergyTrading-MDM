namespace EnergyTrading.MDM.Configuration
{
    ...
    public class PersonConfiguration : NexusEntityConfiguration<Services.PersonService, MDM.Person, RWEST.Nexus.MDM.Contracts.Person, PersonMapping, PersonValidator>
    {
