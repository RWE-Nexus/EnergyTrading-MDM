namespace EnergyTrading.MDM.Test
{
    ...
    [TestClass]
    public class when_a_request_is_made_for_an_individual_mapping_for_a_hierarchy : IntegrationTestBase
    {
        private static HttpResponseMessage response;
        private static MappingResponse mappingResponse;
        private static HttpClient client;
        private static Hierarchy entity;
        private static HierarchyMapping mapping;
        ...
        protected static void Because_of()
        {
            ...
            client = new HttpClient(ServiceUrl["Hierarchy"] + string.Format("{0}/mapping/{1}", entity.Id, mapping.Id));
