	namespace EnergyTrading.MDM.Test
{
    ...
    [TestClass]
    public class when_a_search_for_a_hierarchy_with_two_results_is_paged_at_one_per_page : IntegrationTestBase
    {
        ...
        private static IList<Hierarchy> pageOne;
        private static Uri pageOneNextPage;
        private static IList<Hierarchy> pageTwo;
        ...
        {
            pageOneResponse = client.Post(ServiceUrl["Hierarchy"] + "search", content);
        ...
        protected static void Establish_context()
        {
			...
			HierarchyData.CreateSearch(search, entity1, entity2);
        ...
        private static IList<Hierarchy> GetPeopleFromFeed(SyndicationFeed feed)
        {
