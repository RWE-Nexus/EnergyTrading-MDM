namespace EnergyTrading.MDM.Test
{
    ...
    [TestClass]
    public class when_a_request_is_made_to_update_a_hierarchy_mapping_and_the_mapping_doesnt_exist : IntegrationTestBase
    {
        ...
        private static HierarchyMapping currentTrayportMapping;
        ...
        {
            entity = HierarchyData.CreateBasicEntityWithOneMapping();
        ...
        protected static void Because_of()
        {
            ...
            response = client.Post(ServiceUrl["Hierarchy"] +  string.Format("{0}/Mapping/{1}", entity.Id, int.MaxValue), content);
        }
        ...
        {
            var hierarchyMapping = new DbSetRepository<MDM.HierarchyMapping>(new NexusMappingContext()).FindOne(entity.Mappings[0].Id);
            return hierarchyMapping.Version.ToUnsignedLongVersion();
        }
    }
}
