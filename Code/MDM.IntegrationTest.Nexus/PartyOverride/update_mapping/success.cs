namespace EnergyTrading.MDM.Test
{
    ...
    [TestClass]
    public class when_a_request_is_made_to_update_a_partyoverride_mapping : IntegrationTestBase
    {
        ...
        protected static void Because_of()
        {
            ...
            response = client.Post(ServiceUrl["PartyOverride"] +  string.Format("{0}/Mapping/{1}", entity.Id, currentTrayportMapping.Id), content);
        }

        [TestMethod]
        public void should_update_the_mapping_on_the_partyoverride_entity()
        {
            var savedMapping = new DbSetRepository<MDM.PartyOverride>(new NexusMappingContext()).FindOne(entity.Id).Mappings[0];
