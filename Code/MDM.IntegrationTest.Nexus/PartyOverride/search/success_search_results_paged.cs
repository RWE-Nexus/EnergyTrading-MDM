	namespace EnergyTrading.MDM.Test
{
    ...
    [TestClass]
    public class when_a_search_for_a_partyoverride_with_two_results_is_paged_at_one_per_page : IntegrationTestBase
    {
        ...
        private static IList<PartyOverride> pageOne;
        private static Uri pageOneNextPage;
        private static IList<PartyOverride> pageTwo;
        ...
        {
            pageOneResponse = client.Post(ServiceUrl["PartyOverride"] + "search", content);
        ...
        private static IList<PartyOverride> GetPeopleFromFeed(SyndicationFeed feed)
        {
