namespace EnergyTrading.MDM.Test
{
    ...
    [TestClass]
    public class when_a_request_is_made_to_update_a_bookdefault_entity_and_the_xml_does_not_satisfy_the_schema_ : IntegrationTestBase
    {
        ...
        protected static void Establish_context()
        {
            ...
            var notADefaultPortfolio = new Mapping();
            content = HttpContentExtensions.CreateDataContract(notADefaultPortfolio);
        }
