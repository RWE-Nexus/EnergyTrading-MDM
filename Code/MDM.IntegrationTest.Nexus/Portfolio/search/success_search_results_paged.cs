	namespace EnergyTrading.MDM.Test
{
    ...
    [TestClass]
    public class when_a_search_for_a_portfolio_with_two_results_is_paged_at_one_per_page : IntegrationTestBase
    {
        ...
        private static IList<Portfolio> pageOne;
        private static Uri pageOneNextPage;
        private static IList<Portfolio> pageTwo;
        ...
        {
            pageOneResponse = client.Post(ServiceUrl["Portfolio"] + "search", content);
        ...
        protected static void Establish_context()
        {
			...
			PortfolioData.CreateSearch(search, entity1, entity2);
        ...
        private static IList<Portfolio> GetPeopleFromFeed(SyndicationFeed feed)
        {
