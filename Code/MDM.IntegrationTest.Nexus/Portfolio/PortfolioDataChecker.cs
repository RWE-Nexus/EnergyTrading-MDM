namespace EnergyTrading.MDM.Test
{
    ...
    public static class PortfolioDataChecker
    {
        ...
        {
            var savedEntity =
                new DbSetRepository<MDM.Portfolio>(new NexusMappingContext()).FindOne(id);
        ...
        public static void CompareContractWithSavedEntity(RWEST.Nexus.MDM.Contracts.Portfolio contract)
        {
            ...
            var savedEntity = new DbSetRepository<MDM.Portfolio>(new NexusMappingContext()).FindOne(id);
