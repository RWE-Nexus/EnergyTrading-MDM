namespace EnergyTrading.MDM.Test
{
    ...
    public static class ExchangeDataChecker
    {
        ...
        {
            var savedEntity =
                new DbSetRepository<MDM.Exchange>(new NexusMappingContext()).FindOne(id);
        ...
        public static void CompareContractWithSavedEntity(RWEST.Nexus.MDM.Contracts.Exchange contract)
        {
            ...
            var savedEntity = new DbSetRepository<MDM.Exchange>(new NexusMappingContext()).FindOne(id);
