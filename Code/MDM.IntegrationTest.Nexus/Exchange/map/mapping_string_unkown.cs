namespace EnergyTrading.MDM.Test
{
    ...
    public class when_a_request_is_made_to_retrive_a_exchange_from_a_source_system_and_the_mapping_string_doesnt_exist : IntegrationTestBase
    {
        ...
        {
            RWEST.Nexus.MDM.Contracts.Exchange returnedExchange = null;
            try { returnedExchange = response.Content.ReadAsDataContract<RWEST.Nexus.MDM.Contracts.Exchange>(); } catch { }
        ...
        public void should_return_nexus_failure_with_correct_information()
        {
            ...
            Assert.AreEqual("Exchange Mapping String 'abc' not found for Source System 'Trayport' and the given date '2010-03-16T11:21:23Z'", fault.Message, true);
        }
    }
}