	namespace EnergyTrading.MDM.Test
{
    ...
    [TestClass]
    public class when_a_search_for_a_productcurve_with_two_results_is_paged_at_one_per_page : IntegrationTestBase
    {
        ...
        private static IList<ProductCurve> pageOne;
        private static Uri pageOneNextPage;
        private static IList<ProductCurve> pageTwo;
        ...
        {
            pageOneResponse = client.Post(ServiceUrl["ProductCurve"] + "search", content);
        ...
        protected static void Establish_context()
        {
			...
			ProductCurveData.CreateSearch(search, entity1, entity2);
        ...
        private static IList<ProductCurve> GetPeopleFromFeed(SyndicationFeed feed)
        {
