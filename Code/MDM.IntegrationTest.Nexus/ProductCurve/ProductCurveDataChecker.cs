namespace EnergyTrading.MDM.Test
{
    ...
    public static class ProductCurveDataChecker
    {
        ...
        {
            var savedEntity =
                new DbSetRepository<MDM.ProductCurve>(new NexusMappingContext()).FindOne(id);
        ...
        public static void CompareContractWithSavedEntity(RWEST.Nexus.MDM.Contracts.ProductCurve contract)
        {
            ...
            var savedEntity = new DbSetRepository<MDM.ProductCurve>(new NexusMappingContext()).FindOne(id);
