	namespace EnergyTrading.MDM.Test
{
    ...
    [TestClass]
    public class when_a_search_for_a_product_with_two_results_is_paged_at_one_per_page : IntegrationTestBase
    {
        ...
        private static IList<Product> pageOne;
        private static Uri pageOneNextPage;
        private static IList<Product> pageTwo;
        ...
        {
            pageOneResponse = client.Post(ServiceUrl["Product"] + "search", content);
        ...
        protected static void Establish_context()
        {
			...
			Script.ProductData.CreateSearch(search, entity1, entity2);
        ...
        private static IList<Product> GetPeopleFromFeed(SyndicationFeed feed)
        {
