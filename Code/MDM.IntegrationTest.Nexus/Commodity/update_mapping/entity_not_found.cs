namespace EnergyTrading.MDM.Test
{
    ...
    [TestClass]
    public class when_a_request_is_made_to_update_a_commodity_mapping_and_the_mapping_doesnt_exist : IntegrationTestBase
    {
        ...
        private static CommodityMapping currentTrayportMapping;
        ...
        {
            entity = Script.CommodityData.CreateBasicEntityWithOneMapping();
        ...
        protected static void Because_of()
        {
            ...
            response = client.Post(ServiceUrl["Commodity"] +  string.Format("{0}/Mapping/{1}", entity.Id, int.MaxValue), content);
        }
        ...
        {
            var commodityMapping = new DbSetRepository<MDM.CommodityMapping>(new NexusMappingContext()).FindOne(entity.Mappings[0].Id);
            return commodityMapping.Version.ToUnsignedLongVersion();
        }
    }
}
