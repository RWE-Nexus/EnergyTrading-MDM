namespace EnergyTrading.MDM.Test
{
    ...
    public class when_a_request_is_made_for_a_partyrole_and_they_exist : IntegrationTestBase
    {
        ...
        private static RWEST.Nexus.MDM.Contracts.PartyRole returnedPartyRole;
        ...
        protected static void Because_of()
        {
                ...
                partyrole.Id))
            {
                ...
                {
                    returnedPartyRole = response.Content.ReadAsDataContract<RWEST.Nexus.MDM.Contracts.PartyRole>();
                }
            }
        }
