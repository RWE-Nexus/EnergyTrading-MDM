	namespace EnergyTrading.MDM.Test
{
    ...
    [TestClass]
    public class when_a_search_for_a_settlementcontact_with_two_results_is_paged_at_one_per_page : IntegrationTestBase
    {
        ...
        private static IList<SettlementContact> pageOne;
        private static Uri pageOneNextPage;
        private static IList<SettlementContact> pageTwo;
        ...
        {
            pageOneResponse = client.Post(ServiceUrl["SettlementContact"] + "search", content);
        ...
        protected static void Establish_context()
        {
			...
			SettlementContactData.CreateSearch(search, entity1, entity2);
        ...
        private static IList<SettlementContact> GetPeopleFromFeed(SyndicationFeed feed)
        {
