namespace EnergyTrading.MDM.Test
{
    ...
    [TestClass]
    public class when_a_request_is_made_to_create_a_settlementcontact_mapping : IntegrationTestBase
    {
        ...
        {
            response = client.Post(ServiceUrl["SettlementContact"] + string.Format("{0}/Mapping", entity.Id), content);
        }

        [TestMethod]
        public void should_create_a_mapping_on_the_settlementcontact_entity()
        {
            var savedMapping =
        ...
        public void should_return_the_location_of_the_entity()
        {
            ...
            Assert.IsTrue(parsedEntityId, "The SettlementContact id returned was not an integer");
