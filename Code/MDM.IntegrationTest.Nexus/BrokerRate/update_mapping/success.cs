namespace EnergyTrading.MDM.Test
{
    ...
    [TestClass]
    public class when_a_request_is_made_to_update_a_brokerrate_mapping : IntegrationTestBase
    {
        ...
        {
            client.DefaultHeaders.Add("If-Match", entity.Version.ToString(CultureInfo.InvariantCulture));
