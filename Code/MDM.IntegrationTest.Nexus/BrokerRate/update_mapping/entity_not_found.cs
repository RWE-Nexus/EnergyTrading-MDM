namespace EnergyTrading.MDM.Test
{
    ...
    [TestClass]
    public class when_a_request_is_made_to_update_a_brokerrate_mapping_and_the_mapping_doesnt_exist : IntegrationTestBase
    {
        ...
        private static BrokerRateMapping currentTrayportMapping;
        ...
        {
            entity = BrokerRateData.CreateBasicEntityWithOneMapping();
        ...
        protected static void Because_of()
        {
            ...
            response = client.Post(ServiceUrl["BrokerRate"] +  string.Format("{0}/Mapping/{1}", entity.Id, int.MaxValue), content);
        }
        ...
        {
            var brokerrateMapping = new DbSetRepository<MDM.BrokerRateMapping>(new NexusMappingContext()).FindOne(entity.Mappings[0].Id);
            return brokerrateMapping.Version.ToUnsignedLongVersion();
        }
    }
}
