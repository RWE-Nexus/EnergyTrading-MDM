namespace EnergyTrading.MDM.Test
{
    ...
    [TestClass]
    public class when_a_request_is_made_to_update_a_book_mapping_and_the_xml_does_not_satisfy_the_schema_ : IntegrationTestBase
    {
        ...
        [TestMethod]
        public void should_not_update_the_book_mapping_in_the_database()
        {
        ...
        {
            byte[] b = new DbSetRepository<MDM.BookMapping>(new NexusMappingContext()).FindOne(entity.Mappings[0].Id).Version;
