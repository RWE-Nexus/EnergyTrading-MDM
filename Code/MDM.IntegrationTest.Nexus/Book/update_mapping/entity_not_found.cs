namespace EnergyTrading.MDM.Test
{
    ...
    [TestClass]
    public class when_a_request_is_made_to_update_a_book_mapping_and_the_mapping_doesnt_exist : IntegrationTestBase
    {
        ...
        protected static void Because_of()
        {
            ...
            response = client.Post(ServiceUrl["Book"] +  string.Format("{0}/Mapping/{1}", entity.Id, int.MaxValue), content);
        }
        ...
        {
            var bookMapping = new DbSetRepository<MDM.BookMapping>(new NexusMappingContext()).FindOne(entity.Mappings[0].Id);
            return bookMapping.Version.ToUnsignedLongVersion();
        }
    }
}
