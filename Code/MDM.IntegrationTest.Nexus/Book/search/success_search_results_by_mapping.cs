namespace EnergyTrading.MDM.Test
{
    ...
    [TestClass]
    public class when_a_search_for_a_book_is_made_with_a_mapping_value_and_results_are_found : IntegrationTestBase
    {
        ...
        {
            entity1 = BookData.CreateBasicEntityWithOneMapping();
            entity2 = BookData.CreateBasicEntityWithOneMapping();
    ...
    [TestClass]
    public class when_a_search_for_a_book_is_made_with_a_mapping_value_and_a_system_name_and_results_are_found : IntegrationTestBase
    {
        private static HttpClient client;
