namespace EnergyTrading.MDM.Test
{
    ...
    [TestClass]
    public class when_a_request_is_made_to_update_a_agreement_mapping_and_the_xml_does_not_satisfy_the_schema_ : IntegrationTestBase
    {
        ...
        protected static void Establish_context()
        {
            ...
            var notAMapping = new MDM.Agreement();
        ...
        protected static void Because_of()
        {
            ...
            response = client.Post(ServiceUrl["Agreement"] +  string.Format("{0}/Mapping/{1}", entity.Id, 
                int.MaxValue), content);
        }

        [TestMethod]
        public void should_not_update_the_agreement_mapping_in_the_database()
        {
        ...
        {
            byte[] b = new DbSetRepository<MDM.AgreementMapping>(new NexusMappingContext()).FindOne(entity.Mappings[0].Id).Version;
