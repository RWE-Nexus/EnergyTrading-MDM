namespace EnergyTrading.MDM.Test
{
    ...
    [TestClass]
    public class when_a_request_is_made_to_update_a_agreement_mapping : IntegrationTestBase
    {
        ...
        [TestMethod]
        public void should_update_the_mapping_on_the_agreement_entity()
        {
            var savedMapping = new DbSetRepository<MDM.Agreement>(new NexusMappingContext()).FindOne(entity.Id).Mappings[0];
