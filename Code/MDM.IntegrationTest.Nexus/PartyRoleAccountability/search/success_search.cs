namespace EnergyTrading.MDM.Test
{
    ...
    [TestClass]
    public class when_a_search_for_a_partyRoleaccountability_is_made_with_a_specific_name : IntegrationTestBase
    {
        ...
        {
            var entity1 = PartyRoleAccountabilityData.CreateBasicEntity();
            var entity2 = PartyRoleAccountabilityData.CreateBasicEntity();
