namespace EnergyTrading.MDM.Test
{
    ...
    [TestClass]
    public class when_a_request_is_made_to_update_a_partyRoleaccountability_mapping_and_the_mapping_doesnt_exist : IntegrationTestBase
    {
        ...
        private static PartyRoleAccountabilityMapping currentTrayportMapping;
        ...
        protected static void Because_of()
        {
            ...
            response = client.Post(ServiceUrl["PartyRoleAccountability"] + string.Format("{0}/Mapping/{1}", entity.Id, int.MaxValue), content);
        }
        ...
        {
            var partyaccountabilityMapping = new DbSetRepository<MDM.PartyRoleAccountabilityMapping>(new MappingContext()).FindOne(entity.Mappings[0].Id);
            return BitConverter.ToInt64(partyaccountabilityMapping.Version, 0);
        }
    }
}
