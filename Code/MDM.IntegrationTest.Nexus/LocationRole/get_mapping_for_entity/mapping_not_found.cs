namespace EnergyTrading.MDM.Test
{
    ...
    [TestClass]
    public class when_a_request_is_made_for_an_individual_mapping_for_a_locationrole_and_the_mapping_doesnt_exist : IntegrationTestBase
    {
        ...
        {
            var entity = Script.LocationRoleData.CreateBasicEntityWithOneMapping();

            client = new HttpClient(ServiceUrl["LocationRole"] + string.Format("{0}/mapping/{1}", entity.Id, int.MaxValue));
