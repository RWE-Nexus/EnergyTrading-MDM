namespace EnergyTrading.MDM.Test
{
    ...
    public class LocationRoleDataChecker
    {
        ...
        {
            var savedEntity =
                new DbSetRepository<MDM.LocationRole>(new NexusMappingContext()).FindOne(id);
        ...
        public void CompareContractWithSavedEntity(RWEST.Nexus.MDM.Contracts.LocationRole contract)
        {
            ...
            var savedEntity = new DbSetRepository<MDM.LocationRole>(new NexusMappingContext()).FindOne(id);
