namespace EnergyTrading.MDM.Test
{
    ...
    public class when_a_request_is_made_to_update_a_locationrole_mapping_and_the_mapping_doesnt_exist : IntegrationTestBase
    {
        ...
        {
            var locationroleMapping = new DbSetRepository<MDM.LocationRoleMapping>(new MappingContext()).FindOne(entity.Mappings[0].Id);
            return BitConverter.ToInt64(locationroleMapping.Version, 0);
        }
    }
}
