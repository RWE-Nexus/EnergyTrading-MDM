namespace EnergyTrading.MDM.Test
{
    ...
    [TestClass]
    public class when_a_request_is_made_to_update_a_locationrole_mapping_and_the_mapping_doesnt_exist : IntegrationTestBase
    {
        ...
        private static LocationRoleMapping currentTrayportMapping;
        ...
        {
            entity = Script.LocationRoleData.CreateBasicEntityWithOneMapping();
        ...
        protected static void Because_of()
        {
            ...
            response = client.Post(ServiceUrl["LocationRole"] +  string.Format("{0}/Mapping/{1}", entity.Id, int.MaxValue), content);
        }
        ...
        {
            var locationroleMapping = new DbSetRepository<MDM.LocationRoleMapping>(new NexusMappingContext()).FindOne(entity.Mappings[0].Id);
            return locationroleMapping.Version.ToUnsignedLongVersion();
        }
    }
}
