namespace EnergyTrading.MDM.Test
{
    ...
    [TestClass]
    public class when_a_request_is_made_to_update_a_instrumenttype_mapping_and_the_mapping_doesnt_exist : IntegrationTestBase
    {
        ...
        private static InstrumentTypeMapping currentTrayportMapping;
        ...
        {
            entity = Script.InstrumentTypeData.CreateBasicEntityWithOneMapping();
        ...
        protected static void Because_of()
        {
            ...
            response = client.Post(ServiceUrl["InstrumentType"] +  string.Format("{0}/Mapping/{1}", entity.Id, int.MaxValue), content);
        }
        ...
        {
            var instrumenttypeMapping = new DbSetRepository<MDM.InstrumentTypeMapping>(new NexusMappingContext()).FindOne(entity.Mappings[0].Id);
            return instrumenttypeMapping.Version.ToUnsignedLongVersion();
        }
    }
}
