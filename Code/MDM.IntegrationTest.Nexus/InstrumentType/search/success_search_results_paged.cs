	namespace EnergyTrading.MDM.Test
{
    ...
    [TestClass]
    public class when_a_search_for_a_instrumenttype_with_two_results_is_paged_at_one_per_page : IntegrationTestBase
    {
        ...
        private static IList<InstrumentType> pageOne;
        private static Uri pageOneNextPage;
        private static IList<InstrumentType> pageTwo;
        ...
        {
            pageOneResponse = client.Post(ServiceUrl["InstrumentType"] + "search", content);
        ...
        protected static void Establish_context()
        {
			...
			Script.InstrumentTypeData.CreateSearch(search, entity1, entity2);
        ...
        private static IList<InstrumentType> GetPeopleFromFeed(SyndicationFeed feed)
        {
            List<RWEST.Nexus.MDM.Contracts.InstrumentType> result =
                feed.Items.Select(syndicationItem => (XmlSyndicationContent)syndicationItem.Content).Select(
                    syndic => syndic.ReadContent<RWEST.Nexus.MDM.Contracts.InstrumentType>()).ToList();
