namespace EnergyTrading.MDM.Test
{
    ...
    [TestClass]
    public class when_a_request_is_made_to_update_a_shape_mapping_and_the_mapping_doesnt_exist : IntegrationTestBase
    {
        ...
        private static ShapeMapping currentTrayportMapping;
        ...
        {
            entity = ShapeData.CreateBasicEntityWithOneMapping();
        ...
        protected static void Because_of()
        {
            ...
            response = client.Post(ServiceUrl["Shape"] +  string.Format("{0}/Mapping/{1}", entity.Id, int.MaxValue), content);
        }
        ...
        {
            var shapeMapping = new DbSetRepository<MDM.ShapeMapping>(new NexusMappingContext()).FindOne(entity.Mappings[0].Id);
            return shapeMapping.Version.ToUnsignedLongVersion();
        }
    }
}
