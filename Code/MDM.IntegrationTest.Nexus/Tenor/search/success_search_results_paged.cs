	namespace EnergyTrading.MDM.Test
{
    ...
    [TestClass]
    public class when_a_search_for_a_tenor_with_two_results_is_paged_at_one_per_page : IntegrationTestBase
    {
        ...
        private static IList<Tenor> pageOne;
        private static Uri pageOneNextPage;
        private static IList<Tenor> pageTwo;
        ...
        {
            pageOneResponse = client.Post(ServiceUrl["Tenor"] + "search", content);
        ...
        protected static void Establish_context()
        {
			...
			TenorData.CreateSearch(search, entity1, entity2);
        ...
        private static IList<Tenor> GetPeopleFromFeed(SyndicationFeed feed)
        {
