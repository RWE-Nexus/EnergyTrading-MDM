namespace EnergyTrading.MDM.Test
{
    ...
    [TestClass]
    public class when_a_request_is_made_to_create_a_businessunit_mapping : IntegrationTestBase
    {
        ...
        {
            response = client.Post(ServiceUrl["BusinessUnit"] + string.Format("{0}/Mapping", entity.Id), content);
        }

        [TestMethod]
        public void should_create_a_mapping_on_the_businessunit_entity()
        {
            var savedMapping =
        ...
        public void should_return_the_location_of_the_entity()
        {
            ...
            Assert.IsTrue(parsedEntityId, "The BusinessUnit id returned was not an integer");
