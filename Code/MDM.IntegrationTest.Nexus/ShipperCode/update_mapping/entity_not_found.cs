namespace EnergyTrading.MDM.Test
{
    ...
    [TestClass]
    public class when_a_request_is_made_to_update_a_shippercode_mapping_and_the_mapping_doesnt_exist : IntegrationTestBase
    {
        ...
        private static ShipperCodeMapping currentTrayportMapping;
        ...
        {
            entity = Script.ShipperCodeData.CreateBasicEntityWithOneMapping();
        ...
        protected static void Because_of()
        {
            ...
            response = client.Post(ServiceUrl["ShipperCode"] +  string.Format("{0}/Mapping/{1}", entity.Id, int.MaxValue), content);
        }
        ...
        {
            var shippercodeMapping = new DbSetRepository<MDM.ShipperCodeMapping>(new NexusMappingContext()).FindOne(entity.Mappings[0].Id);
            return shippercodeMapping.Version.ToUnsignedLongVersion();
        }
    }
}
