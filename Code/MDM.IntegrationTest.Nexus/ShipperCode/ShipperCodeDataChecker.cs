namespace EnergyTrading.MDM.Test
{
    ...
    public class ShipperCodeDataChecker
    {
        ...
        {
            var savedEntity =
                new DbSetRepository<MDM.ShipperCode>(new NexusMappingContext()).FindOne(id);
        ...
        public void CompareContractWithSavedEntity(RWEST.Nexus.MDM.Contracts.ShipperCode contract)
        {
            ...
            var savedEntity = new DbSetRepository<MDM.ShipperCode>(new NexusMappingContext()).FindOne(id);
