namespace EnergyTrading.MDM.Test
{
    ...
    [TestClass]
    public class when_a_search_for_a_partyaccountability_is_made_with_a_mapping_value_and_results_are_found : IntegrationTestBase
    {
        ...
        {
            response = client.Post(ServiceUrl["PartyAccountability"] + "search", content);
        }

        protected static void Establish_context()
        {
            entity1 = PartyAccountabilityData.CreateBasicEntityWithOneMapping();
            entity2 = PartyAccountabilityData.CreateBasicEntityWithOneMapping();
    ...
    [TestClass]
    public class when_a_search_for_a_partyaccountability_is_made_with_a_mapping_value_and_a_system_name_and_results_are_found : IntegrationTestBase
    {
        private static HttpClient client;
