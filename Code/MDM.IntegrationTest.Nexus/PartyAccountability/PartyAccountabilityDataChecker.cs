namespace EnergyTrading.MDM.Test
{
    ...
    public static class PartyAccountabilityDataChecker
    {
        ...
        {
            var savedEntity =
                new DbSetRepository<MDM.PartyAccountability>(new NexusMappingContext()).FindOne(id);
        ...
        public static void CompareContractWithSavedEntity(RWEST.Nexus.MDM.Contracts.PartyAccountability contract)
        {
            ...
            var savedEntity = new DbSetRepository<MDM.PartyAccountability>(new NexusMappingContext()).FindOne(id);
