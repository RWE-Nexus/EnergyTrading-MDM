namespace EnergyTrading.MDM.Test
{
    ...
    [TestClass]
    public class when_a_request_is_made_to_retrive_a_partyaccountability_from_a_source_system_and_the_mapping_string_doesnt_exist : IntegrationTestBase
    {
        ...
        [TestMethod]
        public void should_not_return_a_partyaccountability()
        {
            RWEST.Nexus.MDM.Contracts.PartyAccountability returnedPartyAccountability = null;
            try { returnedPartyAccountability = response.Content.ReadAsDataContract<RWEST.Nexus.MDM.Contracts.PartyAccountability>(); } catch { }
