	namespace EnergyTrading.MDM.Test
{
    ...
    [TestClass]
    public class when_a_search_for_a_unit_with_two_results_is_paged_at_one_per_page : IntegrationTestBase
    {
        ...
        private static IList<Unit> pageOne;
        private static Uri pageOneNextPage;
        private static IList<Unit> pageTwo;
        ...
        {
            pageOneResponse = client.Post(ServiceUrl["Unit"] + "search", content);
        ...
        private static IList<Unit> GetPeopleFromFeed(SyndicationFeed feed)
        {
