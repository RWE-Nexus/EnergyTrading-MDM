namespace EnergyTrading.MDM.Test
{
    ...
    [TestClass]
    public class when_a_request_is_made_to_update_a_shapeelement_mapping_and_the_etag_is_not_current : IntegrationTestBase
    {
        ...
        {
            return new DbSetRepository<MDM.ShapeElement>(new NexusMappingContext()).FindOne(entity.Id).Version;
        }
    }
}
