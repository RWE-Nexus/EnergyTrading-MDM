namespace EnergyTrading.MDM.Test
{
    ...
    [TestClass]
    public class when_a_request_is_made_to_update_a_shapeelement_mapping_and_the_mapping_doesnt_exist : IntegrationTestBase
    {
        ...
        private static ShapeElementMapping currentTrayportMapping;
        ...
        {
            entity = ShapeElementData.CreateBasicEntityWithOneMapping();
        ...
        protected static void Because_of()
        {
            ...
            response = client.Post(ServiceUrl["ShapeElement"] +  string.Format("{0}/Mapping/{1}", entity.Id, int.MaxValue), content);
        }
        ...
        {
            var shapeelementMapping = new DbSetRepository<MDM.ShapeElementMapping>(new NexusMappingContext()).FindOne(entity.Mappings[0].Id);
            return shapeelementMapping.Version.ToUnsignedLongVersion();
        }
    }
}
