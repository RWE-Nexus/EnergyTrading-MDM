namespace EnergyTrading.MDM.Test
{
    ...
    public static class ShapeElementDataChecker
    {
        ...
        {
            var savedEntity =
                new DbSetRepository<MDM.ShapeElement>(new NexusMappingContext()).FindOne(id);
        ...
        public static void CompareContractWithSavedEntity(RWEST.Nexus.MDM.Contracts.ShapeElement contract)
        {
            ...
            var savedEntity = new DbSetRepository<MDM.ShapeElement>(new NexusMappingContext()).FindOne(id);
