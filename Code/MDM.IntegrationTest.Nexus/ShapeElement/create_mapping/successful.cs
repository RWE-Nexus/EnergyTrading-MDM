namespace EnergyTrading.MDM.Test
{
    ...
    [TestClass]
    public class when_a_request_is_made_to_create_a_shapeelement_mapping : IntegrationTestBase
    {
        ...
        [TestMethod]
        public void should_create_a_mapping_on_the_shapeelement_entity()
        {
            var savedMapping =
                new DbSetRepository<MDM.ShapeElementMapping>(new NexusMappingContext()).FindOne(int.Parse(GetLocationHeader()[3]));
        ...
        public void should_return_the_location_of_the_entity()
        {
            ...
            Assert.IsTrue(parsedEntityId, "The ShapeElement id returned was not an integer");
