namespace EnergyTrading.MDM.Test
{
    ...
    public static class ProductTenorTypeDataChecker
    {
        ...
        {
            var savedEntity =
                new DbSetRepository<MDM.ProductTenorType>(new MappingContext()).FindOne(id);
        ...
        public static void CompareContractWithSavedEntity(RWEST.Nexus.MDM.Contracts.ProductTenorType contract)
        {
            ...
            var savedEntity = new DbSetRepository<MDM.ProductTenorType>(new MappingContext()).FindOne(id);
