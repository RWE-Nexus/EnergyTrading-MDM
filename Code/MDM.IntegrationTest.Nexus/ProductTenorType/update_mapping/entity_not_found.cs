namespace EnergyTrading.MDM.Test
{
    ...
    [TestClass]
    public class when_a_request_is_made_to_update_a_producttenortype_mapping_and_the_mapping_doesnt_exist : IntegrationTestBase
    {
        ...
        private static ProductTenorTypeMapping currentTrayportMapping;
        ...
        protected static void Because_of()
        {
            ...
            response = client.Post(ServiceUrl["ProductTenorType"] +  string.Format("{0}/Mapping/{1}", entity.Id, int.MaxValue), content);
        }
        ...
        {
            var producttenortypeMapping = new DbSetRepository<ProductTenorTypeMapping>(new NexusMappingContext()).FindOne(entity.Mappings[0].Id);
