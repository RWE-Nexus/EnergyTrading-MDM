	namespace EnergyTrading.MDM.Test
{
    ...
    [TestClass]
    public class when_a_search_for_a_producttenortype_with_two_results_is_paged_at_one_per_page : IntegrationTestBase
    {
        ...
        private static IList<ProductTenorType> pageOne;
        private static Uri pageOneNextPage;
        private static IList<ProductTenorType> pageTwo;
        ...
        {
            pageOneResponse = client.Post(ServiceUrl["ProductTenorType"] + "search", content);
        ...
        protected static void Establish_context()
        {
			...
			ProductTenorTypeData.CreateSearch(search, entity1, entity2);
        ...
        private static IList<ProductTenorType> GetPeopleFromFeed(SyndicationFeed feed)
        {
