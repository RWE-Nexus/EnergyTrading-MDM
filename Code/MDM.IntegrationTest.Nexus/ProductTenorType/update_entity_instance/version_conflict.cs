namespace EnergyTrading.MDM.Test
{
    ...
    [TestClass]
    public class when_a_request_is_made_to_update_a_producttenortype_entity_and_the_etag_is_not_current : IntegrationTestBase
    {
        ...
        protected static void Establish_context()
        {
            ...
            content = HttpContentExtensions.CreateDataContract(new RWEST.Nexus.MDM.Contracts.ProductTenorType());
