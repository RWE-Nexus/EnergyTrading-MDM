namespace EnergyTrading.MDM.Test
{
    ...
    [TestClass]
    public class when_a_request_is_made_to_update_a_commodityfeetype_mapping_and_the_mapping_doesnt_exist : IntegrationTestBase
    {
        ...
        private static CommodityFeeTypeMapping currentTrayportMapping;
        ...
        {
            entity = CommodityFeeTypeData.CreateBasicEntityWithOneMapping();
        ...
        protected static void Because_of()
        {
            ...
            response = client.Post(ServiceUrl["CommodityFeeType"] +  string.Format("{0}/Mapping/{1}", entity.Id, int.MaxValue), content);
        }
        ...
        {
            var commodityfeetypeMapping = new DbSetRepository<MDM.CommodityFeeTypeMapping>(new NexusMappingContext()).FindOne(entity.Mappings[0].Id);
            return commodityfeetypeMapping.Version.ToUnsignedLongVersion();
        }
    }
}
