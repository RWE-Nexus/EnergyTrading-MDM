	namespace EnergyTrading.MDM.Test
{
    ...
    [TestClass]
    public class when_a_search_for_a_commodityfeetype_with_two_results_is_paged_at_one_per_page : IntegrationTestBase
    {
        ...
        private static IList<CommodityFeeType> pageOne;
        private static Uri pageOneNextPage;
        private static IList<CommodityFeeType> pageTwo;
        ...
        {
            pageOneResponse = client.Post(ServiceUrl["CommodityFeeType"] + "search", content);
        ...
        protected static void Establish_context()
        {
			...
			CommodityFeeTypeData.CreateSearch(search, entity1, entity2);
        ...
        private static IList<CommodityFeeType> GetPeopleFromFeed(SyndicationFeed feed)
        {
