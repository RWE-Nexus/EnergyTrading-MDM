namespace EnergyTrading.MDM.Test
{
    ...
    public static class CommodityFeeTypeDataChecker
    {
        ...
        {
            var savedEntity =
                new DbSetRepository<MDM.CommodityFeeType>(new NexusMappingContext()).FindOne(id);
        ...
        public static void CompareContractWithSavedEntity(RWEST.Nexus.MDM.Contracts.CommodityFeeType contract)
        {
            ...
            var savedEntity = new DbSetRepository<MDM.CommodityFeeType>(new NexusMappingContext()).FindOne(id);
