namespace EnergyTrading.MDM.Test
{
    ...
    [TestClass]
    public class when_a_search_for_a_vessel_is_made_with_a_mapping_value_and_results_are_found : IntegrationTestBase
    {
        ...
        {
            response = client.Post(ServiceUrl["Vessel"] + "search", content);
        }

        protected static void Establish_context()
        {
            entity1 = VesselData.CreateBasicEntityWithOneMapping();
            entity2 = VesselData.CreateBasicEntityWithOneMapping();
    ...
    [TestClass]
    public class when_a_search_for_a_vessel_is_made_with_a_mapping_value_and_a_system_name_and_results_are_found : IntegrationTestBase
    {
        private static HttpClient client;
