namespace EnergyTrading.MDM.Test
{
    ...
    [TestClass]
    public class when_a_request_is_made_to_update_a_vessel_mapping_and_the_mapping_doesnt_exist : IntegrationTestBase
    {
        ...
        private static VesselMapping currentTrayportMapping;
        ...
        {
            entity = VesselData.CreateBasicEntityWithOneMapping();
        ...
        protected static void Because_of()
        {
            ...
            response = client.Post(ServiceUrl["Vessel"] +  string.Format("{0}/Mapping/{1}", entity.Id, int.MaxValue), content);
        }
        ...
        {
            var vesselMapping = new DbSetRepository<MDM.VesselMapping>(new NexusMappingContext()).FindOne(entity.Mappings[0].Id);
            return vesselMapping.Version.ToUnsignedLongVersion();
        }
    }
}
