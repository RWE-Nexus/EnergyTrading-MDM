namespace EnergyTrading.MDM.Test
{
    ...
    public class when_a_request_is_made_to_update_a_vessel_mapping_and_the_mapping_doesnt_exist : IntegrationTestBase
    {
        ...
        {
            var vesselMapping = new DbSetRepository<MDM.VesselMapping>(new MappingContext()).FindOne(entity.Mappings[0].Id);
            return BitConverter.ToInt64(vesselMapping.Version, 0);
        }
    }
}
