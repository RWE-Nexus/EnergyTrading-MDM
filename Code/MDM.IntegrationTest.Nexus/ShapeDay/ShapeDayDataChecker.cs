namespace EnergyTrading.MDM.Test
{
    ...
    public static class ShapeDayDataChecker
    {
        ...
        {
            var savedEntity =
                new DbSetRepository<MDM.ShapeDay>(new NexusMappingContext()).FindOne(id);
        ...
        public static void CompareContractWithSavedEntity(RWEST.Nexus.MDM.Contracts.ShapeDay contract)
        {
            ...
            var savedEntity = new DbSetRepository<MDM.ShapeDay>(new NexusMappingContext()).FindOne(id);
