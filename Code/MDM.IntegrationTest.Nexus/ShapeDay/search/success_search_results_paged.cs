	namespace EnergyTrading.MDM.Test
{
    ...
    [TestClass]
    public class when_a_search_for_a_shapeday_with_two_results_is_paged_at_one_per_page : IntegrationTestBase
    {
        ...
        private static IList<ShapeDay> pageOne;
        private static Uri pageOneNextPage;
        private static IList<ShapeDay> pageTwo;
        ...
        {
            pageOneResponse = client.Post(ServiceUrl["ShapeDay"] + "search", content);
        ...
        protected static void Establish_context()
        {
			...
			ShapeDayData.CreateSearch(search, entity1, entity2);
        ...
        private static IList<ShapeDay> GetPeopleFromFeed(SyndicationFeed feed)
        {
