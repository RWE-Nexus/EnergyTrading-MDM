namespace EnergyTrading.MDM.Test
{
    ...
    [TestClass]
    public class when_a_request_is_made_to_update_a_shapeday_mapping_and_the_mapping_doesnt_exist : IntegrationTestBase
    {
        ...
        private static ShapeDayMapping currentTrayportMapping;
        ...
        {
            entity = ShapeDayData.CreateBasicEntityWithOneMapping();
        ...
        protected static void Because_of()
        {
            ...
            response = client.Post(ServiceUrl["ShapeDay"] +  string.Format("{0}/Mapping/{1}", entity.Id, int.MaxValue), content);
        }
        ...
        {
            var shapedayMapping = new DbSetRepository<MDM.ShapeDayMapping>(new NexusMappingContext()).FindOne(entity.Mappings[0].Id);
            return shapedayMapping.Version.ToUnsignedLongVersion();
        }
    }
}
