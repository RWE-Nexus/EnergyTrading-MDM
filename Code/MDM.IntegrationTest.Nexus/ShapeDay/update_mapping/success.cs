namespace EnergyTrading.MDM.Test
{
    ...
    [TestClass]
    public class when_a_request_is_made_to_update_a_shapeday_mapping : IntegrationTestBase
    {
        ...
        protected static void Because_of()
        {
            ...
            response = client.Post(ServiceUrl["ShapeDay"] +  string.Format("{0}/Mapping/{1}", entity.Id, currentTrayportMapping.Id), content);
        }

        [TestMethod]
        public void should_update_the_mapping_on_the_shapeday_entity()
        {
            var savedMapping = new DbSetRepository<MDM.ShapeDay>(new NexusMappingContext()).FindOne(entity.Id).Mappings[0];
