namespace EnergyTrading.MDM.Test
{
    ...
    [TestClass]
    public class when_a_request_is_made_to_update_a_portfoliohierarchy_mapping_and_the_mapping_doesnt_exist : IntegrationTestBase
    {
        ...
        private static PortfolioHierarchyMapping currentTrayportMapping;
        ...
        {
            entity = PortfolioHierarchyData.CreateBasicEntityWithOneMapping();
        ...
        protected static void Because_of()
        {
            ...
            response = client.Post(ServiceUrl["PortfolioHierarchy"] +  string.Format("{0}/Mapping/{1}", entity.Id, int.MaxValue), content);
        }
        ...
        {
            var portfoliohierarchyMapping = new DbSetRepository<MDM.PortfolioHierarchyMapping>(new NexusMappingContext()).FindOne(entity.Mappings[0].Id);
            return portfoliohierarchyMapping.Version.ToUnsignedLongVersion();
        }
    }
}
