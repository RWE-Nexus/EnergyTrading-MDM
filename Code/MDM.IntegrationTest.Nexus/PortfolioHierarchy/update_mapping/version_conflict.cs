namespace EnergyTrading.MDM.Test
{
    ...
    [TestClass]
    public class when_a_request_is_made_to_update_a_portfoliohierarchy_mapping_and_the_etag_is_not_current : IntegrationTestBase
    {
        ...
        {
            return new DbSetRepository<MDM.PortfolioHierarchy>(new MappingContext()).FindOne(entity.Id).Version;
        }
    }
}
