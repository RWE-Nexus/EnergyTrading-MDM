	namespace EnergyTrading.MDM.Test
{
    ...
    [TestClass]
    public class when_a_search_for_a_portfoliohierarchy_with_two_results_is_paged_at_one_per_page : IntegrationTestBase
    {
        ...
        private static IList<PortfolioHierarchy> pageOne;
        private static Uri pageOneNextPage;
        private static IList<PortfolioHierarchy> pageTwo;
        ...
        {
            pageOneResponse = client.Post(ServiceUrl["PortfolioHierarchy"] + "search", content);
        ...
        protected static void Establish_context()
        {
			...
			PortfolioHierarchyData.CreateSearch(search, entity1, entity2);
        ...
        private static IList<PortfolioHierarchy> GetPeopleFromFeed(SyndicationFeed feed)
        {
