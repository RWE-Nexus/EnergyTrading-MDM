namespace EnergyTrading.MDM.Test
{
    ...
    public static class CommodityInstrumentTypeDataChecker
    {
        ...
        {
            var savedEntity =
                new DbSetRepository<MDM.CommodityInstrumentType>(new MappingContext()).FindOne(id);
        ...
        public static void CompareContractWithSavedEntity(RWEST.Nexus.MDM.Contracts.CommodityInstrumentType contract)
        {
            ...
            var savedEntity = new DbSetRepository<MDM.CommodityInstrumentType>(new MappingContext()).FindOne(id);
