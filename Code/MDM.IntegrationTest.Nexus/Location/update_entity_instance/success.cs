namespace EnergyTrading.MDM.Test
{
    ...
    public class when_a_request_is_made_to_update_a_location_entity : IntegrationTestBase
    {
        ...
        private static RWEST.Nexus.MDM.Contracts.Location locationDataContract;
        private static HttpClient client;
        private static MDM.Location entity;

        private static RWEST.Nexus.MDM.Contracts.Location updatedContract;
        ...
        protected static void Establish_context()
        {
            ...
            updatedContract = getResponse.Content.ReadAsDataContract<RWEST.Nexus.MDM.Contracts.Location>();
