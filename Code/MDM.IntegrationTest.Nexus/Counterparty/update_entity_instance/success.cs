namespace EnergyTrading.MDM.Test
{
    ...
    public class when_a_request_is_made_to_update_a_counterparty_entity : IntegrationTestBase
    {
        ...
        private static RWEST.Nexus.MDM.Contracts.Counterparty counterpartyDataContract;
        private static HttpClient client;
        private static MDM.Counterparty entity;

        private static RWEST.Nexus.MDM.Contracts.Counterparty updatedContract;
        ...
        protected static void Establish_context()
        {
            ...
            updatedContract = getResponse.Content.ReadAsDataContract<RWEST.Nexus.MDM.Contracts.Counterparty>();
