namespace EnergyTrading.MDM.Test
{
    ...
    public class when_a_request_is_made_to_update_a_counterparty_mapping_and_the_mapping_doesnt_exist : IntegrationTestBase
    {
        ...
        {
            var counterpartyMapping = new DbSetRepository<MDM.PartyRoleMapping>(new MappingContext()).FindOne(entity.Mappings[0].Id);
            return BitConverter.ToInt64(counterpartyMapping.Version, 0);
        }
    }
}
