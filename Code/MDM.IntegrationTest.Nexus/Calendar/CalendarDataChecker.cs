namespace EnergyTrading.MDM.Test
{
    ...
    public class CalendarDataChecker
    {
        ...
        {
            var savedEntity =
                new DbSetRepository<MDM.Calendar>(new NexusMappingContext()).FindOne(id);
        ...
        public void CompareContractWithSavedEntity(RWEST.Nexus.MDM.Contracts.Calendar contract)
        {
            ...
            var savedEntity = new DbSetRepository<MDM.Calendar>(new NexusMappingContext()).FindOne(id);
