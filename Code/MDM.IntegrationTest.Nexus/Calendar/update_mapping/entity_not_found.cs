namespace EnergyTrading.MDM.Test
{
    ...
    [TestClass]
    public class when_a_request_is_made_to_update_a_calendar_mapping_and_the_mapping_doesnt_exist : IntegrationTestBase
    {
        ...
        private static CalendarMapping currentTrayportMapping;
        ...
        protected static void Because_of()
        {
            ...
            response = client.Post(ServiceUrl["Calendar"] +  string.Format("{0}/Mapping/{1}", entity.Id, int.MaxValue), content);
        }
        ...
        {
            var calendarMapping = new DbSetRepository<MDM.CalendarMapping>(new NexusMappingContext()).FindOne(entity.Mappings[0].Id);
            return calendarMapping.Version.ToUnsignedLongVersion();
        }
    }
}
