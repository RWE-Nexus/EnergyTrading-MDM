namespace EnergyTrading.MDM.Test
{
    ...
    [TestClass]
    public class when_a_request_is_made_to_update_a_productscota_mapping_and_the_mapping_doesnt_exist : IntegrationTestBase
    {
        ...
        private static ProductScotaMapping currentTrayportMapping;
        ...
        {
            entity = ProductScotaData.CreateBasicEntityWithOneMapping();
        ...
        protected static void Because_of()
        {
            ...
            response = client.Post(ServiceUrl["ProductScota"] +  string.Format("{0}/Mapping/{1}", entity.Id, int.MaxValue), content);
        }
        ...
        {
            var productscotaMapping = new DbSetRepository<MDM.ProductScotaMapping>(new NexusMappingContext()).FindOne(entity.Mappings[0].Id);
            return productscotaMapping.Version.ToUnsignedLongVersion();
        }
    }
}
