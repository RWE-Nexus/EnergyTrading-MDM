namespace EnergyTrading.MDM.Test
{
    ...
    public static class ProductScotaDataChecker
    {
        ...
        {
            var savedEntity =
                new DbSetRepository<MDM.ProductScota>(new NexusMappingContext()).FindOne(id);
        ...
        public static void CompareContractWithSavedEntity(RWEST.Nexus.MDM.Contracts.ProductScota contract)
        {
            ...
            var savedEntity = new DbSetRepository<MDM.ProductScota>(new NexusMappingContext()).FindOne(id);
