	namespace EnergyTrading.MDM.Test
{
    ...
    [TestClass]
    public class when_a_search_for_a_dimension_with_two_results_is_paged_at_one_per_page : IntegrationTestBase
    {
        ...
        private static IList<Dimension> pageOne;
        private static Uri pageOneNextPage;
        private static IList<Dimension> pageTwo;
        ...
        {
            pageOneResponse = client.Post(ServiceUrl["Dimension"] + "search", content);
        ...
        protected static void Establish_context()
        {
			...
			DimensionData.CreateSearch(search, entity1, entity2);
        ...
        private static IList<Dimension> GetPeopleFromFeed(SyndicationFeed feed)
        {
