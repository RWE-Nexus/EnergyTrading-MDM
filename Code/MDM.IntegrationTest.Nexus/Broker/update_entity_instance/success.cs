namespace EnergyTrading.MDM.Test
{
    ...
    public class when_a_request_is_made_to_update_a_broker_entity : IntegrationTestBase
    {
        ...
        private static RWEST.Nexus.MDM.Contracts.Broker brokerDataContract;
        private static HttpClient client;
        private static MDM.Broker entity;

        private static RWEST.Nexus.MDM.Contracts.Broker updatedContract;
        ...
        protected static void Establish_context()
        {
            ...
            updatedContract = getResponse.Content.ReadAsDataContract<RWEST.Nexus.MDM.Contracts.Broker>();
