namespace EnergyTrading.MDM.Test
{
    ...
    [TestClass]
    public class when_a_request_is_made_to_create_a_tenortype_mapping : IntegrationTestBase
    {
        ...
        [TestMethod]
        public void should_create_a_mapping_on_the_tenortype_entity()
        {
            var savedMapping =
                new DbSetRepository<MDM.TenorTypeMapping>(new NexusMappingContext()).FindOne(int.Parse(GetLocationHeader()[3]));
        ...
        public void should_return_the_location_of_the_entity()
        {
            ...
            Assert.IsTrue(parsedEntityId, "The TenorType id returned was not an integer");
