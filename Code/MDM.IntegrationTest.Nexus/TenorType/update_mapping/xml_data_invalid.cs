namespace EnergyTrading.MDM.Test
{
    ...
    [TestClass]
    public class when_a_request_is_made_to_update_a_tenortype_mapping_and_the_xml_does_not_satisfy_the_schema_ : IntegrationTestBase
    {
        ...
        protected static void Establish_context()
        {
            ...
            var notAMapping = new MDM.TenorType();
        ...
        [TestMethod]
        public void should_not_update_the_tenortype_mapping_in_the_database()
        {
        ...
        {
            byte[] b = new DbSetRepository<MDM.TenorTypeMapping>(new NexusMappingContext()).FindOne(entity.Mappings[0].Id).Version;
