namespace EnergyTrading.MDM.Test
{
    ...
    [TestClass]
    public class when_a_request_is_made_to_update_a_market_mapping_and_the_mapping_doesnt_exist : IntegrationTestBase
    {
        ...
        private static MarketMapping currentTrayportMapping;
        ...
        {
            entity = Script.MarketData.CreateBasicEntityWithOneMapping();
        ...
        protected static void Because_of()
        {
            ...
            response = client.Post(ServiceUrl["Market"] +  string.Format("{0}/Mapping/{1}", entity.Id, int.MaxValue), content);
        }
        ...
        {
            var marketMapping = new DbSetRepository<MDM.MarketMapping>(new NexusMappingContext()).FindOne(entity.Mappings[0].Id);
            return marketMapping.Version.ToUnsignedLongVersion();
        }
    }
}
