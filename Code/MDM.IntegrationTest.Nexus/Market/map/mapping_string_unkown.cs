namespace EnergyTrading.MDM.Test
{
    ...
    [TestClass]
    public class when_a_request_is_made_to_retrive_a_market_from_a_source_system_and_the_mapping_string_doesnt_exist : IntegrationTestBase
    {
        ...
        [TestMethod]
        public void should_not_return_a_market()
        {
            RWEST.Nexus.MDM.Contracts.Market returnedMarket = null;
            try { returnedMarket = response.Content.ReadAsDataContract<RWEST.Nexus.MDM.Contracts.Market>(); } catch { }
            Assert.IsNull(returnedMarket);
        }
        ...
        public void should_return_nexus_failure_with_correct_information()
        {
            ...
            Assert.AreEqual("Market Mapping String 'abc' not found for Source System 'Trayport' and the given date '2010-03-16T11:21:23Z'", fault.Message, true);
        }
    }
}