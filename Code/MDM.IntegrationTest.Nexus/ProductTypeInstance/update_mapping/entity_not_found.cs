namespace EnergyTrading.MDM.Test
{
    ...
    [TestClass]
    public class when_a_request_is_made_to_update_a_producttypeinstance_mapping_and_the_mapping_doesnt_exist : IntegrationTestBase
    {
        ...
        private static ProductTypeInstanceMapping currentTrayportMapping;
        ...
        {
            entity = Script.ProductTypeInstanceData.CreateBasicEntityWithOneMapping();
        ...
        protected static void Because_of()
        {
            ...
            response = client.Post(ServiceUrl["ProductTypeInstance"] +  string.Format("{0}/Mapping/{1}", entity.Id, int.MaxValue), content);
        }
        ...
        {
            var producttypeinstanceMapping = new DbSetRepository<MDM.ProductTypeInstanceMapping>(new NexusMappingContext()).FindOne(entity.Mappings[0].Id);
            return producttypeinstanceMapping.Version.ToUnsignedLongVersion();
        }
    }
}
