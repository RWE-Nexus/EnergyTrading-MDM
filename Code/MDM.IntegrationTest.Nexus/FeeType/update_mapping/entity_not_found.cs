namespace EnergyTrading.MDM.Test
{
    ...
    [TestClass]
    public class when_a_request_is_made_to_update_a_feetype_mapping_and_the_mapping_doesnt_exist : IntegrationTestBase
    {
        ...
        private static FeeTypeMapping currentTrayportMapping;
        ...
        {
            entity = Script.FeeTypeData.CreateBasicEntityWithOneMapping();
        ...
        protected static void Because_of()
        {
            ...
            response = client.Post(ServiceUrl["FeeType"] +  string.Format("{0}/Mapping/{1}", entity.Id, int.MaxValue), content);
        }
        ...
        {
            var feetypeMapping = new DbSetRepository<MDM.FeeTypeMapping>(new NexusMappingContext()).FindOne(entity.Mappings[0].Id);
            return feetypeMapping.Version.ToUnsignedLongVersion();
        }
    }
}
