namespace EnergyTrading.MDM.Test
{
    ...
    [TestClass]
    public class when_a_request_is_made_to_update_a_producttype_mapping_and_the_mapping_doesnt_exist : IntegrationTestBase
    {
        ...
        private static ProductTypeMapping currentTrayportMapping;
        ...
        {
            entity = Script.ProductTypeData.CreateBasicEntityWithOneMapping();
        ...
        protected static void Because_of()
        {
            ...
            response = client.Post(ServiceUrl["ProductType"] +  string.Format("{0}/Mapping/{1}", entity.Id, int.MaxValue), content);
        }
        ...
        {
            var producttypeMapping = new DbSetRepository<MDM.ProductTypeMapping>(new NexusMappingContext()).FindOne(entity.Mappings[0].Id);
            return producttypeMapping.Version.ToUnsignedLongVersion();
        }
    }
}
