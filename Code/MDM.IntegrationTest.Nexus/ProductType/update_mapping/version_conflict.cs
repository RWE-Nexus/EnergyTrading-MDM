namespace EnergyTrading.MDM.Test
{
    ...
    [TestClass]
    public class when_a_request_is_made_to_update_a_producttype_mapping_and_the_etag_is_not_current : IntegrationTestBase
    {
        ...
        [TestMethod]
        public void should_not_update_the_producttype_in_the_database()
        {
        ...
        {
            return new DbSetRepository<MDM.ProductType>(new NexusMappingContext()).FindOne(entity.Id).Version;
        }
    }
}
