namespace EnergyTrading.MDM.Test
{
    ...
    [TestClass]
    public class when_a_request_is_made_to_create_a_producttype_entity : IntegrationTestBase
    {
        ...
        [TestMethod]
        public void should_create_an_instance_of_the_producttype_in_the_database_with_the_correct_details()
        {
            Script.ProductTypeDataChecker.ConfirmEntitySaved(int.Parse(GetLocationHeader()[1]), producttype);
        }
