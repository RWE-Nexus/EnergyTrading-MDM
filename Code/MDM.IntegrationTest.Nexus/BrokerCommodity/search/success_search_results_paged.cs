	namespace EnergyTrading.MDM.Test
{
    ...
    [TestClass]
    public class when_a_search_for_a_brokercommodity_with_two_results_is_paged_at_one_per_page : IntegrationTestBase
    {
        ...
        private static IList<BrokerCommodity> pageOne;
        private static Uri pageOneNextPage;
        private static IList<BrokerCommodity> pageTwo;
        ...
        {
            pageOneResponse = client.Post(ServiceUrl["BrokerCommodity"] + "search", content);
        ...
        protected static void Establish_context()
        {
			...
			BrokerCommodityData.CreateSearch(search, entity1, entity2);
        ...
        private static IList<BrokerCommodity> GetPeopleFromFeed(SyndicationFeed feed)
        {
