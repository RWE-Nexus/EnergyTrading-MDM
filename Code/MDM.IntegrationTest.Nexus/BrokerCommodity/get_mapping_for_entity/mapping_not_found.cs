namespace EnergyTrading.MDM.Test
{
    ...
    [TestClass]
    public class when_a_request_is_made_for_an_individual_mapping_for_a_brokercommodity_and_the_mapping_doesnt_exist : IntegrationTestBase
    {
        ...
        {
            var entity = BrokerCommodityData.CreateBasicEntityWithOneMapping();

            client = new HttpClient(ServiceUrl["BrokerCommodity"] + string.Format("{0}/mapping/{1}", entity.Id, int.MaxValue));
