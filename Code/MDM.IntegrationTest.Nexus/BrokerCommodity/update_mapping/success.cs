namespace EnergyTrading.MDM.Test
{
    ...
    [TestClass]
    public class when_a_request_is_made_to_update_a_brokercommodity_mapping : IntegrationTestBase
    {
        ...
        protected static void Because_of()
        {
            ...
            response = client.Post(ServiceUrl["BrokerCommodity"] +  string.Format("{0}/Mapping/{1}", entity.Id, currentTrayportMapping.Id), content);
        }

        [TestMethod]
        public void should_update_the_mapping_on_the_brokercommodity_entity()
        {
            var savedMapping = new DbSetRepository<MDM.BrokerCommodity>(new NexusMappingContext()).FindOne(entity.Id).Mappings[0];
