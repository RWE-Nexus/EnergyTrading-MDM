namespace EnergyTrading.MDM.Test
{
    ...
    public static class BrokerCommodityDataChecker
    {
        ...
        {
            var savedEntity =
                new DbSetRepository<MDM.BrokerCommodity>(new NexusMappingContext()).FindOne(id);
        ...
        public static void CompareContractWithSavedEntity(RWEST.Nexus.MDM.Contracts.BrokerCommodity contract)
        {
            ...
            var savedEntity = new DbSetRepository<MDM.BrokerCommodity>(new NexusMappingContext()).FindOne(id);
